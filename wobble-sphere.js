...
}`;function Wp(i,e,t){let n=new aa;const r=new Oe,s=new Oe,a=new ot,o=new ml({depthPacking:$o}),l=new fu,f={},p=t.maxTextureSize,_={[yn]:Rt,[Rt]:yn,[an]:an},m=new En({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Oe},radius:{value:4}},vertexShader:Vp,fragmentShader:Gp}),g=m.clone();g.defines.HORIZONTAL_PASS=1;const M=new bn;M.setAttribute("position",new jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const T=new Yt(M,m),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Fo;let u=this.type;this.render=function(x,b,v){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||x.length===0)return;const h=i.getRenderTarget(),c=i.getActiveCubeFace(),y=i.getActiveMipmapLevel(),I=i.state;I.setBlending(Mn),I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);const F=u!==rn&&this.type===rn,k=u===rn&&this.type!==rn;for(let G=0,O=x.length;G<O;G++){const j=x[G],X=j.shadow;if(X===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;r.copy(X.mapSize);const ie=X.getFrameExtents();if(r.multiply(ie),s.copy(X.mapSize),(r.x>p||r.y>p)&&(r.x>p&&(s.x=Math.floor(p/ie.x),r.x=s.x*ie.x,X.mapSize.x=s.x),r.y>p&&(s.y=Math.floor(p/ie.y),r.y=s.y*ie.y,X.mapSize.y=s.y)),X.map===null||F===!0||k===!0){const _e=this.type!==rn?{minFilter:Xt,magFilter:Xt}:{};X.map!==null&&X.map.dispose(),X.map=new zn(r.x,r.y,_e),X.map.texture.name=j.name+".shadowMap",X.camera.updateProjectionMatrix()}i.setRenderTarget(X.map),i.clear();const se=X.getViewportCount();for(let _e=0;_e<se;_e++){const Ue=X.getViewport(_e);a.set(s.x*Ue.x,s.y*Ue.y,s.x*Ue.z,s.y*Ue.w),I.viewport(a),X.updateMatrices(j,_e),n=X.getFrustum(),S(b,v,X.camera,j,this.type)}X.isPointLightShadow!==!0&&this.type===rn&&A(X,v),X.needsUpdate=!1}u=this.type,d.needsUpdate=!1,i.setRenderTarget(h,c,y)};function A(x,b){const v=e.update(T);m.defines.VSM_SAMPLES!==x.blurSamples&&(m.defines.VSM_SAMPLES=x.blurSamples,g.defines.VSM_SAMPLES=x.blurSamples,m.needsUpdate=!0,g.needsUpdate=!0),x.mapPass===null&&(x.mapPass=new zn(r.x,r.y)),m.uniforms.shadow_pass.value=x.map.texture,m.uniforms.resolution.value=x.mapSize,m.uniforms.radius.value=x.radius,i.setRenderTarget(x.mapPass),i.clear(),i.renderBufferDirect(b,null,v,m,T,null),g.uniforms.shadow_pass.value=x.mapPass.texture,g.uniforms.resolution.value=x.mapSize,g.uniforms.radius.value=x.radius,i.setRenderTarget(x.map),i.clear(),i.renderBufferDirect(b,null,v,g,T,null)}function R(x,b,v,h){let c=null;const y=v.isPointLight===!0?x.customDistanceMaterial:x.customDepthMaterial;if(y!==void 0)c=y;else if(c=v.isPointLight===!0?l:o,i.localClippingEnabled&&b.clipShadows===!0&&Array.isArray(b.clippingPlanes)&&b.clippingPlanes.length!==0||b.displacementMap&&b.displacementScale!==0||b.alphaMap&&b.alphaTest>0||b.map&&b.alphaTest>0){const I=c.uuid,F=b.uuid;let k=f[I];k===void 0&&(k={},f[I]=k);let G=k[F];G===void 0&&(G=c.clone(),k[F]=G,b.addEventListener("dispose",U)),c=G}if(c.visible=b.visible,c.wireframe=b.wireframe,h===rn?c.side=b.shadowSide!==null?b.shadowSide:b.side:c.side=b.shadowSide!==null?b.shadowSide:_[b.side],c.alphaMap=b.alphaMap,c.alphaTest=b.alphaTest,c.map=b.map,c.clipShadows=b.clipShadows,c.clippingPlanes=b.clippingPlanes,c.clipIntersection=b.clipIntersection,c.displacementMap=b.displacementMap,c.displacementScale=b.displacementScale,c.displacementBias=b.displacementBias,c.wireframeLinewidth=b.wireframeLinewidth,c.linewidth=b.linewidth,v.isPointLight===!0&&c.isMeshDistanceMaterial===!0){const I=i.properties.get(c);I.light=v}return c}function S(x,b,v,h,c){if(x.visible===!1)return;if(x.layers.test(b.layers)&&(x.isMesh||x.isLine||x.isPoints)&&(x.castShadow||x.receiveShadow&&c===rn)&&(!x.frustumCulled||n.intersectsObject(x))){x.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,x.matrixWorld);const F=e.update(x),k=x.material;if(Array.isArray(k)){const G=F.groups;for(let O=0,j=G.length;O<j;O++){const X=G[O],ie=k[X.materialIndex];if(ie&&ie.visible){const se=R(x,ie,h,c);x.onBeforeShadow(i,x,b,v,F,se,X),i.renderBufferDirect(v,null,F,se,x,X),x.onAfterShadow(i,x,b,v,F,se,X)}}}else if(k.visible){const G=R(x,k,h,c);x.onBeforeShadow(i,x,b,v,F,G,null),i.renderBufferDirect(v,null,F,G,x,null),x.onAfterShadow(i,x,b,v,F,G,null)}}const I=x.children;for(let F=0,k=I.length;F<k;F++)S(I[F],b,v,h,c)}function U(x){x.target.removeEventListener("dispose",U);for(const v in f){const h=f[v],c=x.target.uuid;c in h&&(h[c].dispose(),delete h[c])}}}const Xp={[fs]:ds,[ps]:gs,[ms]:vs,[fi]:_s,[ds]:fs,[gs]:ps,[vs]:ms,[_s]:fi};function qp(i,e){function t(){let B=!1;const de=new ot;let J=null;const ne=new ot(0,0,0,0);return{setMask:function(ve){J!==ve&&!B&&(i.colorMask(ve,ve,ve,ve),J=ve)},setLocked:function(ve){B=ve},setClear:function(ve,ge,ze,st,_t){_t===!0&&(ve*=st,ge*=st,ze*=st),de.set(ve,ge,ze,st),ne.equals(de)===!1&&(i.clearColor(ve,ge,ze,st),ne.copy(de))},reset:function(){B=!1,J=null,ne.set(-1,0,0,0)}}}function n(){let B=!1,de=!1,J=null,ne=null,ve=null;return{setReversed:function(ge){if(de!==ge){const ze=e.get("EXT_clip_control");de?ze.clipControlEXT(ze.LOWER_LEFT_EXT,ze.ZERO_TO_ONE_EXT):ze.clipControlEXT(ze.LOWER_LEFT_EXT,ze.NEGATIVE_ONE_TO_ONE_EXT);const st=ve;ve=null,this.setClear(st)}de=ge},getReversed:function(){return de},setTest:function(ge){ge?ue(i.DEPTH_TEST):$(i.DEPTH_TEST)},setMask:function(ge){J!==ge&&!B&&(i.depthMask(ge),J=ge)},setFunc:function(ge){if(de&&(ge=Xp[ge]),ne!==ge){switch(ge){case fs:i.depthFunc(i.NEVER);break;case ds:i.depthFunc(i.ALWAYS);break;case ps:i.depthFunc(i.LESS);break;case fi:i.depthFunc(i.LEQUAL);break;case ms:i.depthFunc(i.EQUAL);break;case _s:i.depthFunc(i.GEQUAL);break;case gs:i.depthFunc(i.GREATER);break;case vs:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ne=ge}},setLocked:function(ge){B=ge},setClear:function(ge){ve!==ge&&(de&&(ge=1-ge),i.clearDepth(ge),ve=ge)},reset:function(){B=!1,J=null,ne=null,ve=null,de=!1}}}function r(){let B=!1,de=null,J=null,ne=null,ve=null,ge=null,ze=null,st=null,_t=null;return{setTest:function(Qe){B||(Qe?ue(i.STENCIL_TEST):$(i.STENCIL_TEST))},setMask:function(Qe){de!==Qe&&!B&&(i.stencilMask(Qe),de=Qe)},setFunc:function(Qe,Bt,$t){(J!==Qe||ne!==Bt||ve!==$t)&&(i.stencilFunc(Qe,Bt,$t),J=Qe,ne=Bt,ve=$t)},setOp:function(Qe,Bt,$t){(ge!==Qe||ze!==Bt||st!==$t)&&(i.stencilOp(Qe,Bt,$t),ge=Qe,ze=Bt,st=$t)},setLocked:function(Qe){B=Qe},setClear:function(Qe){_t!==Qe&&(i.clearStencil(Qe),_t=Qe)},reset:function(){B=!1,de=null,J=null,ne=null,ve=null,ge=null,ze=null,st=null,_t=null}}}const s=new t,a=new n,o=new r,l=new WeakMap,f=new WeakMap;let p={},_={},m=new WeakMap,g=[],M=null,T=!1,d=null,u=null,A=null,R=null,S=null,U=null,x=null,b=new Xe(0,0,0),v=0,h=!1,c=null,y=null,I=null,F=null,k=null;const G=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,j=0;const X=i.getParameter(i.VERSION);X.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(X)[1]),O=j>=1):X.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),O=j>=2);let ie=null,se={};const _e=i.getParameter(i.SCISSOR_BOX),Ue=i.getParameter(i.VIEWPORT),Ge=new ot().fromArray(_e),K=new ot().fromArray(Ue);function oe(B,de,J,ne){const ve=new Uint8Array(4),ge=i.createTexture();i.bindTexture(B,ge),i.texParameteri(B,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(B,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ze=0;ze<J;ze++)B===i.TEXTURE_3D||B===i.TEXTURE_2D_ARRAY?i.texImage3D(de,0,i.RGBA,1,1,ne,0,i.RGBA,i.UNSIGNED_BYTE,ve):i.texImage2D(de+ze,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ve);return ge}const xe={};xe[i.TEXTURE_2D]=oe(i.TEXTURE_2D,i.TEXTURE_2D,1),xe[i.TEXTURE_CUBE_MAP]=oe(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),xe[i.TEXTURE_2D_ARRAY]=oe(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),xe[i.TEXTURE_3D]=oe(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ue(i.DEPTH_TEST),a.setFunc(fi),Te(!1),we(va),ue(i.CULL_FACE),L(Mn);function ue(B){p[B]!==!0&&(i.enable(B),p[B]=!0)}function $(B){p[B]!==!1&&(i.disable(B),p[B]=!1)}function w(B,de){return _[B]!==de?(i.bindFramebuffer(B,de),_[B]=de,B===i.DRAW_FRAMEBUFFER&&(_[i.FRAMEBUFFER]=de),B===i.FRAMEBUFFER&&(_[i.DRAW_FRAMEBUFFER]=de),!0):!1}function P(B,de){let J=g,ne=!1;if(B){J=m.get(de),J===void 0&&(J=[],m.set(de,J));const ve=B.textures;if(J.length!==ve.length||J[0]!==i.COLOR_ATTACHMENT0){for(let ge=0,ze=ve.length;ge<ze;ge++)J[ge]=i.COLOR_ATTACHMENT0+ge;J.length=ve.length,ne=!0}}else J[0]!==i.BACK&&(J[0]=i.BACK,ne=!0);ne&&i.drawBuffers(J)}function N(B){return M!==B?(i.useProgram(B),M=B,!0):!1}const Q={[Nn]:i.FUNC_ADD,[Bl]:i.FUNC_SUBTRACT,[zl]:i.FUNC_REVERSE_SUBTRACT};Q[Hl]=i.MIN,Q[kl]=i.MAX;const Z={[Vl]:i.ZERO,[Gl]:i.ONE,[Wl]:i.SRC_COLOR,[us]:i.SRC_ALPHA,[Kl]:i.SRC_ALPHA_SATURATE,[jl]:i.DST_COLOR,[ql]:i.DST_ALPHA,[Xl]:i.ONE_MINUS_SRC_COLOR,[hs]:i.ONE_MINUS_SRC_ALPHA,[Zl]:i.ONE_MINUS_DST_COLOR,[Yl]:i.ONE_MINUS_DST_ALPHA,[$l]:i.CONSTANT_COLOR,[Jl]:i.ONE_MINUS_CONSTANT_COLOR,[Ql]:i.CONSTANT_ALPHA,[ec]:i.ONE_MINUS_CONSTANT_ALPHA};function L(B,de,J,ne,ve,ge,ze,st,_t,Qe){if(B===Mn){T===!0&&($(i.BLEND),T=!1);return}if(T===!1&&(ue(i.BLEND),T=!0),B!==Ol){if(B!==d||Qe!==h){if((u!==Nn||S!==Nn)&&(i.blendEquation(i.FUNC_ADD),u=Nn,S=Nn),Qe)switch(B){case ci:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case xa:i.blendFunc(i.ONE,i.ONE);break;case Ma:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Sa:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",B);break}else switch(B){case ci:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case xa:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Ma:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Sa:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",B);break}A=null,R=null,U=null,x=null,b.set(0,0,0),v=0,d=B,h=Qe}return}ve=ve||de,ge=ge||J,ze=ze||ne,(de!==u||ve!==S)&&(i.blendEquationSeparate(Q[de],Q[ve]),u=de,S=ve),(J!==A||ne!==R||ge!==U||ze!==x)&&(i.blendFuncSeparate(Z[J],Z[ne],Z[ge],Z[ze]),A=J,R=ne,U=ge,x=ze),(st.equals(b)===!1||_t!==v)&&(i.blendColor(st.r,st.g,st.b,_t),b.copy(st),v=_t),d=B,h=!1}function Pe(B,de){B.side===an?$(i.CULL_FACE):ue(i.CULL_FACE);let J=B.side===Rt;de&&(J=!J),Te(J),B.blending===ci&&B.transparent===!1?L(Mn):L(B.blending,B.blendEquation,B.blendSrc,B.blendDst,B.blendEquationAlpha,B.blendSrcAlpha,B.blendDstAlpha,B.blendColor,B.blendAlpha,B.premultipliedAlpha),a.setFunc(B.depthFunc),a.setTest(B.depthTest),a.setMask(B.depthWrite),s.setMask(B.colorWrite);const ne=B.stencilWrite;o.setTest(ne),ne&&(o.setMask(B.stencilWriteMask),o.setFunc(B.stencilFunc,B.stencilRef,B.stencilFuncMask),o.setOp(B.stencilFail,B.stencilZFail,B.stencilZPass)),De(B.polygonOffset,B.polygonOffsetFactor,B.polygonOffsetUnits),B.alphaToCoverage===!0?ue(i.SAMPLE_ALPHA_TO_COVERAGE):$(i.SAMPLE_ALPHA_TO_COVERAGE)}function Te(B){c!==B&&(B?i.frontFace(i.CW):i.frontFace(i.CCW),c=B)}function we(B){B!==Ul?(ue(i.CULL_FACE),B!==y&&(B===va?i.cullFace(i.BACK):B===Nl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):$(i.CULL_FACE),y=B}function le(B){B!==I&&(O&&i.lineWidth(B),I=B)}function De(B,de,J){B?(ue(i.POLYGON_OFFSET_FILL),(F!==de||k!==J)&&(i.polygonOffset(de,J),F=de,k=J)):$(i.POLYGON_OFFSET_FILL)}function fe(B){B?ue(i.SCISSOR_TEST):$(i.SCISSOR_TEST)}function D(B){B===void 0&&(B=i.TEXTURE0+G-1),ie!==B&&(i.activeTexture(B),ie=B)}function E(B,de,J){J===void 0&&(ie===null?J=i.TEXTURE0+G-1:J=ie);let ne=se[J];ne===void 0&&(ne={type:void 0,texture:void 0},se[J]=ne),(ne.type!==B||ne.texture!==de)&&(ie!==J&&(i.activeTexture(J),ie=J),i.bindTexture(B,de||xe[B]),ne.type=B,ne.texture=de)}function W(){const B=se[ie];B!==void 0&&B.type!==void 0&&(i.bindTexture(B.type,null),B.type=void 0,B.texture=void 0)}function te(){try{i.compressedTexImage2D(...arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function re(){try{i.compressedTexImage3D(...arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function ee(){try{i.texSubImage2D(...arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function Ae(){try{i.texSubImage3D(...arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function me(){try{i.compressedTexSubImage2D(...arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function Se(){try{i.compressedTexSubImage3D(...arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function Ye(){try{i.texStorage2D(...arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function ce(){try{i.texStorage3D(...arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function ye(){try{i.texImage2D(...arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function Le(){try{i.texImage3D(...arguments)}catch(B){console.error("THREE.WebGLState:",B)}}function Ne(B){Ge.equals(B)===!1&&(i.scissor(B.x,B.y,B.z,B.w),Ge.copy(B))}function Ee(B){K.equals(B)===!1&&(i.viewport(B.x,B.y,B.z,B.w),K.copy(B))}function qe(B,de){let J=f.get(de);J===void 0&&(J=new WeakMap,f.set(de,J));let ne=J.get(B);ne===void 0&&(ne=i.getUniformBlockIndex(de,B.name),J.set(B,ne))}function ke(B,de){const ne=f.get(de).get(B);l.get(de)!==ne&&(i.uniformBlockBinding(de,ne,B.__bindingPointIndex),l.set(de,ne))}function it(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),p={},ie=null,se={},_={},m=new WeakMap,g=[],M=null,T=!1,d=null,u=null,A=null,R=null,S=null,U=null,x=null,b=new Xe(0,0,0),v=0,h=!1,c=null,y=null,I=null,F=null,k=null,Ge.set(0,0,i.canvas.width,i.canvas.height),K.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ue,disable:$,bindFramebuffer:w,drawBuffers:P,useProgram:N,setBlending:L,setMaterial:Pe,setFlipSided:Te,setCullFace:we,setLineWidth:le,setPolygonOffset:De,setScissorTest:fe,activeTexture:D,bindTexture:E,unbindTexture:W,compressedTexImage2D:te,compressedTexImage3D:re,texImage2D:ye,texImage3D:Le,updateUBOMapping:qe,uniformBlockBinding:ke,texStorage2D:Ye,texStorage3D:ce,texSubImage2D:ee,texSubImage3D:Ae,compressedTexSubImage2D:me,compressedTexSubImage3D:Se,scissor:Ne,viewport:Ee,reset:it}}function Yp(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),f=new Oe,p=new WeakMap;let _;const m=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(D,E){return g?new OffscreenCanvas(D,E):mr("canvas")}function T(D,E,W){let te=1;const re=fe(D);if((re.width>W||re.height>W)&&(te=W/Math.max(re.width,re.height)),te<1)if(typeof HTMLImageElement<"u"&&D instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&D instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&D instanceof ImageBitmap||typeof VideoFrame<"u"&&D instanceof VideoFrame){const ee=Math.floor(te*re.width),Ae=Math.floor(te*re.height);_===void 0&&(_=M(ee,Ae));const me=E?M(ee,Ae):_;return me.width=ee,me.height=Ae,me.getContext("2d").drawImage(D,0,0,ee,Ae),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+re.width+"x"+re.height+") to ("+ee+"x"+Ae+")."),me}else return"data"in D&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+re.width+"x"+re.height+")."),D;return D}function d(D){return D.generateMipmaps}function u(D){i.generateMipmap(D)}function A(D){return D.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:D.isWebGL3DRenderTarget?i.TEXTURE_3D:D.isWebGLArrayRenderTarget||D.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function R(D,E,W,te,re=!1){if(D!==null){if(i[D]!==void 0)return i[D];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+D+"'")}let ee=E;if(E===i.RED&&(W===i.FLOAT&&(ee=i.R32F),W===i.HALF_FLOAT&&(ee=i.R16F),W===i.UNSIGNED_BYTE&&(ee=i.R8)),E===i.RED_INTEGER&&(W===i.UNSIGNED_BYTE&&(ee=i.R8UI),W===i.UNSIGNED_SHORT&&(ee=i.R16UI),W===i.UNSIGNED_INT&&(ee=i.R32UI),W===i.BYTE&&(ee=i.R8I),W===i.SHORT&&(ee=i.R16I),W===i.INT&&(ee=i.R32I)),E===i.RG&&(W===i.FLOAT&&(ee=i.RG32F),W===i.HALF_FLOAT&&(ee=i.RG16F),W===i.UNSIGNED_BYTE&&(ee=i.RG8)),E===i.RG_INTEGER&&(W===i.UNSIGNED_BYTE&&(ee=i.RG8UI),W===i.UNSIGNED_SHORT&&(ee=i.RG16UI),W===i.UNSIGNED_INT&&(ee=i.RG32UI),W===i.BYTE&&(ee=i.RG8I),W===i.SHORT&&(ee=i.RG16I),W===i.INT&&(ee=i.RG32I)),E===i.RGB_INTEGER&&(W===i.UNSIGNED_BYTE&&(ee=i.RGB8UI),W===i.UNSIGNED_SHORT&&(ee=i.RGB16UI),W===i.UNSIGNED_INT&&(ee=i.RGB32UI),W===i.BYTE&&(ee=i.RGB8I),W===i.SHORT&&(ee=i.RGB16I),W===i.INT&&(ee=i.RGB32I)),E===i.RGBA_INTEGER&&(W===i.UNSIGNED_BYTE&&(ee=i.RGBA8UI),W===i.UNSIGNED_SHORT&&(ee=i.RGBA16UI),W===i.UNSIGNED_INT&&(ee=i.RGBA32UI),W===i.BYTE&&(ee=i.RGBA8I),W===i.SHORT&&(ee=i.RGBA16I),W===i.INT&&(ee=i.RGBA32I)),E===i.RGB&&W===i.UNSIGNED_INT_5_9_9_9_REV&&(ee=i.RGB9_E5),E===i.RGBA){const Ae=re?dr:Ke.getTransfer(te);W===i.FLOAT&&(ee=i.RGBA32F),W===i.HALF_FLOAT&&(ee=i.RGBA16F),W===i.UNSIGNED_BYTE&&(ee=Ae===tt?i.SRGB8_ALPHA8:i.RGBA8),W===i.UNSIGNED_SHORT_4_4_4_4&&(ee=i.RGBA4),W===i.UNSIGNED_SHORT_5_5_5_1&&(ee=i.RGB5_A1)}return(ee===i.R16F||ee===i.R32F||ee===i.RG16F||ee===i.RG32F||ee===i.RGBA16F||ee===i.RGBA32F)&&e.get("EXT_color_buffer_float"),ee}function S(D,E){let W;return D?E===null||E===Bn||E===mi?W=i.DEPTH24_STENCIL8:E===on?W=i.DEPTH32F_STENCIL8:E===Pi&&(W=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Bn||E===mi?W=i.DEPTH_COMPONENT24:E===on?W=i.DEPTH_COMPONENT32F:E===Pi&&(W=i.DEPTH_COMPONENT16),W}function U(D,E){return d(D)===!0||D.isFramebufferTexture&&D.minFilter!==Xt&&D.minFilter!==Wt?Math.log2(Math.max(E.width,E.height))+1:D.mipmaps!==void 0&&D.mipmaps.length>0?D.mipmaps.length:D.isCompressedTexture&&Array.isArray(D.image)?E.mipmaps.length:1}function x(D){const E=D.target;E.removeEventListener("dispose",x),v(E),E.isVideoTexture&&p.delete(E)}function b(D){const E=D.target;E.removeEventListener("dispose",b),c(E)}function v(D){const E=n.get(D);if(E.__webglInit===void 0)return;const W=D.source,te=m.get(W);if(te){const re=te[E.__cacheKey];re.usedTimes--,re.usedTimes===0&&h(D),Object.keys(te).length===0&&m.delete(W)}n.remove(D)}function h(D){const E=n.get(D);i.deleteTexture(E.__webglTexture);const W=D.source,te=m.get(W);delete te[E.__cacheKey],a.memory.textures--}function c(D){const E=n.get(D);if(D.depthTexture&&(D.depthTexture.dispose(),n.remove(D.depthTexture)),D.isWebGLCubeRenderTarget)for(let te=0;te<6;te++){if(Array.isArray(E.__webglFramebuffer[te]))for(let re=0;re<E.__webglFramebuffer[te].length;re++)i.deleteFramebuffer(E.__webglFramebuffer[te][re]);else i.deleteFramebuffer(E.__webglFramebuffer[te]);E.__webglDepthbuffer&&i.deleteRenderbuffer(E.__webglDepthbuffer[te])}else{if(Array.isArray(E.__webglFramebuffer))for(let te=0;te<E.__webglFramebuffer.length;te++)i.deleteFramebuffer(E.__webglFramebuffer[te]);else i.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&i.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&i.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let te=0;te<E.__webglColorRenderbuffer.length;te++)E.__webglColorRenderbuffer[te]&&i.deleteRenderbuffer(E.__webglColorRenderbuffer[te]);E.__webglDepthRenderbuffer&&i.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const W=D.textures;for(let te=0,re=W.length;te<re;te++){const ee=n.get(W[te]);ee.__webglTexture&&(i.deleteTexture(ee.__webglTexture),a.memory.textures--),n.remove(W[te])}n.remove(D)}let y=0;function I(){y=0}function F(){const D=y;return D>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+D+" texture units while this GPU supports only "+r.maxTextures),y+=1,D}function k(D){const E=[];return E.push(D.wrapS),E.push(D.wrapT),E.push(D.wrapR||0),E.push(D.magFilter),E.push(D.minFilter),E.push(D.anisotropy),E.push(D.internalFormat),E.push(D.format),E.push(D.type),E.push(D.generateMipmaps),E.push(D.premultiplyAlpha),E.push(D.flipY),E.push(D.unpackAlignment),E.push(D.colorSpace),E.join()}function G(D,E){const W=n.get(D);if(D.isVideoTexture&&le(D),D.isRenderTargetTexture===!1&&D.version>0&&W.__version!==D.version){const te=D.image;if(te===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(te.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{K(W,D,E);return}}t.bindTexture(i.TEXTURE_2D,W.__webglTexture,i.TEXTURE0+E)}function O(D,E){const W=n.get(D);if(D.version>0&&W.__version!==D.version){K(W,D,E);return}t.bindTexture(i.TEXTURE_2D_ARRAY,W.__webglTexture,i.TEXTURE0+E)}function j(D,E){const W=n.get(D);if(D.version>0&&W.__version!==D.version){K(W,D,E);return}t.bindTexture(i.TEXTURE_3D,W.__webglTexture,i.TEXTURE0+E)}function X(D,E){const W=n.get(D);if(D.version>0&&W.__version!==D.version){oe(W,D,E);return}t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture,i.TEXTURE0+E)}const ie={[Ss]:i.REPEAT,[On]:i.CLAMP_TO_EDGE,[ys]:i.MIRRORED_REPEAT},se={[Xt]:i.NEAREST,[cc]:i.NEAREST_MIPMAP_NEAREST,[Oi]:i.NEAREST_MIPMAP_LINEAR,[Wt]:i.LINEAR,[Er]:i.LINEAR_MIPMAP_NEAREST,[xn]:i.LINEAR_MIPMAP_LINEAR},_e={[fc]:i.NEVER,[vc]:i.ALWAYS,[dc]:i.LESS,[Qo]:i.LEQUAL,[pc]:i.EQUAL,[gc]:i.GEQUAL,[mc]:i.GREATER,[_c]:i.NOTEQUAL};function Ue(D,E){if(E.type===on&&e.has("OES_texture_float_linear")===!1&&(E.magFilter===Wt||E.magFilter===Er||E.magFilter===Oi||E.magFilter===xn||E.minFilter===Wt||E.minFilter===Er||E.minFilter===Oi||E.minFilter===xn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(D,i.TEXTURE_WRAP_S,ie[E.wrapS]),i.texParameteri(D,i.TEXTURE_WRAP_T,ie[E.wrapT]),(D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY)&&i.texParameteri(D,i.TEXTURE_WRAP_R,ie[E.wrapR]),i.texParameteri(D,i.TEXTURE_MAG_FILTER,se[E.magFilter]),i.texParameteri(D,i.TEXTURE_MIN_FILTER,se[E.minFilter]),E.compareFunction&&(i.texParameteri(D,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(D,i.TEXTURE_COMPARE_FUNC,_e[E.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===Xt||E.minFilter!==Oi&&E.minFilter!==xn||E.type===on&&e.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||n.get(E).__currentAnisotropy){const W=e.get("EXT_texture_filter_anisotropic");i.texParameterf(D,W.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,r.getMaxAnisotropy())),n.get(E).__currentAnisotropy=E.anisotropy}}}function Ge(D,E){let W=!1;D.__webglInit===void 0&&(D.__webglInit=!0,E.addEventListener("dispose",x));const te=E.source;let re=m.get(te);re===void 0&&(re={},m.set(te,re));const ee=k(E);if(ee!==D.__cacheKey){re[ee]===void 0&&(re[ee]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,W=!0),re[ee].usedTimes++;const Ae=re[D.__cacheKey];Ae!==void 0&&(re[D.__cacheKey].usedTimes--,Ae.usedTimes===0&&h(E)),D.__cacheKey=ee,D.__webglTexture=re[ee].texture}return W}function K(D,E,W){let te=i.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(te=i.TEXTURE_2D_ARRAY),E.isData3DTexture&&(te=i.TEXTURE_3D);const re=Ge(D,E),ee=E.source;t.bindTexture(te,D.__webglTexture,i.TEXTURE0+W);const Ae=n.get(ee);if(ee.version!==Ae.__version||re===!0){t.activeTexture(i.TEXTURE0+W);const me=Ke.getPrimaries(Ke.workingColorSpace),Se=E.colorSpace===vn?null:Ke.getPrimaries(E.colorSpace),Ye=E.colorSpace===vn||me===Se?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,E.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,E.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ye);let ce=T(E.image,!1,r.maxTextureSize);ce=De(E,ce);const ye=s.convert(E.format,E.colorSpace),Le=s.convert(E.type);let Ne=R(E.internalFormat,ye,Le,E.colorSpace,E.isVideoTexture);Ue(te,E);let Ee;const qe=E.mipmaps,ke=E.isVideoTexture!==!0,it=Ae.__version===void 0||re===!0,B=ee.dataReady,de=U(E,ce);if(E.isDepthTexture)Ne=S(E.format===_i,E.type),it&&(ke?t.texStorage2D(i.TEXTURE_2D,1,Ne,ce.width,ce.height):t.texImage2D(i.TEXTURE_2D,0,Ne,ce.width,ce.height,0,ye,Le,null));else if(E.isDataTexture)if(qe.length>0){ke&&it&&t.texStorage2D(i.TEXTURE_2D,de,Ne,qe[0].width,qe[0].height);for(let J=0,ne=qe.length;J<ne;J++)Ee=qe[J],ke?B&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,Ee.width,Ee.height,ye,Le,Ee.data):t.texImage2D(i.TEXTURE_2D,J,Ne,Ee.width,Ee.height,0,ye,Le,Ee.data);E.generateMipmaps=!1}else ke?(it&&t.texStorage2D(i.TEXTURE_2D,de,Ne,ce.width,ce.height),B&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ce.width,ce.height,ye,Le,ce.data)):t.texImage2D(i.TEXTURE_2D,0,Ne,ce.width,ce.height,0,ye,Le,ce.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){ke&&it&&t.texStorage3D(i.TEXTURE_2D_ARRAY,de,Ne,qe[0].width,qe[0].height,ce.depth);for(let J=0,ne=qe.length;J<ne;J++)if(Ee=qe[J],E.format!==Ot)if(ye!==null)if(ke){if(B)if(E.layerUpdates.size>0){const ve=Ya(Ee.width,Ee.height,E.format,E.type);for(const ge of E.layerUpdates){const ze=Ee.data.subarray(ge*ve/Ee.data.BYTES_PER_ELEMENT,(ge+1)*ve/Ee.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,ge,Ee.width,Ee.height,1,ye,ze)}E.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,Ee.width,Ee.height,ce.depth,ye,Ee.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,J,Ne,Ee.width,Ee.height,ce.depth,0,Ee.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ke?B&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,Ee.width,Ee.height,ce.depth,ye,Le,Ee.data):t.texImage3D(i.TEXTURE_2D_ARRAY,J,Ne,Ee.width,Ee.height,ce.depth,0,ye,Le,Ee.data)}else{ke&&it&&t.texStorage2D(i.TEXTURE_2D,de,Ne,qe[0].width,qe[0].height);for(let J=0,ne=qe.length;J<ne;J++)Ee=qe[J],E.format!==Ot?ye!==null?ke?B&&t.compressedTexSubImage2D(i.TEXTURE_2D,J,0,0,Ee.width,Ee.height,ye,Ee.data):t.compressedTexImage2D(i.TEXTURE_2D,J,Ne,Ee.width,Ee.height,0,Ee.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ke?B&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,Ee.width,Ee.height,ye,Le,Ee.data):t.texImage2D(i.TEXTURE_2D,J,Ne,Ee.width,Ee.height,0,ye,Le,Ee.data)}else if(E.isDataArrayTexture)if(ke){if(it&&t.texStorage3D(i.TEXTURE_2D_ARRAY,de,Ne,ce.width,ce.height,ce.depth),B)if(E.layerUpdates.size>0){const J=Ya(ce.width,ce.height,E.format,E.type);for(const ne of E.layerUpdates){const ve=ce.data.subarray(ne*J/ce.data.BYTES_PER_ELEMENT,(ne+1)*J/ce.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ne,ce.width,ce.height,1,ye,Le,ve)}E.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ce.width,ce.height,ce.depth,ye,Le,ce.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Ne,ce.width,ce.height,ce.depth,0,ye,Le,ce.data);else if(E.isData3DTexture)ke?(it&&t.texStorage3D(i.TEXTURE_3D,de,Ne,ce.width,ce.height,ce.depth),B&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ce.width,ce.height,ce.depth,ye,Le,ce.data)):t.texImage3D(i.TEXTURE_3D,0,Ne,ce.width,ce.height,ce.depth,0,ye,Le,ce.data);else if(E.isFramebufferTexture){if(it)if(ke)t.texStorage2D(i.TEXTURE_2D,de,Ne,ce.width,ce.height);else{let J=ce.width,ne=ce.height;for(let ve=0;ve<de;ve++)t.texImage2D(i.TEXTURE_2D,ve,Ne,J,ne,0,ye,Le,null),J>>=1,ne>>=1}}else if(qe.length>0){if(ke&&it){const J=fe(qe[0]);t.texStorage2D(i.TEXTURE_2D,de,Ne,J.width,J.height)}for(let J=0,ne=qe.length;J<ne;J++)Ee=qe[J],ke?B&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,ye,Le,Ee):t.texImage2D(i.TEXTURE_2D,J,Ne,ye,Le,Ee);E.generateMipmaps=!1}else if(ke){if(it){const J=fe(ce);t.texStorage2D(i.TEXTURE_2D,de,Ne,J.width,J.height)}B&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ye,Le,ce)}else t.texImage2D(i.TEXTURE_2D,0,Ne,ye,Le,ce);d(E)&&u(te),Ae.__version=ee.version,E.onUpdate&&E.onUpdate(E)}D.__version=E.version}function oe(D,E,W){if(E.image.length!==6)return;const te=Ge(D,E),re=E.source;t.bindTexture(i.TEXTURE_CUBE_MAP,D.__webglTexture,i.TEXTURE0+W);const ee=n.get(re);if(re.version!==ee.__version||te===!0){t.activeTexture(i.TEXTURE0+W);const Ae=Ke.getPrimaries(Ke.workingColorSpace),me=E.colorSpace===vn?null:Ke.getPrimaries(E.colorSpace),Se=E.colorSpace===vn||Ae===me?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,E.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,E.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Se);const Ye=E.isCompressedTexture||E.image[0].isCompressedTexture,ce=E.image[0]&&E.image[0].isDataTexture,ye=[];for(let ne=0;ne<6;ne++)!Ye&&!ce?ye[ne]=T(E.image[ne],!0,r.maxCubemapSize):ye[ne]=ce?E.image[ne].image:E.image[ne],ye[ne]=De(E,ye[ne]);const Le=ye[0],Ne=s.convert(E.format,E.colorSpace),Ee=s.convert(E.type),qe=R(E.internalFormat,Ne,Ee,E.colorSpace),ke=E.isVideoTexture!==!0,it=ee.__version===void 0||te===!0,B=re.dataReady;let de=U(E,Le);Ue(i.TEXTURE_CUBE_MAP,E);let J;if(Ye){ke&&it&&t.texStorage2D(i.TEXTURE_CUBE_MAP,de,qe,Le.width,Le.height);for(let ne=0;ne<6;ne++){J=ye[ne].mipmaps;for(let ve=0;ve<J.length;ve++){const ge=J[ve];E.format!==Ot?Ne!==null?ke?B&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ve,0,0,ge.width,ge.height,Ne,ge.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ve,qe,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):ke?B&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ve,0,0,ge.width,ge.height,Ne,Ee,ge.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ve,qe,ge.width,ge.height,0,Ne,Ee,ge.data)}}}else{if(J=E.mipmaps,ke&&it){J.length>0&&de++;const ne=fe(ye[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,de,qe,ne.width,ne.height)}for(let ne=0;ne<6;ne++)if(ce){ke?B&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,0,0,ye[ne].width,ye[ne].height,Ne,Ee,ye[ne].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,qe,ye[ne].width,ye[ne].height,0,Ne,Ee,ye[ne].data);for(let ve=0;ve<J.length;ve++){const ze=J[ve].image[ne].image;ke?B&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ve+1,0,0,ze.width,ze.height,Ne,Ee,ze.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ve+1,qe,ze.width,ze.height,0,Ne,Ee,ze.data)}}else{ke?B&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,0,0,Ne,Ee,ye[ne]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,qe,Ne,Ee,ye[ne]);for(let ve=0;ve<J.length;ve++){const ge=J[ve];ke?B&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ve+1,0,0,Ne,Ee,ge.image[ne]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ve+1,qe,Ne,Ee,ge.image[ne])}}}d(E)&&u(i.TEXTURE_CUBE_MAP),ee.__version=re.version,E.onUpdate&&E.onUpdate(E)}D.__version=E.version}function xe(D,E,W,te,re,ee){const Ae=s.convert(W.format,W.colorSpace),me=s.convert(W.type),Se=R(W.internalFormat,Ae,me,W.colorSpace),Ye=n.get(E),ce=n.get(W);if(ce.__renderTarget=E,!Ye.__hasExternalTextures){const ye=Math.max(1,E.width>>ee),Le=Math.max(1,E.height>>ee);re===i.TEXTURE_3D||re===i.TEXTURE_2D_ARRAY?t.texImage3D(re,ee,Se,ye,Le,E.depth,0,Ae,me,null):t.texImage2D(re,ee,Se,ye,Le,0,Ae,me,null)}t.bindFramebuffer(i.FRAMEBUFFER,D),we(E)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,te,re,ce.__webglTexture,0,Te(E)):(re===i.TEXTURE_2D||re>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&re<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,te,re,ce.__webglTexture,ee),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ue(D,E,W){if(i.bindRenderbuffer(i.RENDERBUFFER,D),E.depthBuffer){const te=E.depthTexture,re=te&&te.isDepthTexture?te.type:null,ee=S(E.stencilBuffer,re),Ae=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,me=Te(E);we(E)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,me,ee,E.width,E.height):W?i.renderbufferStorageMultisample(i.RENDERBUFFER,me,ee,E.width,E.height):i.renderbufferStorage(i.RENDERBUFFER,ee,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Ae,i.RENDERBUFFER,D)}else{const te=E.textures;for(let re=0;re<te.length;re++){const ee=te[re],Ae=s.convert(ee.format,ee.colorSpace),me=s.convert(ee.type),Se=R(ee.internalFormat,Ae,me,ee.colorSpace),Ye=Te(E);W&&we(E)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ye,Se,E.width,E.height):we(E)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ye,Se,E.width,E.height):i.renderbufferStorage(i.RENDERBUFFER,Se,E.width,E.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function $(D,E){if(E&&E.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,D),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const te=n.get(E.depthTexture);te.__renderTarget=E,(!te.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),G(E.depthTexture,0);const re=te.__webglTexture,ee=Te(E);if(E.depthTexture.format===ui)we(E)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,re,0,ee):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,re,0);else if(E.depthTexture.format===_i)we(E)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,re,0,ee):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,re,0);else throw new Error("Unknown depthTexture format")}function w(D){const E=n.get(D),W=D.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==D.depthTexture){const te=D.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),te){const re=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,te.removeEventListener("dispose",re)};te.addEventListener("dispose",re),E.__depthDisposeCallback=re}E.__boundDepthTexture=te}if(D.depthTexture&&!E.__autoAllocateDepthBuffer){if(W)throw new Error("target.depthTexture not supported in Cube render targets");$(E.__webglFramebuffer,D)}else if(W){E.__webglDepthbuffer=[];for(let te=0;te<6;te++)if(t.bindFramebuffer(i.FRAMEBUFFER,E.__webglFramebuffer[te]),E.__webglDepthbuffer[te]===void 0)E.__webglDepthbuffer[te]=i.createRenderbuffer(),ue(E.__webglDepthbuffer[te],D,!1);else{const re=D.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ee=E.__webglDepthbuffer[te];i.bindRenderbuffer(i.RENDERBUFFER,ee),i.framebufferRenderbuffer(i.FRAMEBUFFER,re,i.RENDERBUFFER,ee)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=i.createRenderbuffer(),ue(E.__webglDepthbuffer,D,!1);else{const te=D.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,re=E.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,re),i.framebufferRenderbuffer(i.FRAMEBUFFER,te,i.RENDERBUFFER,re)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function P(D,E,W){const te=n.get(D);E!==void 0&&xe(te.__webglFramebuffer,D,D.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),W!==void 0&&w(D)}function N(D){const E=D.texture,W=n.get(D),te=n.get(E);D.addEventListener("dispose",b);const re=D.textures,ee=D.isWebGLCubeRenderTarget===!0,Ae=re.length>1;if(Ae||(te.__webglTexture===void 0&&(te.__webglTexture=i.createTexture()),te.__version=E.version,a.memory.textures++),ee){W.__webglFramebuffer=[];for(let me=0;me<6;me++)if(E.mipmaps&&E.mipmaps.length>0){W.__webglFramebuffer[me]=[];for(let Se=0;Se<E.mipmaps.length;Se++)W.__webglFramebuffer[me][Se]=i.createFramebuffer()}else W.__webglFramebuffer[me]=i.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){W.__webglFramebuffer=[];for(let me=0;me<E.mipmaps.length;me++)W.__webglFramebuffer[me]=i.createFramebuffer()}else W.__webglFramebuffer=i.createFramebuffer();if(Ae)for(let me=0,Se=re.length;me<Se;me++){const Ye=n.get(re[me]);Ye.__webglTexture===void 0&&(Ye.__webglTexture=i.createTexture(),a.memory.textures++)}if(D.samples>0&&we(D)===!1){W.__webglMultisampledFramebuffer=i.createFramebuffer(),W.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,W.__webglMultisampledFramebuffer);for(let me=0;me<re.length;me++){const Se=re[me];W.__webglColorRenderbuffer[me]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,W.__webglColorRenderbuffer[me]);const Ye=s.convert(Se.format,Se.colorSpace),ce=s.convert(Se.type),ye=R(Se.internalFormat,Ye,ce,Se.colorSpace,D.isXRRenderTarget===!0),Le=Te(D);i.renderbufferStorageMultisample(i.RENDERBUFFER,Le,ye,D.width,D.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.RENDERBUFFER,W.__webglColorRenderbuffer[me])}i.bindRenderbuffer(i.RENDERBUFFER,null),D.depthBuffer&&(W.__webglDepthRenderbuffer=i.createRenderbuffer(),ue(W.__webglDepthRenderbuffer,D,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ee){t.bindTexture(i.TEXTURE_CUBE_MAP,te.__webglTexture),Ue(i.TEXTURE_CUBE_MAP,E);for(let me=0;me<6;me++)if(E.mipmaps&&E.mipmaps.length>0)for(let Se=0;Se<E.mipmaps.length;Se++)xe(W.__webglFramebuffer[me][Se],D,E,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+me,Se);else xe(W.__webglFramebuffer[me],D,E,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+me,0);d(E)&&u(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ae){for(let me=0,Se=re.length;me<Se;me++){const Ye=re[me],ce=n.get(Ye);t.bindTexture(i.TEXTURE_2D,ce.__webglTexture),Ue(i.TEXTURE_2D,Ye),xe(W.__webglFramebuffer,D,Ye,i.COLOR_ATTACHMENT0+me,i.TEXTURE_2D,0),d(Ye)&&u(i.TEXTURE_2D)}t.unbindTexture()}else{let me=i.TEXTURE_2D;if((D.isWebGL3DRenderTarget||D.isWebGLArrayRenderTarget)&&(me=D.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(me,te.__webglTexture),Ue(me,E),E.mipmaps&&E.mipmaps.length>0)for(let Se=0;Se<E.mipmaps.length;Se++)xe(W.__webglFramebuffer[Se],D,E,i.COLOR_ATTACHMENT0,me,Se);else xe(W.__webglFramebuffer,D,E,i.COLOR_ATTACHMENT0,me,0);d(E)&&u(me),t.unbindTexture()}D.depthBuffer&&w(D)}function Q(D){const E=D.textures;for(let W=0,te=E.length;W<te;W++){const re=E[W];if(d(re)){const ee=A(D),Ae=n.get(re).__webglTexture;t.bindTexture(ee,Ae),u(ee),t.unbindTexture()}}}const Z=[],L=[];function Pe(D){if(D.samples>0){if(we(D)===!1){const E=D.textures,W=D.width,te=D.height;let re=i.COLOR_BUFFER_BIT;const ee=D.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Ae=n.get(D),me=E.length>1;if(me)for(let Se=0;Se<E.length;Se++)t.bindFramebuffer(i.FRAMEBUFFER,Ae.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Se,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Ae.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Se,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Ae.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ae.__webglFramebuffer);for(let Se=0;Se<E.length;Se++){if(D.resolveDepthBuffer&&(D.depthBuffer&&(re|=i.DEPTH_BUFFER_BIT),D.stencilBuffer&&D.resolveStencilBuffer&&(re|=i.STENCIL_BUFFER_BIT)),me){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Ae.__webglColorRenderbuffer[Se]);const Ye=n.get(E[Se]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ye,0)}i.blitFramebuffer(0,0,W,te,0,0,W,te,re,i.NEAREST),l===!0&&(Z.length=0,L.length=0,Z.push(i.COLOR_ATTACHMENT0+Se),D.depthBuffer&&D.resolveDepthBuffer===!1&&(Z.push(ee),L.push(ee),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,L)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Z))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),me)for(let Se=0;Se<E.length;Se++){t.bindFramebuffer(i.FRAMEBUFFER,Ae.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Se,i.RENDERBUFFER,Ae.__webglColorRenderbuffer[Se]);const Ye=n.get(E[Se]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Ae.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Se,i.TEXTURE_2D,Ye,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ae.__webglMultisampledFramebuffer)}else if(D.depthBuffer&&D.resolveDepthBuffer===!1&&l){const E=D.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[E])}}}function Te(D){return Math.min(r.maxSamples,D.samples)}function we(D){const E=n.get(D);return D.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function le(D){const E=a.render.frame;p.get(D)!==E&&(p.set(D,E),D.update())}function De(D,E){const W=D.colorSpace,te=D.format,re=D.type;return D.isCompressedTexture===!0||D.isVideoTexture===!0||W!==gi&&W!==vn&&(Ke.getTransfer(W)===tt?(te!==Ot||re!==un)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",W)),E}function fe(D){return typeof HTMLImageElement<"u"&&D instanceof HTMLImageElement?(f.width=D.naturalWidth||D.width,f.height=D.naturalHeight||D.height):typeof VideoFrame<"u"&&D instanceof VideoFrame?(f.width=D.displayWidth,f.height=D.displayHeight):(f.width=D.width,f.height=D.height),f}this.allocateTextureUnit=F,this.resetTextureUnits=I,this.setTexture2D=G,this.setTexture2DArray=O,this.setTexture3D=j,this.setTextureCube=X,this.rebindTextures=P,this.setupRenderTarget=N,this.updateRenderTargetMipmap=Q,this.updateMultisampleRenderTarget=Pe,this.setupDepthRenderbuffer=w,this.setupFrameBufferTexture=xe,this.useMultisampledRTT=we}function jp(i,e){function t(n,r=vn){let s;const a=Ke.getTransfer(r);if(n===un)return i.UNSIGNED_BYTE;if(n===Js)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Qs)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Go)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===ko)return i.BYTE;if(n===Vo)return i.SHORT;if(n===Pi)return i.UNSIGNED_SHORT;if(n===$s)return i.INT;if(n===Bn)return i.UNSIGNED_INT;if(n===on)return i.FLOAT;if(n===Li)return i.HALF_FLOAT;if(n===Wo)return i.ALPHA;if(n===Xo)return i.RGB;if(n===Ot)return i.RGBA;if(n===qo)return i.LUMINANCE;if(n===Yo)return i.LUMINANCE_ALPHA;if(n===ui)return i.DEPTH_COMPONENT;if(n===_i)return i.DEPTH_STENCIL;if(n===jo)return i.RED;if(n===ea)return i.RED_INTEGER;if(n===Zo)return i.RG;if(n===ta)return i.RG_INTEGER;if(n===na)return i.RGBA_INTEGER;if(n===or||n===lr||n===cr||n===ur)if(a===tt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===or)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===lr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===cr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ur)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===or)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===lr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===cr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ur)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Es||n===bs||n===Ts||n===As)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Es)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===bs)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ts)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===As)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ws||n===Rs||n===Cs)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===ws||n===Rs)return a===tt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Cs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Ps||n===Ds||n===Ls||n===Is||n===Us||n===Ns||n===Fs||n===Os||n===Bs||n===zs||n===Hs||n===ks||n===Vs||n===Gs)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Ps)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ds)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ls)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Is)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Us)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ns)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Fs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Os)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Bs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===zs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Hs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ks)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Vs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Gs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===hr||n===Ws||n===Xs)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===hr)return a===tt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Ws)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Xs)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ko||n===qs||n===Ys||n===js)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===hr)return s.COMPRESSED_RED_RGTC1_EXT;if(n===qs)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ys)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===js)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===mi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Zp=`
void main() {
...
}`;class $p{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,n){if(this.texture===null){const r=new Ct,s=e.properties.get(r);s.__webglTexture=t.texture,(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new En({vertexShader:Zp,fragmentShader:Kp,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Yt(new vr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Jp extends kn{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,f=null,p=null,_=null,m=null,g=null,M=null;const T=new $p,d=t.getContextAttributes();let u=null,A=null;const R=[],S=[],U=new Oe;let x=null;const b=new Ft;b.viewport=new ot;const v=new Ft;v.viewport=new ot;const h=[b,v],c=new _u;let y=null,I=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let oe=R[K];return oe===void 0&&(oe=new Gr,R[K]=oe),oe.getTargetRaySpace()},this.getControllerGrip=function(K){let oe=R[K];return oe===void 0&&(oe=new Gr,R[K]=oe),oe.getGripSpace()},this.getHand=function(K){let oe=R[K];return oe===void 0&&(oe=new Gr,R[K]=oe),oe.getHandSpace()};function F(K){const oe=S.indexOf(K.inputSource);if(oe===-1)return;const xe=R[oe];xe!==void 0&&(xe.update(K.inputSource,K.frame,f||a),xe.dispatchEvent({type:K.type,data:K.inputSource}))}function k(){r.removeEventListener("select",F),r.removeEventListener("selectstart",F),r.removeEventListener("selectend",F),r.removeEventListener("squeeze",F),r.removeEventListener("squeezestart",F),r.removeEventListener("squeezeend",F),r.removeEventListener("end",k),r.removeEventListener("inputsourceschange",G);for(let K=0;K<R.length;K++){const oe=S[K];oe!==null&&(S[K]=null,R[K].disconnect(oe))}y=null,I=null,T.reset(),e.setRenderTarget(u),g=null,m=null,_=null,r=null,A=null,Ge.stop(),n.isPresenting=!1,e.setPixelRatio(x),e.setSize(U.width,U.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){s=K,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){o=K,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return f||a},this.setReferenceSpace=function(K){f=K},this.getBaseLayer=function(){return m!==null?m:g},this.getBinding=function(){return _},this.getFrame=function(){return M},this.getSession=function(){return r},this.setSession=async function(K){if(r=K,r!==null){if(u=e.getRenderTarget(),r.addEventListener("select",F),r.addEventListener("selectstart",F),r.addEventListener("selectend",F),r.addEventListener("squeeze",F),r.addEventListener("squeezestart",F),r.addEventListener("squeezeend",F),r.addEventListener("end",k),r.addEventListener("inputsourceschange",G),d.xrCompatible!==!0&&await t.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(U),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let xe=null,ue=null,$=null;d.depth&&($=d.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,xe=d.stencil?_i:ui,ue=d.stencil?mi:Bn);const w={colorFormat:t.RGBA8,depthFormat:$,scaleFactor:s};_=new XRWebGLBinding(r,t),m=_.createProjectionLayer(w),r.updateRenderState({layers:[m]}),e.setPixelRatio(1),e.setSize(m.textureWidth,m.textureHeight,!1),A=new zn(m.textureWidth,m.textureHeight,{format:Ot,type:un,depthTexture:new pl(m.textureWidth,m.textureHeight,ue,void 0,void 0,void 0,void 0,void 0,void 0,xe),stencilBuffer:d.stencil,colorSpace:e.outputColorSpace,samples:d.antialias?4:0,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}else{const xe={antialias:d.antialias,alpha:!0,depth:d.depth,stencil:d.stencil,framebufferScaleFactor:s};g=new XRWebGLLayer(r,t,xe),r.updateRenderState({baseLayer:g}),e.setPixelRatio(1),e.setSize(g.framebufferWidth,g.framebufferHeight,!1),A=new zn(g.framebufferWidth,g.framebufferHeight,{format:Ot,type:un,colorSpace:e.outputColorSpace,stencilBuffer:d.stencil,resolveDepthBuffer:g.ignoreDepthValues===!1,resolveStencilBuffer:g.ignoreDepthValues===!1})}A.isXRRenderTarget=!0,this.setFoveation(l),f=null,a=await r.requestReferenceSpace(o),Ge.setContext(r),Ge.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return T.getDepthTexture()};function G(K){for(let oe=0;oe<K.removed.length;oe++){const xe=K.removed[oe],ue=S.indexOf(xe);ue>=0&&(S[ue]=null,R[ue].disconnect(xe))}for(let oe=0;oe<K.added.length;oe++){const xe=K.added[oe];let ue=S.indexOf(xe);if(ue===-1){for(let w=0;w<R.length;w++)if(w>=S.length){S.push(xe),ue=w;break}else if(S[w]===null){S[w]=xe,ue=w;break}if(ue===-1)break}const $=R[ue];$&&$.connect(xe)}}const O=new V,j=new V;function X(K,oe,xe){O.setFromMatrixPosition(oe.matrixWorld),j.setFromMatrixPosition(xe.matrixWorld);const ue=O.distanceTo(j),$=oe.projectionMatrix.elements,w=xe.projectionMatrix.elements,P=$[14]/($[10]-1),N=$[14]/($[10]+1),Q=($[9]+1)/$[5],Z=($[9]-1)/$[5],L=($[8]-1)/$[0],Pe=(w[8]+1)/w[0],Te=P*L,we=P*Pe,le=ue/(-L+Pe),De=le*-L;if(oe.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(De),K.translateZ(le),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),$[10]===-1)K.projectionMatrix.copy(oe.projectionMatrix),K.projectionMatrixInverse.copy(oe.projectionMatrixInverse);else{const fe=P+le,D=N+le,E=Te-De,W=we+(ue-De),te=Q*N/D*fe,re=Z*N/D*fe;K.projectionMatrix.makePerspective(E,W,te,re,fe,D),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function ie(K,oe){oe===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(oe.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(r===null)return;let oe=K.near,xe=K.far;T.texture!==null&&(T.depthNear>0&&(oe=T.depthNear),T.depthFar>0&&(xe=T.depthFar)),c.near=v.near=b.near=oe,c.far=v.far=b.far=xe,(y!==c.near||I!==c.far)&&(r.updateRenderState({depthNear:c.near,depthFar:c.far}),y=c.near,I=c.far),b.layers.mask=K.layers.mask|2,v.layers.mask=K.layers.mask|4,c.layers.mask=b.layers.mask|v.layers.mask;const ue=K.parent,$=c.cameras;ie(c,ue);for(let w=0;w<$.length;w++)ie($[w],ue);$.length===2?X(c,b,v):c.projectionMatrix.copy(b.projectionMatrix),se(K,c,ue)};function se(K,oe,xe){xe===null?K.matrix.copy(oe.matrixWorld):(K.matrix.copy(xe.matrixWorld),K.matrix.invert(),K.matrix.multiply(oe.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(oe.projectionMatrix),K.projectionMatrixInverse.copy(oe.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=Di*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return c},this.getFoveation=function(){if(!(m===null&&g===null))return l},this.setFoveation=function(K){l=K,m!==null&&(m.fixedFoveation=K),g!==null&&g.fixedFoveation!==void 0&&(g.fixedFoveation=K)},this.hasDepthSensing=function(){return T.texture!==null},this.getDepthSensingMesh=function(){return T.getMesh(c)};let _e=null;function Ue(K,oe){if(p=oe.getViewerPose(f||a),M=oe,p!==null){const xe=p.views;g!==null&&(e.setRenderTargetFramebuffer(A,g.framebuffer),e.setRenderTarget(A));let ue=!1;xe.length!==c.cameras.length&&(c.cameras.length=0,ue=!0);for(let P=0;P<xe.length;P++){const N=xe[P];let Q=null;if(g!==null)Q=g.getViewport(N);else{const L=_.getViewSubImage(m,N);Q=L.viewport,P===0&&(e.setRenderTargetTextures(A,L.colorTexture,m.ignoreDepthValues?void 0:L.depthStencilTexture),e.setRenderTarget(A))}let Z=h[P];Z===void 0&&(Z=new Ft,Z.layers.enable(P),Z.viewport=new ot,h[P]=Z),Z.matrix.fromArray(N.transform.matrix),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.projectionMatrix.fromArray(N.projectionMatrix),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert(),Z.viewport.set(Q.x,Q.y,Q.width,Q.height),P===0&&(c.matrix.copy(Z.matrix),c.matrix.decompose(c.position,c.quaternion,c.scale)),ue===!0&&c.cameras.push(Z)}const $=r.enabledFeatures;if($&&$.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&_){const P=_.getDepthInformation(xe[0]);P&&P.isValid&&P.texture&&T.init(e,P,r.renderState)}}for(let xe=0;xe<R.length;xe++){const ue=S[xe],$=R[xe];ue!==null&&$!==void 0&&$.update(ue,oe,f||a)}_e&&_e(K,oe),oe.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:oe}),M=null}const Ge=new vl;Ge.setAnimationLoop(Ue),this.setAnimationLoop=function(K){_e=K},this.dispose=function(){}}}const Ln=new Kt,Qp=new lt;function em(i,e){function t(d,u){d.matrixAutoUpdate===!0&&d.updateMatrix(),u.value.copy(d.matrix)}function n(d,u){u.color.getRGB(d.fogColor.value,cl(i)),u.isFog?(d.fogNear.value=u.near,d.fogFar.value=u.far):u.isFogExp2&&(d.fogDensity.value=u.density)}function r(d,u,A,R,S){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(d,u):u.isMeshToonMaterial?(s(d,u),_(d,u)):u.isMeshPhongMaterial?(s(d,u),p(d,u)):u.isMeshStandardMaterial?(s(d,u),m(d,u),u.isMeshPhysicalMaterial&&g(d,u,S)):u.isMeshMatcapMaterial?(s(d,u),M(d,u)):u.isMeshDepthMaterial?s(d,u):u.isMeshDistanceMaterial?(s(d,u),T(d,u)):u.isMeshNormalMaterial?s(d,u):u.isLineBasicMaterial?(a(d,u),u.isLineDashedMaterial&&o(d,u)):u.isPointsMaterial?l(d,u,A,R):u.isSpriteMaterial?f(d,u):u.isShadowMaterial?(d.color.value.copy(u.color),d.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(d,u){d.opacity.value=u.opacity,u.color&&d.diffuse.value.copy(u.color),u.emissive&&d.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(d.map.value=u.map,t(u.map,d.mapTransform)),u.alphaMap&&(d.alphaMap.value=u.alphaMap,t(u.alphaMap,d.alphaMapTransform)),u.bumpMap&&(d.bumpMap.value=u.bumpMap,t(u.bumpMap,d.bumpMapTransform),d.bumpScale.value=u.bumpScale,u.side===Rt&&(d.bumpScale.value*=-1)),u.normalMap&&(d.normalMap.value=u.normalMap,t(u.normalMap,d.normalMapTransform),d.normalScale.value.copy(u.normalScale),u.side===Rt&&d.normalScale.value.negate()),u.displacementMap&&(d.displacementMap.value=u.displacementMap,t(u.displacementMap,d.displacementMapTransform),d.displacementScale.value=u.displacementScale,d.displacementBias.value=u.displacementBias),u.emissiveMap&&(d.emissiveMap.value=u.emissiveMap,t(u.emissiveMap,d.emissiveMapTransform)),u.specularMap&&(d.specularMap.value=u.specularMap,t(u.specularMap,d.specularMapTransform)),u.alphaTest>0&&(d.alphaTest.value=u.alphaTest);const A=e.get(u),R=A.envMap,S=A.envMapRotation;R&&(d.envMap.value=R,Ln.copy(S),Ln.x*=-1,Ln.y*=-1,Ln.z*=-1,R.isCubeTexture&&R.isRenderTargetTexture===!1&&(Ln.y*=-1,Ln.z*=-1),d.envMapRotation.value.setFromMatrix4(Qp.makeRotationFromEuler(Ln)),d.flipEnvMap.value=R.isCubeTexture&&R.isRenderTargetTexture===!1?-1:1,d.reflectivity.value=u.reflectivity,d.ior.value=u.ior,d.refractionRatio.value=u.refractionRatio),u.lightMap&&(d.lightMap.value=u.lightMap,d.lightMapIntensity.value=u.lightMapIntensity,t(u.lightMap,d.lightMapTransform)),u.aoMap&&(d.aoMap.value=u.aoMap,d.aoMapIntensity.value=u.aoMapIntensity,t(u.aoMap,d.aoMapTransform))}function a(d,u){d.diffuse.value.copy(u.color),d.opacity.value=u.opacity,u.map&&(d.map.value=u.map,t(u.map,d.mapTransform))}function o(d,u){d.dashSize.value=u.dashSize,d.totalSize.value=u.dashSize+u.gapSize,d.scale.value=u.scale}function l(d,u,A,R){d.diffuse.value.copy(u.color),d.opacity.value=u.opacity,d.size.value=u.size*A,d.scale.value=R*.5,u.map&&(d.map.value=u.map,t(u.map,d.uvTransform)),u.alphaMap&&(d.alphaMap.value=u.alphaMap,t(u.alphaMap,d.alphaMapTransform)),u.alphaTest>0&&(d.alphaTest.value=u.alphaTest)}function f(d,u){d.diffuse.value.copy(u.color),d.opacity.value=u.opacity,d.rotation.value=u.rotation,u.map&&(d.map.value=u.map,t(u.map,d.mapTransform)),u.alphaMap&&(d.alphaMap.value=u.alphaMap,t(u.alphaMap,d.alphaMapTransform)),u.alphaTest>0&&(d.alphaTest.value=u.alphaTest)}function p(d,u){d.specular.value.copy(u.specular),d.shininess.value=Math.max(u.shininess,1e-4)}function _(d,u){u.gradientMap&&(d.gradientMap.value=u.gradientMap)}function m(d,u){d.metalness.value=u.metalness,u.metalnessMap&&(d.metalnessMap.value=u.metalnessMap,t(u.metalnessMap,d.metalnessMapTransform)),d.roughness.value=u.roughness,u.roughnessMap&&(d.roughnessMap.value=u.roughnessMap,t(u.roughnessMap,d.roughnessMapTransform)),u.envMap&&(d.envMapIntensity.value=u.envMapIntensity)}function g(d,u,A){d.ior.value=u.ior,u.sheen>0&&(d.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),d.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(d.sheenColorMap.value=u.sheenColorMap,t(u.sheenColorMap,d.sheenColorMapTransform)),u.sheenRoughnessMap&&(d.sheenRoughnessMap.value=u.sheenRoughnessMap,t(u.sheenRoughnessMap,d.sheenRoughnessMapTransform))),u.clearcoat>0&&(d.clearcoat.value=u.clearcoat,d.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(d.clearcoatMap.value=u.clearcoatMap,t(u.clearcoatMap,d.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(d.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,t(u.clearcoatRoughnessMap,d.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(d.clearcoatNormalMap.value=u.clearcoatNormalMap,t(u.clearcoatNormalMap,d.clearcoatNormalMapTransform),d.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Rt&&d.clearcoatNormalScale.value.negate())),u.dispersion>0&&(d.dispersion.value=u.dispersion),u.iridescence>0&&(d.iridescence.value=u.iridescence,d.iridescenceIOR.value=u.iridescenceIOR,d.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],d.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(d.iridescenceMap.value=u.iridescenceMap,t(u.iridescenceMap,d.iridescenceMapTransform)),u.iridescenceThicknessMap&&(d.iridescenceThicknessMap.value=u.iridescenceThicknessMap,t(u.iridescenceThicknessMap,d.iridescenceThicknessMapTransform))),u.transmission>0&&(d.transmission.value=u.transmission,d.transmissionSamplerMap.value=A.texture,d.transmissionSamplerSize.value.set(A.width,A.height),u.transmissionMap&&(d.transmissionMap.value=u.transmissionMap,t(u.transmissionMap,d.transmissionMapTransform)),d.thickness.value=u.thickness,u.thicknessMap&&(d.thicknessMap.value=u.thicknessMap,t(u.thicknessMap,d.thicknessMapTransform)),d.attenuationDistance.value=u.attenuationDistance,d.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(d.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(d.anisotropyMap.value=u.anisotropyMap,t(u.anisotropyMap,d.anisotropyMapTransform))),d.specularIntensity.value=u.specularIntensity,d.specularColor.value.copy(u.specularColor),u.specularColorMap&&(d.specularColorMap.value=u.specularColorMap,t(u.specularColorMap,d.specularColorMapTransform)),u.specularIntensityMap&&(d.specularIntensityMap.value=u.specularIntensityMap,t(u.specularIntensityMap,d.specularIntensityMapTransform))}function M(d,u){u.matcap&&(d.matcap.value=u.matcap)}function T(d,u){const A=e.get(u).light;d.referencePosition.value.setFromMatrixPosition(A.matrixWorld),d.nearDistance.value=A.shadow.camera.near,d.farDistance.value=A.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function tm(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(A,R){const S=R.program;n.uniformBlockBinding(A,S)}function f(A,R){let S=r[A.id];S===void 0&&(M(A),S=p(A),r[A.id]=S,A.addEventListener("dispose",d));const U=R.program;n.updateUBOMapping(A,U);const x=e.render.frame;s[A.id]!==x&&(m(A),s[A.id]=x)}function p(A){const R=_();A.__bindingPointIndex=R;const S=i.createBuffer(),U=A.__size,x=A.usage;return i.bindBuffer(i.UNIFORM_BUFFER,S),i.bufferData(i.UNIFORM_BUFFER,U,x),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,R,S),S}function _(){for(let A=0;A<o;A++)if(a.indexOf(A)===-1)return a.push(A),A;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function m(A){const R=r[A.id],S=A.uniforms,U=A.__cache;i.bindBuffer(i.UNIFORM_BUFFER,R);for(let x=0,b=S.length;x<b;x++){const v=Array.isArray(S[x])?S[x]:[S[x]];for(let h=0,c=v.length;h<c;h++){const y=v[h];if(g(y,x,h,U)===!0){const I=y.__offset,F=Array.isArray(y.value)?y.value:[y.value];let k=0;for(let G=0;G<F.length;G++){const O=F[G],j=T(O);typeof O=="number"||typeof O=="boolean"?(y.__data[0]=O,i.bufferSubData(i.UNIFORM_BUFFER,I+k,y.__data)):O.isMatrix3?(y.__data[0]=O.elements[0],y.__data[1]=O.elements[1],y.__data[2]=O.elements[2],y.__data[3]=0,y.__data[4]=O.elements[3],y.__data[5]=O.elements[4],y.__data[6]=O.elements[5],y.__data[7]=0,y.__data[8]=O.elements[6],y.__data[9]=O.elements[7],y.__data[10]=O.elements[8],y.__data[11]=0):(O.toArray(y.__data,k),k+=j.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,I,y.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function g(A,R,S,U){const x=A.value,b=R+"_"+S;if(U[b]===void 0)return typeof x=="number"||typeof x=="boolean"?U[b]=x:U[b]=x.clone(),!0;{const v=U[b];if(typeof x=="number"||typeof x=="boolean"){if(v!==x)return U[b]=x,!0}else if(v.equals(x)===!1)return v.copy(x),!0}return!1}function M(A){const R=A.uniforms;let S=0;const U=16;for(let b=0,v=R.length;b<v;b++){const h=Array.isArray(R[b])?R[b]:[R[b]];for(let c=0,y=h.length;c<y;c++){const I=h[c],F=Array.isArray(I.value)?I.value:[I.value];for(let k=0,G=F.length;k<G;k++){const O=F[k],j=T(O),X=S%U,ie=X%j.boundary,se=X+ie;S+=ie,se!==0&&U-se<j.storage&&(S+=U-se),I.__data=new Float32Array(j.storage/Float32Array.BYTES_PER_ELEMENT),I.__offset=S,S+=j.storage}}}const x=S%U;return x>0&&(S+=U-x),A.__size=S,A.__cache={},this}function T(A){const R={boundary:0,storage:0};return typeof A=="number"||typeof A=="boolean"?(R.boundary=4,R.storage=4):A.isVector2?(R.boundary=8,R.storage=8):A.isVector3||A.isColor?(R.boundary=16,R.storage=12):A.isVector4?(R.boundary=16,R.storage=16):A.isMatrix3?(R.boundary=48,R.storage=48):A.isMatrix4?(R.boundary=64,R.storage=64):A.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",A),R}function d(A){const R=A.target;R.removeEventListener("dispose",d);const S=a.indexOf(R.__bindingPointIndex);a.splice(S,1),i.deleteBuffer(r[R.id]),delete r[R.id],delete s[R.id]}function u(){for(const A in r)i.deleteBuffer(r[A]);a=[],r={},s={}}return{bind:l,update:f,dispose:u}}class nm{constructor(e={}){const{canvas:t=Nc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:f=!1,powerPreference:p="default",failIfMajorPerformanceCaveat:_=!1,reverseDepthBuffer:m=!1}=e;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=a;const M=new Uint32Array(4),T=new Int32Array(4);let d=null,u=null;const A=[],R=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=wt,this.toneMapping=Sn,this.toneMappingExposure=1;const S=this;let U=!1,x=0,b=0,v=null,h=-1,c=null;const y=new ot,I=new ot;let F=null;const k=new Xe(0);let G=0,O=t.width,j=t.height,X=1,ie=null,se=null;const _e=new ot(0,0,O,j),Ue=new ot(0,0,O,j);let Ge=!1;const K=new aa;let oe=!1,xe=!1;this.transmissionResolutionScale=1;const ue=new lt,$=new lt,w=new V,P=new ot,N={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Q=!1;function Z(){return v===null?X:1}let L=n;function Pe(C,z){return t.getContext(C,z)}try{const C={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:f,powerPreference:p,failIfMajorPerformanceCaveat:_};if("setAttribute"in t&&t.setAttribute("data-engine","three.js r174"),t.addEventListener("webglcontextlost",ne,!1),t.addEventListener("webglcontextrestored",ve,!1),t.addEventListener("webglcontextcreationerror",ge,!1),L===null){const z="webgl2";if(L=Pe(z,C),L===null)throw Pe(z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(C){throw console.error("THREE.WebGLRenderer: "+C.message),C}let Te,we,le,De,fe,D,E,W,te,re,ee,Ae,me,Se,Ye,ce,ye,Le,Ne,Ee,qe,ke,it,B;function de(){Te=new fd(L),Te.init(),ke=new jp(L,Te),we=new sd(L,Te,e,ke),le=new qp(L,Te),we.reverseDepthBuffer&&m&&le.buffers.depth.setReversed(!0),De=new md(L),fe=new Ip,D=new Yp(L,Te,le,fe,we,ke,De),E=new od(S),W=new hd(S),te=new Mu(L),it=new id(L,te),re=new dd(L,te,De,it),ee=new gd(L,re,te,De),Ne=new _d(L,we,D),ce=new ad(fe),Ae=new Lp(S,E,W,Te,we,it,ce),me=new em(S,fe),Se=new Np,Ye=new kp(Te),Le=new nd(S,E,W,le,ee,g,l),ye=new Wp(S,ee,we),B=new tm(L,De,we,le),Ee=new rd(L,Te,De),qe=new pd(L,Te,De),De.programs=Ae.programs,S.capabilities=we,S.extensions=Te,S.properties=fe,S.renderLists=Se,S.shadowMap=ye,S.state=le,S.info=De}de();const J=new Jp(S,L);this.xr=J,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){const C=Te.get("WEBGL_lose_context");C&&C.loseContext()},this.forceContextRestore=function(){const C=Te.get("WEBGL_lose_context");C&&C.restoreContext()},this.getPixelRatio=function(){return X},this.setPixelRatio=function(C){C!==void 0&&(X=C,this.setSize(O,j,!1))},this.getSize=function(C){return C.set(O,j)},this.setSize=function(C,z,q=!0){if(J.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}O=C,j=z,t.width=Math.floor(C*X),t.height=Math.floor(z*X),q===!0&&(t.style.width=C+"px",t.style.height=z+"px"),this.setViewport(0,0,C,z)},this.getDrawingBufferSize=function(C){return C.set(O*X,j*X).floor()},this.setDrawingBufferSize=function(C,z,q){O=C,j=z,X=q,t.width=Math.floor(C*q),t.height=Math.floor(z*q),this.setViewport(0,0,C,z)},this.getCurrentViewport=function(C){return C.copy(y)},this.getViewport=function(C){return C.copy(_e)},this.setViewport=function(C,z,q,Y){C.isVector4?_e.set(C.x,C.y,C.z,C.w):_e.set(C,z,q,Y),le.viewport(y.copy(_e).multiplyScalar(X).round())},this.getScissor=function(C){return C.copy(Ue)},this.setScissor=function(C,z,q,Y){C.isVector4?Ue.set(C.x,C.y,C.z,C.w):Ue.set(C,z,q,Y),le.scissor(I.copy(Ue).multiplyScalar(X).round())},this.getScissorTest=function(){return Ge},this.setScissorTest=function(C){le.setScissorTest(Ge=C)},this.setOpaqueSort=function(C){ie=C},this.setTransparentSort=function(C){se=C},this.getClearColor=function(C){return C.copy(Le.getClearColor())},this.setClearColor=function(){Le.setClearColor(...arguments)},this.getClearAlpha=function(){return Le.getClearAlpha()},this.setClearAlpha=function(){Le.setClearAlpha(...arguments)},this.clear=function(C=!0,z=!0,q=!0){let Y=0;if(C){let H=!1;if(v!==null){const ae=v.texture.format;H=ae===na||ae===ta||ae===ea}if(H){const ae=v.texture.type,pe=ae===un||ae===Bn||ae===Pi||ae===mi||ae===Js||ae===Qs,Me=Le.getClearColor(),be=Le.getClearAlpha(),Fe=Me.r,Be=Me.g,Re=Me.b;pe?(M[0]=Fe,M[1]=Be,M[2]=Re,M[3]=be,L.clearBufferuiv(L.COLOR,0,M)):(T[0]=Fe,T[1]=Be,T[2]=Re,T[3]=be,L.clearBufferiv(L.COLOR,0,T))}else Y|=L.COLOR_BUFFER_BIT}z&&(Y|=L.DEPTH_BUFFER_BIT),q&&(Y|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),L.clear(Y)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ne,!1),t.removeEventListener("webglcontextrestored",ve,!1),t.removeEventListener("webglcontextcreationerror",ge,!1),Le.dispose(),Se.dispose(),Ye.dispose(),fe.dispose(),E.dispose(),W.dispose(),ee.dispose(),it.dispose(),B.dispose(),Ae.dispose(),J.dispose(),J.removeEventListener("sessionstart",ha),J.removeEventListener("sessionend",fa),Tn.stop()};function ne(C){C.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),U=!0}function ve(){console.log("THREE.WebGLRenderer: Context Restored."),U=!1;const C=De.autoReset,z=ye.enabled,q=ye.autoUpdate,Y=ye.needsUpdate,H=ye.type;de(),De.autoReset=C,ye.enabled=z,ye.autoUpdate=q,ye.needsUpdate=Y,ye.type=H}function ge(C){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",C.statusMessage)}function ze(C){const z=C.target;z.removeEventListener("dispose",ze),st(z)}function st(C){_t(C),fe.remove(C)}function _t(C){const z=fe.get(C).programs;z!==void 0&&(z.forEach(function(q){Ae.releaseProgram(q)}),C.isShaderMaterial&&Ae.releaseShaderCache(C))}this.renderBufferDirect=function(C,z,q,Y,H,ae){z===null&&(z=N);const pe=H.isMesh&&H.matrixWorld.determinant()<0,Me=Rl(C,z,q,Y,H);le.setMaterial(Y,pe);let be=q.index,Fe=1;if(Y.wireframe===!0){if(be=re.getWireframeAttribute(q),be===void 0)return;Fe=2}const Be=q.drawRange,Re=q.attributes.position;let je=Be.start*Fe,$e=(Be.start+Be.count)*Fe;ae!==null&&(je=Math.max(je,ae.start*Fe),$e=Math.min($e,(ae.start+ae.count)*Fe)),be!==null?(je=Math.max(je,0),$e=Math.min($e,be.count)):Re!=null&&(je=Math.max(je,0),$e=Math.min($e,Re.count));const ct=$e-je;if(ct<0||ct===1/0)return;it.setup(H,Y,Me,q,be);let at,Ze=Ee;if(be!==null&&(at=te.get(be),Ze=qe,Ze.setIndex(at)),H.isMesh)Y.wireframe===!0?(le.setLineWidth(Y.wireframeLinewidth*Z()),Ze.setMode(L.LINES)):Ze.setMode(L.TRIANGLES);else if(H.isLine){let Ce=Y.linewidth;Ce===void 0&&(Ce=1),le.setLineWidth(Ce*Z()),H.isLineSegments?Ze.setMode(L.LINES):H.isLineLoop?Ze.setMode(L.LINE_LOOP):Ze.setMode(L.LINE_STRIP)}else H.isPoints?Ze.setMode(L.POINTS):H.isSprite&&Ze.setMode(L.TRIANGLES);if(H.isBatchedMesh)if(H._multiDrawInstances!==null)In("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Ze.renderMultiDrawInstances(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount,H._multiDrawInstances);else if(Te.get("WEBGL_multi_draw"))Ze.renderMultiDraw(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount);else{const Ce=H._multiDrawStarts,mt=H._multiDrawCounts,Je=H._multiDrawCount,zt=be?te.get(be).bytesPerElement:1,Vn=fe.get(Y).currentProgram.getUniforms();for(let Pt=0;Pt<Je;Pt++)Vn.setValue(L,"_gl_DrawID",Pt),Ze.render(Ce[Pt]/zt,mt[Pt])}else if(H.isInstancedMesh)Ze.renderInstances(je,ct,H.count);else if(q.isInstancedBufferGeometry){const Ce=q._maxInstanceCount!==void 0?q._maxInstanceCount:1/0,mt=Math.min(q.instanceCount,Ce);Ze.renderInstances(je,ct,mt)}else Ze.render(je,ct)};function Qe(C,z,q){C.transparent===!0&&C.side===an&&C.forceSinglePass===!1?(C.side=Rt,C.needsUpdate=!0,Fi(C,z,q),C.side=yn,C.needsUpdate=!0,Fi(C,z,q),C.side=an):Fi(C,z,q)}this.compile=function(C,z,q=null){q===null&&(q=C),u=Ye.get(q),u.init(z),R.push(u),q.traverseVisible(function(H){H.isLight&&H.layers.test(z.layers)&&(u.pushLight(H),H.castShadow&&u.pushShadow(H))}),C!==q&&C.traverseVisible(function(H){H.isLight&&H.layers.test(z.layers)&&(u.pushLight(H),H.castShadow&&u.pushShadow(H))}),u.setupLights();const Y=new Set;return C.traverse(function(H){if(!(H.isMesh||H.isPoints||H.isLine||H.isSprite))return;const ae=H.material;if(ae)if(Array.isArray(ae))for(let pe=0;pe<ae.length;pe++){const Me=ae[pe];Qe(Me,q,H),Y.add(Me)}else Qe(ae,q,H),Y.add(ae)}),u=R.pop(),Y},this.compileAsync=function(C,z,q=null){const Y=this.compile(C,z,q);return new Promise(H=>{function ae(){if(Y.forEach(function(pe){fe.get(pe).currentProgram.isReady()&&Y.delete(pe)}),Y.size===0){H(C);return}setTimeout(ae,10)}Te.get("KHR_parallel_shader_compile")!==null?ae():setTimeout(ae,10)})};let Bt=null;function $t(C){Bt&&Bt(C)}function ha(){Tn.stop()}function fa(){Tn.start()}const Tn=new vl;Tn.setAnimationLoop($t),typeof self<"u"&&Tn.setContext(self),this.setAnimationLoop=function(C){Bt=C,J.setAnimationLoop(C),C===null?Tn.stop():Tn.start()},J.addEventListener("sessionstart",ha),J.addEventListener("sessionend",fa),this.render=function(C,z){if(z!==void 0&&z.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(U===!0)return;if(C.matrixWorldAutoUpdate===!0&&C.updateMatrixWorld(),z.parent===null&&z.matrixWorldAutoUpdate===!0&&z.updateMatrixWorld(),J.enabled===!0&&J.isPresenting===!0&&(J.cameraAutoUpdate===!0&&J.updateCamera(z),z=J.getCamera()),C.isScene===!0&&C.onBeforeRender(S,C,z,v),u=Ye.get(C,R.length),u.init(z),R.push(u),$.multiplyMatrices(z.projectionMatrix,z.matrixWorldInverse),K.setFromProjectionMatrix($),xe=this.localClippingEnabled,oe=ce.init(this.clippingPlanes,xe),d=Se.get(C,A.length),d.init(),A.push(d),J.enabled===!0&&J.isPresenting===!0){const ae=S.xr.getDepthSensingMesh();ae!==null&&Sr(ae,z,-1/0,S.sortObjects)}Sr(C,z,0,S.sortObjects),d.finish(),S.sortObjects===!0&&d.sort(ie,se),Q=J.enabled===!1||J.isPresenting===!1||J.hasDepthSensing()===!1,Q&&Le.addToRenderList(d,C),this.info.render.frame++,oe===!0&&ce.beginShadows();const q=u.state.shadowsArray;ye.render(q,C,z),oe===!0&&ce.endShadows(),this.info.autoReset===!0&&this.info.reset();const Y=d.opaque,H=d.transmissive;if(u.setupLights(),z.isArrayCamera){const ae=z.cameras;if(H.length>0)for(let pe=0,Me=ae.length;pe<Me;pe++){const be=ae[pe];pa(Y,H,C,be)}Q&&Le.render(C);for(let pe=0,Me=ae.length;pe<Me;pe++){const be=ae[pe];da(d,C,be,be.viewport)}}else H.length>0&&pa(Y,H,C,z),Q&&Le.render(C),da(d,C,z);v!==null&&b===0&&(D.updateMultisampleRenderTarget(v),D.updateRenderTargetMipmap(v)),C.isScene===!0&&C.onAfterRender(S,C,z),it.resetDefaultState(),h=-1,c=null,R.pop(),R.length>0?(u=R[R.length-1],oe===!0&&ce.setGlobalState(S.clippingPlanes,u.state.camera)):u=null,A.pop(),A.length>0?d=A[A.length-1]:d=null};function Sr(C,z,q,Y){if(C.visible===!1)return;if(C.layers.test(z.layers)){if(C.isGroup)q=C.renderOrder;else if(C.isLOD)C.autoUpdate===!0&&C.update(z);else if(C.isLight)u.pushLight(C),C.castShadow&&u.pushShadow(C);else if(C.isSprite){if(!C.frustumCulled||K.intersectsSprite(C)){Y&&P.setFromMatrixPosition(C.matrixWorld).applyMatrix4($);const pe=ee.update(C),Me=C.material;Me.visible&&d.push(C,pe,Me,q,P.z,null)}}else if((C.isMesh||C.isLine||C.isPoints)&&(!C.frustumCulled||K.intersectsObject(C))){const pe=ee.update(C),Me=C.material;if(Y&&(C.boundingSphere!==void 0?(C.boundingSphere===null&&C.computeBoundingSphere(),P.copy(C.boundingSphere.center)):(pe.boundingSphere===null&&pe.computeBoundingSphere(),P.copy(pe.boundingSphere.center)),P.applyMatrix4(C.matrixWorld).applyMatrix4($)),Array.isArray(Me)){const be=pe.groups;for(let Fe=0,Be=be.length;Fe<Be;Fe++){const Re=be[Fe],je=Me[Re.materialIndex];je&&je.visible&&d.push(C,pe,je,q,P.z,Re)}}else Me.visible&&d.push(C,pe,Me,q,P.z,null)}}const ae=C.children;for(let pe=0,Me=ae.length;pe<Me;pe++)Sr(ae[pe],z,q,Y)}function da(C,z,q,Y){const H=C.opaque,ae=C.transmissive,pe=C.transparent;u.setupLightsView(q),oe===!0&&ce.setGlobalState(S.clippingPlanes,q),Y&&le.viewport(y.copy(Y)),H.length>0&&Ni(H,z,q),ae.length>0&&Ni(ae,z,q),pe.length>0&&Ni(pe,z,q),le.buffers.depth.setTest(!0),le.buffers.depth.setMask(!0),le.buffers.color.setMask(!0),le.setPolygonOffset(!1)}function pa(C,z,q,Y){if((q.isScene===!0?q.overrideMaterial:null)!==null)return;u.state.transmissionRenderTarget[Y.id]===void 0&&(u.state.transmissionRenderTarget[Y.id]=new zn(1,1,{generateMipmaps:!0,type:Te.has("EXT_color_buffer_half_float")||Te.has("EXT_color_buffer_float")?Li:un,minFilter:xn,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ke.workingColorSpace}));const ae=u.state.transmissionRenderTarget[Y.id],pe=Y.viewport||y;ae.setSize(pe.z*S.transmissionResolutionScale,pe.w*S.transmissionResolutionScale);const Me=S.getRenderTarget();S.setRenderTarget(ae),S.getClearColor(k),G=S.getClearAlpha(),G<1&&S.setClearColor(16777215,.5),S.clear(),Q&&Le.render(q);const be=S.toneMapping;S.toneMapping=Sn;const Fe=Y.viewport;if(Y.viewport!==void 0&&(Y.viewport=void 0),u.setupLightsView(Y),oe===!0&&ce.setGlobalState(S.clippingPlanes,Y),Ni(C,q,Y),D.updateMultisampleRenderTarget(ae),D.updateRenderTargetMipmap(ae),Te.has("WEBGL_multisampled_render_to_texture")===!1){let Be=!1;for(let Re=0,je=z.length;Re<je;Re++){const $e=z[Re],ct=$e.object,at=$e.geometry,Ze=$e.material,Ce=$e.group;if(Ze.side===an&&ct.layers.test(Y.layers)){const mt=Ze.side;Ze.side=Rt,Ze.needsUpdate=!0,ma(ct,q,Y,at,Ze,Ce),Ze.side=mt,Ze.needsUpdate=!0,Be=!0}}Be===!0&&(D.updateMultisampleRenderTarget(ae),D.updateRenderTargetMipmap(ae))}S.setRenderTarget(Me),S.setClearColor(k,G),Fe!==void 0&&(Y.viewport=Fe),S.toneMapping=be}function Ni(C,z,q){const Y=z.isScene===!0?z.overrideMaterial:null;for(let H=0,ae=C.length;H<ae;H++){const pe=C[H],Me=pe.object,be=pe.geometry,Fe=Y===null?pe.material:Y,Be=pe.group;Me.layers.test(q.layers)&&ma(Me,z,q,be,Fe,Be)}}function ma(C,z,q,Y,H,ae){C.onBeforeRender(S,z,q,Y,H,ae),C.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,C.matrixWorld),C.normalMatrix.getNormalMatrix(C.modelViewMatrix),H.onBeforeRender(S,z,q,Y,C,ae),H.transparent===!0&&H.side===an&&H.forceSinglePass===!1?(H.side=Rt,H.needsUpdate=!0,S.renderBufferDirect(q,z,Y,H,C,ae),H.side=yn,H.needsUpdate=!0,S.renderBufferDirect(q,z,Y,H,C,ae),H.side=an):S.renderBufferDirect(q,z,Y,H,C,ae),C.onAfterRender(S,z,q,Y,H,ae)}function Fi(C,z,q){z.isScene!==!0&&(z=N);const Y=fe.get(C),H=u.state.lights,ae=u.state.shadowsArray,pe=H.state.version,Me=Ae.getParameters(C,H.state,ae,z,q),be=Ae.getProgramCacheKey(Me);let Fe=Y.programs;Y.environment=C.isMeshStandardMaterial?z.environment:null,Y.fog=z.fog,Y.envMap=(C.isMeshStandardMaterial?W:E).get(C.envMap||Y.environment),Y.envMapRotation=Y.environment!==null&&C.envMap===null?z.environmentRotation:C.envMapRotation,Fe===void 0&&(C.addEventListener("dispose",ze),Fe=new Map,Y.programs=Fe);let Be=Fe.get(be);if(Be!==void 0){if(Y.currentProgram===Be&&Y.lightsStateVersion===pe)return ga(C,Me),Be}else Me.uniforms=Ae.getUniforms(C),C.onBeforeCompile(Me,S),Be=Ae.acquireProgram(Me,be),Fe.set(be,Be),Y.uniforms=Me.uniforms;const Re=Y.uniforms;return(!C.isShaderMaterial&&!C.isRawShaderMaterial||C.clipping===!0)&&(Re.clippingPlanes=ce.uniform),ga(C,Me),Y.needsLights=Pl(C),Y.lightsStateVersion=pe,Y.needsLights&&(Re.ambientLightColor.value=H.state.ambient,Re.lightProbe.value=H.state.probe,Re.directionalLights.value=H.state.directional,Re.directionalLightShadows.value=H.state.directionalShadow,Re.spotLights.value=H.state.spot,Re.spotLightShadows.value=H.state.spotShadow,Re.rectAreaLights.value=H.state.rectArea,Re.ltc_1.value=H.state.rectAreaLTC1,Re.ltc_2.value=H.state.rectAreaLTC2,Re.pointLights.value=H.state.point,Re.pointLightShadows.value=H.state.pointShadow,Re.hemisphereLights.value=H.state.hemi,Re.directionalShadowMap.value=H.state.directionalShadowMap,Re.directionalShadowMatrix.value=H.state.directionalShadowMatrix,Re.spotShadowMap.value=H.state.spotShadowMap,Re.spotLightMatrix.value=H.state.spotLightMatrix,Re.spotLightMap.value=H.state.spotLightMap,Re.pointShadowMap.value=H.state.pointShadowMap,Re.pointShadowMatrix.value=H.state.pointShadowMatrix),Y.currentProgram=Be,Y.uniformsList=null,Be}function _a(C){if(C.uniformsList===null){const z=C.currentProgram.getUniforms();C.uniformsList=fr.seqWithValue(z.seq,C.uniforms)}return C.uniformsList}function ga(C,z){const q=fe.get(C);q.outputColorSpace=z.outputColorSpace,q.batching=z.batching,q.batchingColor=z.batchingColor,q.instancing=z.instancing,q.instancingColor=z.instancingColor,q.instancingMorph=z.instancingMorph,q.skinning=z.skinning,q.morphTargets=z.morphTargets,q.morphNormals=z.morphNormals,q.morphColors=z.morphColors,q.morphTargetsCount=z.morphTargetsCount,q.numClippingPlanes=z.numClippingPlanes,q.numIntersection=z.numClipIntersection,q.vertexAlphas=z.vertexAlphas,q.vertexTangents=z.vertexTangents,q.toneMapping=z.toneMapping}function Rl(C,z,q,Y,H){z.isScene!==!0&&(z=N),D.resetTextureUnits();const ae=z.fog,pe=Y.isMeshStandardMaterial?z.environment:null,Me=v===null?S.outputColorSpace:v.isXRRenderTarget===!0?v.texture.colorSpace:gi,be=(Y.isMeshStandardMaterial?W:E).get(Y.envMap||pe),Fe=Y.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,Be=!!q.attributes.tangent&&(!!Y.normalMap||Y.anisotropy>0),Re=!!q.morphAttributes.position,je=!!q.morphAttributes.normal,$e=!!q.morphAttributes.color;let ct=Sn;Y.toneMapped&&(v===null||v.isXRRenderTarget===!0)&&(ct=S.toneMapping);const at=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,Ze=at!==void 0?at.length:0,Ce=fe.get(Y),mt=u.state.lights;if(oe===!0&&(xe===!0||C!==c)){const Mt=C===c&&Y.id===h;ce.setState(Y,C,Mt)}let Je=!1;Y.version===Ce.__version?(Ce.needsLights&&Ce.lightsStateVersion!==mt.state.version||Ce.outputColorSpace!==Me||H.isBatchedMesh&&Ce.batching===!1||!H.isBatchedMesh&&Ce.batching===!0||H.isBatchedMesh&&Ce.batchingColor===!0&&H.colorTexture===null||H.isBatchedMesh&&Ce.batchingColor===!1&&H.colorTexture!==null||H.isInstancedMesh&&Ce.instancing===!1||!H.isInstancedMesh&&Ce.instancing===!0||H.isSkinnedMesh&&Ce.skinning===!1||!H.isSkinnedMesh&&Ce.skinning===!0||H.isInstancedMesh&&Ce.instancingColor===!0&&H.instanceColor===null||H.isInstancedMesh&&Ce.instancingColor===!1&&H.instanceColor!==null||H.isInstancedMesh&&Ce.instancingMorph===!0&&H.morphTexture===null||H.isInstancedMesh&&Ce.instancingMorph===!1&&H.morphTexture!==null||Ce.envMap!==be||Y.fog===!0&&Ce.fog!==ae||Ce.numClippingPlanes!==void 0&&(Ce.numClippingPlanes!==ce.numPlanes||Ce.numIntersection!==ce.numIntersection)||Ce.vertexAlphas!==Fe||Ce.vertexTangents!==Be||Ce.morphTargets!==Re||Ce.morphNormals!==je||Ce.morphColors!==$e||Ce.toneMapping!==ct||Ce.morphTargetsCount!==Ze)&&(Je=!0):(Je=!0,Ce.__version=Y.version);let zt=Ce.currentProgram;Je===!0&&(zt=Fi(Y,z,H));let Vn=!1,Pt=!1,yi=!1;const rt=zt.getUniforms(),It=Ce.uniforms;if(le.useProgram(zt.program)&&(Vn=!0,Pt=!0,yi=!0),Y.id!==h&&(h=Y.id,Pt=!0),Vn||c!==C){le.buffers.depth.getReversed()?(ue.copy(C.projectionMatrix),Oc(ue),Bc(ue),rt.setValue(L,"projectionMatrix",ue)):rt.setValue(L,"projectionMatrix",C.projectionMatrix),rt.setValue(L,"viewMatrix",C.matrixWorldInverse);const Et=rt.map.cameraPosition;Et!==void 0&&Et.setValue(L,w.setFromMatrixPosition(C.matrixWorld)),we.logarithmicDepthBuffer&&rt.setValue(L,"logDepthBufFC",2/(Math.log(C.far+1)/Math.LN2)),(Y.isMeshPhongMaterial||Y.isMeshToonMaterial||Y.isMeshLambertMaterial||Y.isMeshBasicMaterial||Y.isMeshStandardMaterial||Y.isShaderMaterial)&&rt.setValue(L,"isOrthographic",C.isOrthographicCamera===!0),c!==C&&(c=C,Pt=!0,yi=!0)}if(H.isSkinnedMesh){rt.setOptional(L,H,"bindMatrix"),rt.setOptional(L,H,"bindMatrixInverse");const Mt=H.skeleton;Mt&&(Mt.boneTexture===null&&Mt.computeBoneTexture(),rt.setValue(L,"boneTexture",Mt.boneTexture,D))}H.isBatchedMesh&&(rt.setOptional(L,H,"batchingTexture"),rt.setValue(L,"batchingTexture",H._matricesTexture,D),rt.setOptional(L,H,"batchingIdTexture"),rt.setValue(L,"batchingIdTexture",H._indirectTexture,D),rt.setOptional(L,H,"batchingColorTexture"),H._colorsTexture!==null&&rt.setValue(L,"batchingColorTexture",H._colorsTexture,D));const Ut=q.morphAttributes;if((Ut.position!==void 0||Ut.normal!==void 0||Ut.color!==void 0)&&Ne.update(H,q,zt),(Pt||Ce.receiveShadow!==H.receiveShadow)&&(Ce.receiveShadow=H.receiveShadow,rt.setValue(L,"receiveShadow",H.receiveShadow)),Y.isMeshGouraudMaterial&&Y.envMap!==null&&(It.envMap.value=be,It.flipEnvMap.value=be.isCubeTexture&&be.isRenderTargetTexture===!1?-1:1),Y.isMeshStandardMaterial&&Y.envMap===null&&z.environment!==null&&(It.envMapIntensity.value=z.environmentIntensity),Pt&&(rt.setValue(L,"toneMappingExposure",S.toneMappingExposure),Ce.needsLights&&Cl(It,yi),ae&&Y.fog===!0&&me.refreshFogUniforms(It,ae),me.refreshMaterialUniforms(It,Y,X,j,u.state.transmissionRenderTarget[C.id]),fr.upload(L,_a(Ce),It,D)),Y.isShaderMaterial&&Y.uniformsNeedUpdate===!0&&(fr.upload(L,_a(Ce),It,D),Y.uniformsNeedUpdate=!1),Y.isSpriteMaterial&&rt.setValue(L,"center",H.center),rt.setValue(L,"modelViewMatrix",H.modelViewMatrix),rt.setValue(L,"normalMatrix",H.normalMatrix),rt.setValue(L,"modelMatrix",H.matrixWorld),Y.isShaderMaterial||Y.isRawShaderMaterial){const Mt=Y.uniformsGroups;for(let Et=0,yr=Mt.length;Et<yr;Et++){const An=Mt[Et];B.update(An,zt),B.bind(An,zt)}}return zt}function Cl(C,z){C.ambientLightColor.needsUpdate=z,C.lightProbe.needsUpdate=z,C.directionalLights.needsUpdate=z,C.directionalLightShadows.needsUpdate=z,C.pointLights.needsUpdate=z,C.pointLightShadows.needsUpdate=z,C.spotLights.needsUpdate=z,C.spotLightShadows.needsUpdate=z,C.rectAreaLights.needsUpdate=z,C.hemisphereLights.needsUpdate=z}function Pl(C){return C.isMeshLambertMaterial||C.isMeshToonMaterial||C.isMeshPhongMaterial||C.isMeshStandardMaterial||C.isShadowMaterial||C.isShaderMaterial&&C.lights===!0}this.getActiveCubeFace=function(){return x},this.getActiveMipmapLevel=function(){return b},this.getRenderTarget=function(){return v},this.setRenderTargetTextures=function(C,z,q){fe.get(C.texture).__webglTexture=z,fe.get(C.depthTexture).__webglTexture=q;const Y=fe.get(C);Y.__hasExternalTextures=!0,Y.__autoAllocateDepthBuffer=q===void 0,Y.__autoAllocateDepthBuffer||Te.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),Y.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(C,z){const q=fe.get(C);q.__webglFramebuffer=z,q.__useDefaultFramebuffer=z===void 0};const Dl=L.createFramebuffer();this.setRenderTarget=function(C,z=0,q=0){v=C,x=z,b=q;let Y=!0,H=null,ae=!1,pe=!1;if(C){const be=fe.get(C);if(be.__useDefaultFramebuffer!==void 0)le.bindFramebuffer(L.FRAMEBUFFER,null),Y=!1;else if(be.__webglFramebuffer===void 0)D.setupRenderTarget(C);else if(be.__hasExternalTextures)D.rebindTextures(C,fe.get(C.texture).__webglTexture,fe.get(C.depthTexture).__webglTexture);else if(C.depthBuffer){const Re=C.depthTexture;if(be.__boundDepthTexture!==Re){if(Re!==null&&fe.has(Re)&&(C.width!==Re.image.width||C.height!==Re.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");D.setupDepthRenderbuffer(C)}}const Fe=C.texture;(Fe.isData3DTexture||Fe.isDataArrayTexture||Fe.isCompressedArrayTexture)&&(pe=!0);const Be=fe.get(C).__webglFramebuffer;C.isWebGLCubeRenderTarget?(Array.isArray(Be[z])?H=Be[z][q]:H=Be[z],ae=!0):C.samples>0&&D.useMultisampledRTT(C)===!1?H=fe.get(C).__webglMultisampledFramebuffer:Array.isArray(Be)?H=Be[q]:H=Be,y.copy(C.viewport),I.copy(C.scissor),F=C.scissorTest}else y.copy(_e).multiplyScalar(X).floor(),I.copy(Ue).multiplyScalar(X).floor(),F=Ge;if(q!==0&&(H=Dl),le.bindFramebuffer(L.FRAMEBUFFER,H)&&Y&&le.drawBuffers(C,H),le.viewport(y),le.scissor(I),le.setScissorTest(F),ae){const be=fe.get(C.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+z,be.__webglTexture,q)}else if(pe){const be=fe.get(C.texture),Fe=z;L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,be.__webglTexture,q,Fe)}else if(C!==null&&q!==0){const be=fe.get(C.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,be.__webglTexture,q)}h=-1},this.readRenderTargetPixels=function(C,z,q,Y,H,ae,pe){if(!(C&&C.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Me=fe.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&pe!==void 0&&(Me=Me[pe]),Me){le.bindFramebuffer(L.FRAMEBUFFER,Me);try{const be=C.texture,Fe=be.format,Be=be.type;if(!we.textureFormatReadable(Fe)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!we.textureTypeReadable(Be)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}z>=0&&z<=C.width-Y&&q>=0&&q<=C.height-H&&L.readPixels(z,q,Y,H,ke.convert(Fe),ke.convert(Be),ae)}finally{const be=v!==null?fe.get(v).__webglFramebuffer:null;le.bindFramebuffer(L.FRAMEBUFFER,be)}}},this.readRenderTargetPixelsAsync=async function(C,z,q,Y,H,ae,pe){if(!(C&&C.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Me=fe.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&pe!==void 0&&(Me=Me[pe]),Me){const be=C.texture,Fe=be.format,Be=be.type;if(!we.textureFormatReadable(Fe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!we.textureTypeReadable(Be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(z>=0&&z<=C.width-Y&&q>=0&&q<=C.height-H){le.bindFramebuffer(L.FRAMEBUFFER,Me);const Re=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,Re),L.bufferData(L.PIXEL_PACK_BUFFER,ae.byteLength,L.STREAM_READ),L.readPixels(z,q,Y,H,ke.convert(Fe),ke.convert(Be),0);const je=v!==null?fe.get(v).__webglFramebuffer:null;le.bindFramebuffer(L.FRAMEBUFFER,je);const $e=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await Fc(L,$e,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,Re),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,ae),L.deleteBuffer(Re),L.deleteSync($e),ae}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(C,z=null,q=0){C.isTexture!==!0&&(In("WebGLRenderer: copyFramebufferToTexture function signature has changed."),z=arguments[0]||null,C=arguments[1]);const Y=Math.pow(2,-q),H=Math.floor(C.image.width*Y),ae=Math.floor(C.image.height*Y),pe=z!==null?z.x:0,Me=z!==null?z.y:0;D.setTexture2D(C,0),L.copyTexSubImage2D(L.TEXTURE_2D,q,0,0,pe,Me,H,ae),le.unbindTexture()};const Ll=L.createFramebuffer(),Il=L.createFramebuffer();this.copyTextureToTexture=function(C,z,q=null,Y=null,H=0,ae=null){C.isTexture!==!0&&(In("WebGLRenderer: copyTextureToTexture function signature has changed."),Y=arguments[0]||null,C=arguments[1],z=arguments[2],ae=arguments[3]||0,q=null),ae===null&&(H!==0?(In("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ae=H,H=0):ae=0);let pe,Me,be,Fe,Be,Re,je,$e,ct;const at=C.isCompressedTexture?C.mipmaps[ae]:C.image;if(q!==null)pe=q.max.x-q.min.x,Me=q.max.y-q.min.y,be=q.isBox3?q.max.z-q.min.z:1,Fe=q.min.x,Be=q.min.y,Re=q.isBox3?q.min.z:0;else{const Ut=Math.pow(2,-H);pe=Math.floor(at.width*Ut),Me=Math.floor(at.height*Ut),C.isDataArrayTexture?be=at.depth:C.isData3DTexture?be=Math.floor(at.depth*Ut):be=1,Fe=0,Be=0,Re=0}Y!==null?(je=Y.x,$e=Y.y,ct=Y.z):(je=0,$e=0,ct=0);const Ze=ke.convert(z.format),Ce=ke.convert(z.type);let mt;z.isData3DTexture?(D.setTexture3D(z,0),mt=L.TEXTURE_3D):z.isDataArrayTexture||z.isCompressedArrayTexture?(D.setTexture2DArray(z,0),mt=L.TEXTURE_2D_ARRAY):(D.setTexture2D(z,0),mt=L.TEXTURE_2D),L.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,z.flipY),L.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,z.premultiplyAlpha),L.pixelStorei(L.UNPACK_ALIGNMENT,z.unpackAlignment);const Je=L.getParameter(L.UNPACK_ROW_LENGTH),zt=L.getParameter(L.UNPACK_IMAGE_HEIGHT),Vn=L.getParameter(L.UNPACK_SKIP_PIXELS),Pt=L.getParameter(L.UNPACK_SKIP_ROWS),yi=L.getParameter(L.UNPACK_SKIP_IMAGES);L.pixelStorei(L.UNPACK_ROW_LENGTH,at.width),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,at.height),L.pixelStorei(L.UNPACK_SKIP_PIXELS,Fe),L.pixelStorei(L.UNPACK_SKIP_ROWS,Be),L.pixelStorei(L.UNPACK_SKIP_IMAGES,Re);const rt=C.isDataArrayTexture||C.isData3DTexture,It=z.isDataArrayTexture||z.isData3DTexture;if(C.isDepthTexture){const Ut=fe.get(C),Mt=fe.get(z),Et=fe.get(Ut.__renderTarget),yr=fe.get(Mt.__renderTarget);le.bindFramebuffer(L.READ_FRAMEBUFFER,Et.__webglFramebuffer),le.bindFramebuffer(L.DRAW_FRAMEBUFFER,yr.__webglFramebuffer);for(let An=0;An<be;An++)rt&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,fe.get(C).__webglTexture,H,Re+An),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,fe.get(z).__webglTexture,ae,ct+An)),L.blitFramebuffer(Fe,Be,pe,Me,je,$e,pe,Me,L.DEPTH_BUFFER_BIT,L.NEAREST);le.bindFramebuffer(L.READ_FRAMEBUFFER,null),le.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(H!==0||C.isRenderTargetTexture||fe.has(C)){const Ut=fe.get(C),Mt=fe.get(z);le.bindFramebuffer(L.READ_FRAMEBUFFER,Ll),le.bindFramebuffer(L.DRAW_FRAMEBUFFER,Il);for(let Et=0;Et<be;Et++)rt?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,Ut.__webglTexture,H,Re+Et):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,Ut.__webglTexture,H),It?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,Mt.__webglTexture,ae,ct+Et):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,Mt.__webglTexture,ae),H!==0?L.blitFramebuffer(Fe,Be,pe,Me,je,$e,pe,Me,L.COLOR_BUFFER_BIT,L.NEAREST):It?L.copyTexSubImage3D(mt,ae,je,$e,ct+Et,Fe,Be,pe,Me):L.copyTexSubImage2D(mt,ae,je,$e,Fe,Be,pe,Me);le.bindFramebuffer(L.READ_FRAMEBUFFER,null),le.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else It?C.isDataTexture||C.isData3DTexture?L.texSubImage3D(mt,ae,je,$e,ct,pe,Me,be,Ze,Ce,at.data):z.isCompressedArrayTexture?L.compressedTexSubImage3D(mt,ae,je,$e,ct,pe,Me,be,Ze,at.data):L.texSubImage3D(mt,ae,je,$e,ct,pe,Me,be,Ze,Ce,at):C.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,ae,je,$e,pe,Me,Ze,Ce,at.data):C.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,ae,je,$e,at.width,at.height,Ze,at.data):L.texSubImage2D(L.TEXTURE_2D,ae,je,$e,pe,Me,Ze,Ce,at);L.pixelStorei(L.UNPACK_ROW_LENGTH,Je),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,zt),L.pixelStorei(L.UNPACK_SKIP_PIXELS,Vn),L.pixelStorei(L.UNPACK_SKIP_ROWS,Pt),L.pixelStorei(L.UNPACK_SKIP_IMAGES,yi),ae===0&&z.generateMipmaps&&L.generateMipmap(mt),le.unbindTexture()},this.copyTextureToTexture3D=function(C,z,q=null,Y=null,H=0){return C.isTexture!==!0&&(In("WebGLRenderer: copyTextureToTexture3D function signature has changed."),q=arguments[0]||null,Y=arguments[1]||null,C=arguments[2],z=arguments[3],H=arguments[4]||0),In('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(C,z,q,Y,H)},this.initRenderTarget=function(C){fe.get(C).__webglFramebuffer===void 0&&D.setupRenderTarget(C)},this.initTexture=function(C){C.isCubeTexture?D.setTextureCube(C,0):C.isData3DTexture?D.setTexture3D(C,0):C.isDataArrayTexture||C.isCompressedArrayTexture?D.setTexture2DArray(C,0):D.setTexture2D(C,0),le.unbindTexture()},this.resetState=function(){x=0,b=0,v=null,le.reset(),it.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ln}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorspace=Ke._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ke._getUnpackColorSpace()}}const xo={type:"change"},ua={type:"start"},El={type:"end"},sr=new il,Mo=new gn,im=Math.cos(70*el.DEG2RAD),ht=new V,bt=2*Math.PI,nt={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Qr=1e-6;class rm extends vu{constructor(e,t=null){super(e,t),this.state=nt.NONE,this.enabled=!0,this.target=new V,this.cursor=new V,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:li.ROTATE,MIDDLE:li.DOLLY,RIGHT:li.PAN},this.touches={ONE:ai.ROTATE,TWO:ai.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new V,this._lastQuaternion=new Hn,this._lastTargetPosition=new V,this._quat=new Hn().setFromUnitVectors(e.up,new V(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new qa,this._sphericalDelta=new qa,this._scale=1,this._panOffset=new V,this._rotateStart=new Oe,this._rotateEnd=new Oe,this._rotateDelta=new Oe,this._panStart=new Oe,this._panEnd=new Oe,this._panDelta=new Oe,this._dollyStart=new Oe,this._dollyEnd=new Oe,this._dollyDelta=new Oe,this._dollyDirection=new V,this._mouse=new Oe,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=am.bind(this),this._onPointerDown=sm.bind(this),this._onPointerUp=om.bind(this),this._onContextMenu=pm.bind(this),this._onMouseWheel=um.bind(this),this._onKeyDown=hm.bind(this),this._onTouchStart=fm.bind(this),this._onTouchMove=dm.bind(this),this._onMouseDown=lm.bind(this),this._onMouseMove=cm.bind(this),this._interceptControlDown=mm.bind(this),this._interceptControlUp=_m.bind(this),this.domElement!==null&&this.connect(),this.update()}connect(){this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(xo),this.update(),this.state=nt.NONE}update(e=null){const t=this.object.position;ht.copy(t).sub(this.target),ht.applyQuaternion(this._quat),this._spherical.setFromVector3(ht),this.autoRotate&&this.state===nt.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=bt:n>Math.PI&&(n-=bt),r<-Math.PI?r+=bt:r>Math.PI&&(r-=bt),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let s=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const a=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),s=a!=this._spherical.radius}if(ht.setFromSpherical(this._spherical),ht.applyQuaternion(this._quatInverse),t.copy(this.target).add(ht),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let a=null;if(this.object.isPerspectiveCamera){const o=ht.length();a=this._clampDistance(o*this._scale);const l=o-a;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),s=!!l}else if(this.object.isOrthographicCamera){const o=new V(this._mouse.x,this._mouse.y,0);o.unproject(this.object);const l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),s=l!==this.object.zoom;const f=new V(this._mouse.x,this._mouse.y,0);f.unproject(this.object),this.object.position.sub(f).add(o),this.object.updateMatrixWorld(),a=ht.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;a!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(a).add(this.object.position):(sr.origin.copy(this.object.position),sr.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(sr.direction))<im?this.object.lookAt(this.target):(Mo.setFromNormalAndCoplanarPoint(this.object.up,this.target),sr.intersectPlane(Mo,this.target))))}else if(this.object.isOrthographicCamera){const a=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),a!==this.object.zoom&&(this.object.updateProjectionMatrix(),s=!0)}return this._scale=1,this._performCursorZoom=!1,s||this._lastPosition.distanceToSquared(this.object.position)>Qr||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Qr||this._lastTargetPosition.distanceToSquared(this.target)>Qr?(this.dispatchEvent(xo),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?bt/60*this.autoRotateSpeed*e:bt/60/60*this.autoRotateSpeed}_getZoomScale(e){const t=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){ht.setFromMatrixColumn(t,0),ht.multiplyScalar(-e),this._panOffset.add(ht)}_panUp(e,t){this.screenSpacePanning===!0?ht.setFromMatrixColumn(t,1):(ht.setFromMatrixColumn(t,0),ht.crossVectors(this.object.up,ht)),ht.multiplyScalar(e),this._panOffset.add(ht)}_pan(e,t){const n=this.domElement;if(this.object.isPerspectiveCamera){const r=this.object.position;ht.copy(r).sub(this.target);let s=ht.length();s*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*s/n.clientHeight,this.object.matrix),this._panUp(2*t*s/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const n=this.domElement.getBoundingClientRect(),r=e-n.left,s=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(s/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(bt*this._rotateDelta.x/t.clientHeight),this._rotateUp(bt*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(bt*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-bt*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(bt*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-bt*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){const t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,s=Math.sqrt(n*n+r*r);this._dollyStart.set(0,s)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const n=this._getSecondPointerPosition(e),r=.5*(e.pageX+n.x),s=.5*(e.pageY+n.y);this._rotateEnd.set(r,s)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(bt*this._rotateDelta.x/t.clientHeight),this._rotateUp(bt*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,s=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,s),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new Oe,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){const t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}}function sm(i){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(i.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(i)&&(this._addPointer(i),i.pointerType==="touch"?this._onTouchStart(i):this._onMouseDown(i)))}function am(i){this.enabled!==!1&&(i.pointerType==="touch"?this._onTouchMove(i):this._onMouseMove(i))}function om(i){switch(this._removePointer(i),this._pointers.length){case 0:this.domElement.releasePointerCapture(i.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(El),this.state=nt.NONE;break;case 1:const e=this._pointers[0],t=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:t.x,pageY:t.y});break}}function lm(i){let e;switch(i.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case li.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(i),this.state=nt.DOLLY;break;case li.ROTATE:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=nt.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=nt.ROTATE}break;case li.PAN:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=nt.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=nt.PAN}break;default:this.state=nt.NONE}this.state!==nt.NONE&&this.dispatchEvent(ua)}function cm(i){switch(this.state){case nt.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(i);break;case nt.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(i);break;case nt.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(i);break}}function um(i){this.enabled===!1||this.enableZoom===!1||this.state!==nt.NONE||(i.preventDefault(),this.dispatchEvent(ua),this._handleMouseWheel(this._customWheelEvent(i)),this.dispatchEvent(El))}function hm(i){this.enabled!==!1&&this._handleKeyDown(i)}function fm(i){switch(this._trackPointer(i),this._pointers.length){case 1:switch(this.touches.ONE){case ai.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(i),this.state=nt.TOUCH_ROTATE;break;case ai.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(i),this.state=nt.TOUCH_PAN;break;default:this.state=nt.NONE}break;case 2:switch(this.touches.TWO){case ai.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(i),this.state=nt.TOUCH_DOLLY_PAN;break;case ai.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(i),this.state=nt.TOUCH_DOLLY_ROTATE;break;default:this.state=nt.NONE}break;default:this.state=nt.NONE}this.state!==nt.NONE&&this.dispatchEvent(ua)}function dm(i){switch(this._trackPointer(i),this.state){case nt.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(i),this.update();break;case nt.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(i),this.update();break;case nt.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(i),this.update();break;case nt.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(i),this.update();break;default:this.state=nt.NONE}}function pm(i){this.enabled!==!1&&i.preventDefault()}function mm(i){i.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function _m(i){i.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function gm(i,e=1e-4){e=Math.max(e,Number.EPSILON);const t={},n=i.getIndex(),r=i.getAttribute("position"),s=n?n.count:r.count;let a=0;const o=Object.keys(i.attributes),l={},f={},p=[],_=["getX","getY","getZ","getW"],m=["setX","setY","setZ","setW"];for(let A=0,R=o.length;A<R;A++){const S=o[A],U=i.attributes[S];l[S]=new U.constructor(new U.array.constructor(U.count*U.itemSize),U.itemSize,U.normalized);const x=i.morphAttributes[S];x&&(f[S]||(f[S]=[]),x.forEach((b,v)=>{const h=new b.array.constructor(b.count*b.itemSize);f[S][v]=new b.constructor(h,b.itemSize,b.normalized)}))}const g=e*.5,M=Math.log10(1/e),T=Math.pow(10,M),d=g*T;for(let A=0;A<s;A++){const R=n?n.getX(A):A;let S="";for(let U=0,x=o.length;U<x;U++){const b=o[U],v=i.getAttribute(b),h=v.itemSize;for(let c=0;c<h;c++)S+=`${~~(v[_[c]](R)*T+d)},`}if(S in t)p.push(t[S]);else{for(let U=0,x=o.length;U<x;U++){const b=o[U],v=i.getAttribute(b),h=i.morphAttributes[b],c=v.itemSize,y=l[b],I=f[b];for(let F=0;F<c;F++){const k=_[F],G=m[F];if(y[G](a,v[k](R)),h)for(let O=0,j=h.length;O<j;O++)I[O][G](a,h[O][k](R))}}t[S]=a,p.push(a),a++}}const u=i.clone();for(const A in i.attributes){const R=l[A];if(u.setAttribute(A,new R.constructor(R.array.slice(0,a*R.itemSize),R.itemSize,R.normalized)),A in f)for(let S=0;S<f[A].length;S++){const U=f[A][S];u.morphAttributes[A][S]=new U.constructor(U.array.slice(0,a*U.itemSize),U.itemSize,U.normalized)}}return u.setIndex(p),u}function Mr(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}function ar(i){throw new Error('Could not dynamically require "'+i+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var es={exports:{}},So;function vm(){return So||(So=1,(function(i,e){(function(t){i.exports=t()})(function(){return(function t(n,r,s){function a(f,p){if(!r[f]){if(!n[f]){var _=typeof ar=="function"&&ar;if(!p&&_)return _(f,!0);if(o)return o(f,!0);throw new Error("Cannot find module '"+f+"'")}p=r[f]={exports:{}},n[f][0].call(p.exports,function(m){var g=n[f][1][m];return a(g||m)},p,p.exports,t,n,r,s)}return r[f].exports}for(var o=typeof ar=="function"&&ar,l=0;l<s.length;l++)a(s[l]);return a})({1:[function(t,n,r){(function(s,a,o,l,f,p,_,m,g){var M=t("crypto");function T(x,b){b=A(x,b);var v;return(v=b.algorithm!=="passthrough"?M.createHash(b.algorithm):new U).write===void 0&&(v.write=v.update,v.end=v.update),S(b,v).dispatch(x),v.update||v.end(""),v.digest?v.digest(b.encoding==="buffer"?void 0:b.encoding):(x=v.read(),b.encoding!=="buffer"?x.toString(b.encoding):x)}(r=n.exports=T).sha1=function(x){return T(x)},r.keys=function(x){return T(x,{excludeValues:!0,algorithm:"sha1",encoding:"hex"})},r.MD5=function(x){return T(x,{algorithm:"md5",encoding:"hex"})},r.keysMD5=function(x){return T(x,{algorithm:"md5",encoding:"hex",excludeValues:!0})};var d=M.getHashes?M.getHashes().slice():["sha1","md5"],u=(d.push("passthrough"),["buffer","hex","binary","base64"]);function A(x,b){var v={};if(v.algorithm=(b=b||{}).algorithm||"sha1",v.encoding=b.encoding||"hex",v.excludeValues=!!b.excludeValues,v.algorithm=v.algorithm.toLowerCase(),v.encoding=v.encoding.toLowerCase(),v.ignoreUnknown=b.ignoreUnknown===!0,v.respectType=b.respectType!==!1,v.respectFunctionNames=b.respectFunctionNames!==!1,v.respectFunctionProperties=b.respectFunctionProperties!==!1,v.unorderedArrays=b.unorderedArrays===!0,v.unorderedSets=b.unorderedSets!==!1,v.unorderedObjects=b.unorderedObjects!==!1,v.replacer=b.replacer||void 0,v.excludeKeys=b.excludeKeys||void 0,x===void 0)throw new Error("Object argument required.");for(var h=0;h<d.length;++h)d[h].toLowerCase()===v.algorithm.toLowerCase()&&(v.algorithm=d[h]);if(d.indexOf(v.algorithm)===-1)throw new Error('Algorithm "'+v.algorithm+'"  not supported. supported values: '+d.join(", "));if(u.indexOf(v.encoding)===-1&&v.algorithm!=="passthrough")throw new Error('Encoding "'+v.encoding+'"  not supported. supported values: '+u.join(", "));return v}function R(x){if(typeof x=="function")return/^function\s+\w*\s*\(\s*\)\s*{\s+\[native code\]\s+}$/i.exec(Function.prototype.toString.call(x))!=null}function S(x,b,v){v=v||[];function h(c){return b.update?b.update(c,"utf8"):b.write(c,"utf8")}return{dispatch:function(c){return this["_"+((c=x.replacer?x.replacer(c):c)===null?"null":typeof c)](c)},_object:function(c){var y,I=Object.prototype.toString.call(c),F=/\[object (.*)\]/i.exec(I);if(F=(F=F?F[1]:"unknown:["+I+"]").toLowerCase(),0<=(I=v.indexOf(c)))return this.dispatch("[CIRCULAR:"+I+"]");if(v.push(c),o!==void 0&&o.isBuffer&&o.isBuffer(c))return h("buffer:"),h(c);if(F==="object"||F==="function"||F==="asyncfunction")return I=Object.keys(c),x.unorderedObjects&&(I=I.sort()),x.respectType===!1||R(c)||I.splice(0,0,"prototype","__proto__","constructor"),x.excludeKeys&&(I=I.filter(function(k){return!x.excludeKeys(k)})),h("object:"+I.length+":"),y=this,I.forEach(function(k){y.dispatch(k),h(":"),x.excludeValues||y.dispatch(c[k]),h(",")});if(!this["_"+F]){if(x.ignoreUnknown)return h("["+F+"]");throw new Error('Unknown object type "'+F+'"')}this["_"+F](c)},_array:function(c,k){k=k!==void 0?k:x.unorderedArrays!==!1;var I=this;if(h("array:"+c.length+":"),!k||c.length<=1)return c.forEach(function(G){return I.dispatch(G)});var F=[],k=c.map(function(G){var O=new U,j=v.slice();return S(x,O,j).dispatch(G),F=F.concat(j.slice(v.length)),O.read().toString()});return v=v.concat(F),k.sort(),this._array(k,!1)},_date:function(c){return h("date:"+c.toJSON())},_symbol:function(c){return h("symbol:"+c.toString())},_error:function(c){return h("error:"+c.toString())},_boolean:function(c){return h("bool:"+c.toString())},_string:function(c){h("string:"+c.length+":"),h(c.toString())},_function:function(c){h("fn:"),R(c)?this.dispatch("[native]"):this.dispatch(c.toString()),x.respectFunctionNames!==!1&&this.dispatch("function-name:"+String(c.name)),x.respectFunctionProperties&&this._object(c)},_number:function(c){return h("number:"+c.toString())},_xml:function(c){return h("xml:"+c.toString())},_null:function(){return h("Null")},_undefined:function(){return h("Undefined")},_regexp:function(c){return h("regex:"+c.toString())},_uint8array:function(c){return h("uint8array:"),this.dispatch(Array.prototype.slice.call(c))},_uint8clampedarray:function(c){return h("uint8clampedarray:"),this.dispatch(Array.prototype.slice.call(c))},_int8array:function(c){return h("int8array:"),this.dispatch(Array.prototype.slice.call(c))},_uint16array:function(c){return h("uint16array:"),this.dispatch(Array.prototype.slice.call(c))},_int16array:function(c){return h("int16array:"),this.dispatch(Array.prototype.slice.call(c))},_uint32array:function(c){return h("uint32array:"),this.dispatch(Array.prototype.slice.call(c))},_int32array:function(c){return h("int32array:"),this.dispatch(Array.prototype.slice.call(c))},_float32array:function(c){return h("float32array:"),this.dispatch(Array.prototype.slice.call(c))},_float64array:function(c){return h("float64array:"),this.dispatch(Array.prototype.slice.call(c))},_arraybuffer:function(c){return h("arraybuffer:"),this.dispatch(new Uint8Array(c))},_url:function(c){return h("url:"+c.toString())},_map:function(c){return h("map:"),c=Array.from(c),this._array(c,x.unorderedSets!==!1)},_set:function(c){return h("set:"),c=Array.from(c),this._array(c,x.unorderedSets!==!1)},_file:function(c){return h("file:"),this.dispatch([c.name,c.size,c.type,c.lastModfied])},_blob:function(){if(x.ignoreUnknown)return h("[blob]");throw Error(`Hashing Blob objects is currently not supported
(see https://github.com/puleos/object-hash/issues/26)
Use "options.replacer" or "options.ignoreUnknown"
`)},_domwindow:function(){return h("domwindow")},_bigint:function(c){return h("bigint:"+c.toString())},_process:function(){return h("process")},_timer:function(){return h("timer")},_pipe:function(){return h("pipe")},_tcp:function(){return h("tcp")},_udp:function(){return h("udp")},_tty:function(){return h("tty")},_statwatcher:function(){return h("statwatcher")},_securecontext:function(){return h("securecontext")},_connection:function(){return h("connection")},_zlib:function(){return h("zlib")},_context:function(){return h("context")},_nodescript:function(){return h("nodescript")},_httpparser:function(){return h("httpparser")},_dataview:function(){return h("dataview")},_signal:function(){return h("signal")},_fsevent:function(){return h("fsevent")},_tlswrap:function(){return h("tlswrap")}}}function U(){return{buf:"",write:function(x){this.buf+=x},end:function(x){this.buf+=x},read:function(){return this.buf}}}r.writeToStream=function(x,b,v){return v===void 0&&(v=b,b={}),S(b=A(x,b),v).dispatch(x)}}).call(this,t("lYpoI2"),typeof self<"u"?self:typeof window<"u"?window:{},t("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_9a5aa49d.js","/")},{buffer:3,crypto:5,lYpoI2:11}],2:[function(t,n,r){(function(s,a,o,l,f,p,_,m,g){(function(M){var T=typeof Uint8Array<"u"?Uint8Array:Array,d=43,u=47,A=48,R=97,S=65,U=45,x=95;function b(v){return v=v.charCodeAt(0),v===d||v===U?62:v===u||v===x?63:v<A?-1:v<A+10?v-A+26+26:v<S+26?v-S:v<R+26?v-R+26:void 0}M.toByteArray=function(v){var h,c;if(0<v.length%4)throw new Error("Invalid string. Length must be a multiple of 4");var y=v.length,y=v.charAt(y-2)==="="?2:v.charAt(y-1)==="="?1:0,I=new T(3*v.length/4-y),F=0<y?v.length-4:v.length,k=0;function G(O){I[k++]=O}for(h=0;h<F;h+=4,0)G((16711680&(c=b(v.charAt(h))<<18|b(v.charAt(h+1))<<12|b(v.charAt(h+2))<<6|b(v.charAt(h+3))))>>16),G((65280&c)>>8),G(255&c);return y==2?G(255&(c=b(v.charAt(h))<<2|b(v.charAt(h+1))>>4)):y==1&&(G((c=b(v.charAt(h))<<10|b(v.charAt(h+1))<<4|b(v.charAt(h+2))>>2)>>8&255),G(255&c)),I},M.fromByteArray=function(v){var h,c,y,I,F=v.length%3,k="";function G(O){return"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(O)}for(h=0,y=v.length-F;h<y;h+=3)c=(v[h]<<16)+(v[h+1]<<8)+v[h+2],k+=G((I=c)>>18&63)+G(I>>12&63)+G(I>>6&63)+G(63&I);switch(F){case 1:k=(k+=G((c=v[v.length-1])>>2))+G(c<<4&63)+"==";break;case 2:k=(k=(k+=G((c=(v[v.length-2]<<8)+v[v.length-1])>>10))+G(c>>4&63))+G(c<<2&63)+"="}return k}})(r===void 0?this.base64js={}:r)}).call(this,t("lYpoI2"),typeof self<"u"?self:typeof window<"u"?window:{},t("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/node_modules/gulp-browserify/node_modules/base64-js/lib/b64.js","/node_modules/gulp-browserify/node_modules/base64-js/lib")},{buffer:3,lYpoI2:11}],3:[function(t,n,r){(function(s,a,d,l,f,p,_,m,g){var M=t("base64-js"),T=t("ieee754");function d(w,P,N){if(!(this instanceof d))return new d(w,P,N);var Q,Z,L,Pe,Te=typeof w;if(P==="base64"&&Te=="string")for(w=(Pe=w).trim?Pe.trim():Pe.replace(/^\s+|\s+$/g,"");w.length%4!=0;)w+="=";if(Te=="number")Q=X(w);else if(Te=="string")Q=d.byteLength(w,P);else{if(Te!="object")throw new Error("First argument needs to be a number, array or string.");Q=X(w.length)}if(d._useTypedArrays?Z=d._augment(new Uint8Array(Q)):((Z=this).length=Q,Z._isBuffer=!0),d._useTypedArrays&&typeof w.byteLength=="number")Z._set(w);else if(ie(Pe=w)||d.isBuffer(Pe)||Pe&&typeof Pe=="object"&&typeof Pe.length=="number")for(L=0;L<Q;L++)d.isBuffer(w)?Z[L]=w.readUInt8(L):Z[L]=w[L];else if(Te=="string")Z.write(w,0,P);else if(Te=="number"&&!d._useTypedArrays&&!N)for(L=0;L<Q;L++)Z[L]=0;return Z}function u(w,P,N,Q){return d._charsWritten=Ge((function(Z){for(var L=[],Pe=0;Pe<Z.length;Pe++)L.push(255&Z.charCodeAt(Pe));return L})(P),w,N,Q)}function A(w,P,N,Q){return d._charsWritten=Ge((function(Z){for(var L,Pe,Te=[],we=0;we<Z.length;we++)Pe=Z.charCodeAt(we),L=Pe>>8,Pe=Pe%256,Te.push(Pe),Te.push(L);return Te})(P),w,N,Q)}function R(w,P,N){var Q="";N=Math.min(w.length,N);for(var Z=P;Z<N;Z++)Q+=String.fromCharCode(w[Z]);return Q}function S(w,P,N,L){L||($(typeof N=="boolean","missing or invalid endian"),$(P!=null,"missing offset"),$(P+1<w.length,"Trying to read beyond buffer length"));var Z,L=w.length;if(!(L<=P))return N?(Z=w[P],P+1<L&&(Z|=w[P+1]<<8)):(Z=w[P]<<8,P+1<L&&(Z|=w[P+1])),Z}function U(w,P,N,L){L||($(typeof N=="boolean","missing or invalid endian"),$(P!=null,"missing offset"),$(P+3<w.length,"Trying to read beyond buffer length"));var Z,L=w.length;if(!(L<=P))return N?(P+2<L&&(Z=w[P+2]<<16),P+1<L&&(Z|=w[P+1]<<8),Z|=w[P],P+3<L&&(Z+=w[P+3]<<24>>>0)):(P+1<L&&(Z=w[P+1]<<16),P+2<L&&(Z|=w[P+2]<<8),P+3<L&&(Z|=w[P+3]),Z+=w[P]<<24>>>0),Z}function x(w,P,N,Q){if(Q||($(typeof N=="boolean","missing or invalid endian"),$(P!=null,"missing offset"),$(P+1<w.length,"Trying to read beyond buffer length")),!(w.length<=P))return Q=S(w,P,N,!0),32768&Q?-1*(65535-Q+1):Q}function b(w,P,N,Q){if(Q||($(typeof N=="boolean","missing or invalid endian"),$(P!=null,"missing offset"),$(P+3<w.length,"Trying to read beyond buffer length")),!(w.length<=P))return Q=U(w,P,N,!0),2147483648&Q?-1*(4294967295-Q+1):Q}function v(w,P,N,Q){return Q||($(typeof N=="boolean","missing or invalid endian"),$(P+3<w.length,"Trying to read beyond buffer length")),T.read(w,P,N,23,4)}function h(w,P,N,Q){return Q||($(typeof N=="boolean","missing or invalid endian"),$(P+7<w.length,"Trying to read beyond buffer length")),T.read(w,P,N,52,8)}function c(w,P,N,Q,Z){if(Z||($(P!=null,"missing value"),$(typeof Q=="boolean","missing or invalid endian"),$(N!=null,"missing offset"),$(N+1<w.length,"trying to write beyond buffer length"),oe(P,65535)),Z=w.length,!(Z<=N))for(var L=0,Pe=Math.min(Z-N,2);L<Pe;L++)w[N+L]=(P&255<<8*(Q?L:1-L))>>>8*(Q?L:1-L)}function y(w,P,N,Q,Z){if(Z||($(P!=null,"missing value"),$(typeof Q=="boolean","missing or invalid endian"),$(N!=null,"missing offset"),$(N+3<w.length,"trying to write beyond buffer length"),oe(P,4294967295)),Z=w.length,!(Z<=N))for(var L=0,Pe=Math.min(Z-N,4);L<Pe;L++)w[N+L]=P>>>8*(Q?L:3-L)&255}function I(w,P,N,Q,Z){Z||($(P!=null,"missing value"),$(typeof Q=="boolean","missing or invalid endian"),$(N!=null,"missing offset"),$(N+1<w.length,"Trying to write beyond buffer length"),xe(P,32767,-32768)),w.length<=N||c(w,0<=P?P:65535+P+1,N,Q,Z)}function F(w,P,N,Q,Z){Z||($(P!=null,"missing value"),$(typeof Q=="boolean","missing or invalid endian"),$(N!=null,"missing offset"),$(N+3<w.length,"Trying to write beyond buffer length"),xe(P,2147483647,-2147483648)),w.length<=N||y(w,0<=P?P:4294967295+P+1,N,Q,Z)}function k(w,P,N,Q,Z){Z||($(P!=null,"missing value"),$(typeof Q=="boolean","missing or invalid endian"),$(N!=null,"missing offset"),$(N+3<w.length,"Trying to write beyond buffer length"),ue(P,34028234663852886e22,-34028234663852886e22)),w.length<=N||T.write(w,P,N,Q,23,4)}function G(w,P,N,Q,Z){Z||($(P!=null,"missing value"),$(typeof Q=="boolean","missing or invalid endian"),$(N!=null,"missing offset"),$(N+7<w.length,"Trying to write beyond buffer length"),ue(P,17976931348623157e292,-17976931348623157e292)),w.length<=N||T.write(w,P,N,Q,52,8)}r.Buffer=d,r.SlowBuffer=d,r.INSPECT_MAX_BYTES=50,d.poolSize=8192,d._useTypedArrays=(function(){try{var w=new ArrayBuffer(0),P=new Uint8Array(w);return P.foo=function(){return 42},P.foo()===42&&typeof P.subarray=="function"}catch{return!1}})(),d.isEncoding=function(w){switch(String(w).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"binary":case"base64":case"raw":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},d.isBuffer=function(w){return!(w==null||!w._isBuffer)},d.byteLength=function(w,P){var N;switch(w+="",P||"utf8"){case"hex":N=w.length/2;break;case"utf8":case"utf-8":N=_e(w).length;break;case"ascii":case"binary":case"raw":N=w.length;break;case"base64":N=Ue(w).length;break;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":N=2*w.length;break;default:throw new Error("Unknown encoding")}return N},d.concat=function(w,P){if($(ie(w),`Usage: Buffer.concat(list, [totalLength])
list should be an Array.`),w.length===0)return new d(0);if(w.length===1)return w[0];if(typeof P!="number")for(Z=P=0;Z<w.length;Z++)P+=w[Z].length;for(var N=new d(P),Q=0,Z=0;Z<w.length;Z++){var L=w[Z];L.copy(N,Q),Q+=L.length}return N},d.prototype.write=function(w,P,N,Q){isFinite(P)?isFinite(N)||(Q=N,N=void 0):(we=Q,Q=P,P=N,N=we),P=Number(P)||0;var Z,L,Pe,Te,we=this.length-P;switch((!N||we<(N=Number(N)))&&(N=we),Q=String(Q||"utf8").toLowerCase()){case"hex":Z=(function(le,De,fe,D){fe=Number(fe)||0;var E=le.length-fe;(!D||E<(D=Number(D)))&&(D=E),$((E=De.length)%2==0,"Invalid hex string"),E/2<D&&(D=E/2);for(var W=0;W<D;W++){var te=parseInt(De.substr(2*W,2),16);$(!isNaN(te),"Invalid hex string"),le[fe+W]=te}return d._charsWritten=2*W,W})(this,w,P,N);break;case"utf8":case"utf-8":L=this,Pe=P,Te=N,Z=d._charsWritten=Ge(_e(w),L,Pe,Te);break;case"ascii":case"binary":Z=u(this,w,P,N);break;case"base64":L=this,Pe=P,Te=N,Z=d._charsWritten=Ge(Ue(w),L,Pe,Te);break;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":Z=A(this,w,P,N);break;default:throw new Error("Unknown encoding")}return Z},d.prototype.toString=function(w,P,N){var Q,Z,L,Pe,Te=this;if(w=String(w||"utf8").toLowerCase(),P=Number(P)||0,(N=N!==void 0?Number(N):Te.length)===P)return"";switch(w){case"hex":Q=(function(we,le,De){var fe=we.length;(!le||le<0)&&(le=0),(!De||De<0||fe<De)&&(De=fe);for(var D="",E=le;E<De;E++)D+=se(we[E]);return D})(Te,P,N);break;case"utf8":case"utf-8":Q=(function(we,le,De){var fe="",D="";De=Math.min(we.length,De);for(var E=le;E<De;E++)we[E]<=127?(fe+=K(D)+String.fromCharCode(we[E]),D=""):D+="%"+we[E].toString(16);return fe+K(D)})(Te,P,N);break;case"ascii":case"binary":Q=R(Te,P,N);break;case"base64":Z=Te,Pe=N,Q=(L=P)===0&&Pe===Z.length?M.fromByteArray(Z):M.fromByteArray(Z.slice(L,Pe));break;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":Q=(function(we,le,De){for(var fe=we.slice(le,De),D="",E=0;E<fe.length;E+=2)D+=String.fromCharCode(fe[E]+256*fe[E+1]);return D})(Te,P,N);break;default:throw new Error("Unknown encoding")}return Q},d.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}},d.prototype.copy=function(w,P,N,Q){if(P=P||0,(Q=Q||Q===0?Q:this.length)!==(N=N||0)&&w.length!==0&&this.length!==0){$(N<=Q,"sourceEnd < sourceStart"),$(0<=P&&P<w.length,"targetStart out of bounds"),$(0<=N&&N<this.length,"sourceStart out of bounds"),$(0<=Q&&Q<=this.length,"sourceEnd out of bounds"),Q>this.length&&(Q=this.length);var Z=(Q=w.length-P<Q-N?w.length-P+N:Q)-N;if(Z<100||!d._useTypedArrays)for(var L=0;L<Z;L++)w[L+P]=this[L+N];else w._set(this.subarray(N,N+Z),P)}},d.prototype.slice=function(w,P){var N=this.length;if(w=j(w,N,0),P=j(P,N,N),d._useTypedArrays)return d._augment(this.subarray(w,P));for(var Q=P-w,Z=new d(Q,void 0,!0),L=0;L<Q;L++)Z[L]=this[L+w];return Z},d.prototype.get=function(w){return console.log(".get() is deprecated. Access using array indexes instead."),this.readUInt8(w)},d.prototype.set=function(w,P){return console.log(".set() is deprecated. Access using array indexes instead."),this.writeUInt8(w,P)},d.prototype.readUInt8=function(w,P){if(P||($(w!=null,"missing offset"),$(w<this.length,"Trying to read beyond buffer length")),!(w>=this.length))return this[w]},d.prototype.readUInt16LE=function(w,P){return S(this,w,!0,P)},d.prototype.readUInt16BE=function(w,P){return S(this,w,!1,P)},d.prototype.readUInt32LE=function(w,P){return U(this,w,!0,P)},d.prototype.readUInt32BE=function(w,P){return U(this,w,!1,P)},d.prototype.readInt8=function(w,P){if(P||($(w!=null,"missing offset"),$(w<this.length,"Trying to read beyond buffer length")),!(w>=this.length))return 128&this[w]?-1*(255-this[w]+1):this[w]},d.prototype.readInt16LE=function(w,P){return x(this,w,!0,P)},d.prototype.readInt16BE=function(w,P){return x(this,w,!1,P)},d.prototype.readInt32LE=function(w,P){return b(this,w,!0,P)},d.prototype.readInt32BE=function(w,P){return b(this,w,!1,P)},d.prototype.readFloatLE=function(w,P){return v(this,w,!0,P)},d.prototype.readFloatBE=function(w,P){return v(this,w,!1,P)},d.prototype.readDoubleLE=function(w,P){return h(this,w,!0,P)},d.prototype.readDoubleBE=function(w,P){return h(this,w,!1,P)},d.prototype.writeUInt8=function(w,P,N){N||($(w!=null,"missing value"),$(P!=null,"missing offset"),$(P<this.length,"trying to write beyond buffer length"),oe(w,255)),P>=this.length||(this[P]=w)},d.prototype.writeUInt16LE=function(w,P,N){c(this,w,P,!0,N)},d.prototype.writeUInt16BE=function(w,P,N){c(this,w,P,!1,N)},d.prototype.writeUInt32LE=function(w,P,N){y(this,w,P,!0,N)},d.prototype.writeUInt32BE=function(w,P,N){y(this,w,P,!1,N)},d.prototype.writeInt8=function(w,P,N){N||($(w!=null,"missing value"),$(P!=null,"missing offset"),$(P<this.length,"Trying to write beyond buffer length"),xe(w,127,-128)),P>=this.length||(0<=w?this.writeUInt8(w,P,N):this.writeUInt8(255+w+1,P,N))},d.prototype.writeInt16LE=function(w,P,N){I(this,w,P,!0,N)},d.prototype.writeInt16BE=function(w,P,N){I(this,w,P,!1,N)},d.prototype.writeInt32LE=function(w,P,N){F(this,w,P,!0,N)},d.prototype.writeInt32BE=function(w,P,N){F(this,w,P,!1,N)},d.prototype.writeFloatLE=function(w,P,N){k(this,w,P,!0,N)},d.prototype.writeFloatBE=function(w,P,N){k(this,w,P,!1,N)},d.prototype.writeDoubleLE=function(w,P,N){G(this,w,P,!0,N)},d.prototype.writeDoubleBE=function(w,P,N){G(this,w,P,!1,N)},d.prototype.fill=function(w,P,N){if(P=P||0,N=N||this.length,$(typeof(w=typeof(w=w||0)=="string"?w.charCodeAt(0):w)=="number"&&!isNaN(w),"value is not a number"),$(P<=N,"end < start"),N!==P&&this.length!==0){$(0<=P&&P<this.length,"start out of bounds"),$(0<=N&&N<=this.length,"end out of bounds");for(var Q=P;Q<N;Q++)this[Q]=w}},d.prototype.inspect=function(){for(var w=[],P=this.length,N=0;N<P;N++)if(w[N]=se(this[N]),N===r.INSPECT_MAX_BYTES){w[N+1]="...";break}return"<Buffer "+w.join(" ")+">"},d.prototype.toArrayBuffer=function(){if(typeof Uint8Array>"u")throw new Error("Buffer.toArrayBuffer not supported in this browser");if(d._useTypedArrays)return new d(this).buffer;for(var w=new Uint8Array(this.length),P=0,N=w.length;P<N;P+=1)w[P]=this[P];return w.buffer};var O=d.prototype;function j(w,P,N){return typeof w!="number"?N:P<=(w=~~w)?P:0<=w||0<=(w+=P)?w:0}function X(w){return(w=~~Math.ceil(+w))<0?0:w}function ie(w){return(Array.isArray||function(P){return Object.prototype.toString.call(P)==="[object Array]"})(w)}function se(w){return w<16?"0"+w.toString(16):w.toString(16)}function _e(w){for(var P=[],N=0;N<w.length;N++){var Q=w.charCodeAt(N);if(Q<=127)P.push(w.charCodeAt(N));else for(var Z=N,L=(55296<=Q&&Q<=57343&&N++,encodeURIComponent(w.slice(Z,N+1)).substr(1).split("%")),Pe=0;Pe<L.length;Pe++)P.push(parseInt(L[Pe],16))}return P}function Ue(w){return M.toByteArray(w)}function Ge(w,P,N,Q){for(var Z=0;Z<Q&&!(Z+N>=P.length||Z>=w.length);Z++)P[Z+N]=w[Z];return Z}function K(w){try{return decodeURIComponent(w)}catch{return"�"}}function oe(w,P){$(typeof w=="number","cannot write a non-number as a number"),$(0<=w,"specified a negative value for writing an unsigned value"),$(w<=P,"value is larger than maximum value for type"),$(Math.floor(w)===w,"value has a fractional component")}function xe(w,P,N){$(typeof w=="number","cannot write a non-number as a number"),$(w<=P,"value larger than maximum allowed value"),$(N<=w,"value smaller than minimum allowed value"),$(Math.floor(w)===w,"value has a fractional component")}function ue(w,P,N){$(typeof w=="number","cannot write a non-number as a number"),$(w<=P,"value larger than maximum allowed value"),$(N<=w,"value smaller than minimum allowed value")}function $(w,P){if(!w)throw new Error(P||"Failed assertion")}d._augment=function(w){return w._isBuffer=!0,w._get=w.get,w._set=w.set,w.get=O.get,w.set=O.set,w.write=O.write,w.toString=O.toString,w.toLocaleString=O.toString,w.toJSON=O.toJSON,w.copy=O.copy,w.slice=O.slice,w.readUInt8=O.readUInt8,w.readUInt16LE=O.readUInt16LE,w.readUInt16BE=O.readUInt16BE,w.readUInt32LE=O.readUInt32LE,w.readUInt32BE=O.readUInt32BE,w.readInt8=O.readInt8,w.readInt16LE=O.readInt16LE,w.readInt16BE=O.readInt16BE,w.readInt32LE=O.readInt32LE,w.readInt32BE=O.readInt32BE,w.readFloatLE=O.readFloatLE,w.readFloatBE=O.readFloatBE,w.readDoubleLE=O.readDoubleLE,w.readDoubleBE=O.readDoubleBE,w.writeUInt8=O.writeUInt8,w.writeUInt16LE=O.writeUInt16LE,w.writeUInt16BE=O.writeUInt16BE,w.writeUInt32LE=O.writeUInt32LE,w.writeUInt32BE=O.writeUInt32BE,w.writeInt8=O.writeInt8,w.writeInt16LE=O.writeInt16LE,w.writeInt16BE=O.writeInt16BE,w.writeInt32LE=O.writeInt32LE,w.writeInt32BE=O.writeInt32BE,w.writeFloatLE=O.writeFloatLE,w.writeFloatBE=O.writeFloatBE,w.writeDoubleLE=O.writeDoubleLE,w.writeDoubleBE=O.writeDoubleBE,w.fill=O.fill,w.inspect=O.inspect,w.toArrayBuffer=O.toArrayBuffer,w}}).call(this,t("lYpoI2"),typeof self<"u"?self:typeof window<"u"?window:{},t("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/node_modules/gulp-browserify/node_modules/buffer/index.js","/node_modules/gulp-browserify/node_modules/buffer")},{"base64-js":2,buffer:3,ieee754:10,lYpoI2:11}],4:[function(t,n,r){(function(s,a,M,l,f,p,_,m,g){var M=t("buffer").Buffer,T=4,d=new M(T);d.fill(0),n.exports={hash:function(u,A,R,S){for(var U=A((function(c,y){c.length%T!=0&&(I=c.length+(T-c.length%T),c=M.concat([c,d],I));for(var I,F=[],k=y?c.readInt32BE:c.readInt32LE,G=0;G<c.length;G+=T)F.push(k.call(c,G));return F})(u=M.isBuffer(u)?u:new M(u),S),8*u.length),A=S,x=new M(R),b=A?x.writeInt32BE:x.writeInt32LE,v=0;v<U.length;v++)b.call(x,U[v],4*v,!0);return x}}}).call(this,t("lYpoI2"),typeof self<"u"?self:typeof window<"u"?window:{},t("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/node_modules/gulp-browserify/node_modules/crypto-browserify/helpers.js","/node_modules/gulp-browserify/node_modules/crypto-browserify")},{buffer:3,lYpoI2:11}],5:[function(t,n,r){(function(s,a,M,l,f,p,_,m,g){var M=t("buffer").Buffer,T=t("./sha"),d=t("./sha256"),u=t("./rng"),A={sha1:T,sha256:d,md5:t("./md5")},R=64,S=new M(R);function U(c,y){var I=A[c=c||"sha1"],F=[];return I||x("algorithm:",c,"is not yet supported"),{update:function(k){return M.isBuffer(k)||(k=new M(k)),F.push(k),k.length,this},digest:function(k){var G=M.concat(F),G=y?(function(O,j,X){M.isBuffer(j)||(j=new M(j)),M.isBuffer(X)||(X=new M(X)),j.length>R?j=O(j):j.length<R&&(j=M.concat([j,S],R));for(var ie=new M(R),se=new M(R),_e=0;_e<R;_e++)ie[_e]=54^j[_e],se[_e]=92^j[_e];return X=O(M.concat([ie,X])),O(M.concat([se,X]))})(I,y,G):I(G);return F=null,k?G.toString(k):G}}}function x(){var c=[].slice.call(arguments).join(" ");throw new Error([c,"we accept pull requests","http://github.com/dominictarr/crypto-browserify"].join(`
`))}S.fill(0),r.createHash=function(c){return U(c)},r.createHmac=U,r.randomBytes=function(c,y){if(!y||!y.call)return new M(u(c));try{y.call(this,void 0,new M(u(c)))}catch(I){y(I)}};var b,v=["createCredentials","createCipher","createCipheriv","createDecipher","createDecipheriv","createSign","createVerify","createDiffieHellman","pbkdf2"],h=function(c){r[c]=function(){x("sorry,",c,"is not implemented yet")}};for(b in v)h(v[b])}).call(this,t("lYpoI2"),typeof self<"u"?self:typeof window<"u"?window:{},t("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/node_modules/gulp-browserify/node_modules/crypto-browserify/index.js","/node_modules/gulp-browserify/node_modules/crypto-browserify")},{"./md5":6,"./rng":7,"./sha":8,"./sha256":9,buffer:3,lYpoI2:11}],6:[function(t,n,r){(function(s,a,o,l,f,p,_,m,g){var M=t("./helpers");function T(x,b){x[b>>5]|=128<<b%32,x[14+(b+64>>>9<<4)]=b;for(var v=1732584193,h=-271733879,c=-1732584194,y=271733878,I=0;I<x.length;I+=16){var F=v,k=h,G=c,O=y,v=u(v,h,c,y,x[I+0],7,-680876936),y=u(y,v,h,c,x[I+1],12,-389564586),c=u(c,y,v,h,x[I+2],17,606105819),h=u(h,c,y,v,x[I+3],22,-1044525330);v=u(v,h,c,y,x[I+4],7,-176418897),y=u(y,v,h,c,x[I+5],12,1200080426),c=u(c,y,v,h,x[I+6],17,-1473231341),h=u(h,c,y,v,x[I+7],22,-45705983),v=u(v,h,c,y,x[I+8],7,1770035416),y=u(y,v,h,c,x[I+9],12,-1958414417),c=u(c,y,v,h,x[I+10],17,-42063),h=u(h,c,y,v,x[I+11],22,-1990404162),v=u(v,h,c,y,x[I+12],7,1804603682),y=u(y,v,h,c,x[I+13],12,-40341101),c=u(c,y,v,h,x[I+14],17,-1502002290),v=A(v,h=u(h,c,y,v,x[I+15],22,1236535329),c,y,x[I+1],5,-165796510),y=A(y,v,h,c,x[I+6],9,-1069501632),c=A(c,y,v,h,x[I+11],14,643717713),h=A(h,c,y,v,x[I+0],20,-373897302),v=A(v,h,c,y,x[I+5],5,-701558691),y=A(y,v,h,c,x[I+10],9,38016083),c=A(c,y,v,h,x[I+15],14,-660478335),h=A(h,c,y,v,x[I+4],20,-405537848),v=A(v,h,c,y,x[I+9],5,568446438),y=A(y,v,h,c,x[I+14],9,-1019803690),c=A(c,y,v,h,x[I+3],14,-187363961),h=A(h,c,y,v,x[I+8],20,1163531501),v=A(v,h,c,y,x[I+13],5,-1444681467),y=A(y,v,h,c,x[I+2],9,-51403784),c=A(c,y,v,h,x[I+7],14,1735328473),v=R(v,h=A(h,c,y,v,x[I+12],20,-1926607734),c,y,x[I+5],4,-378558),y=R(y,v,h,c,x[I+8],11,-2022574463),c=R(c,y,v,h,x[I+11],16,1839030562),h=R(h,c,y,v,x[I+14],23,-35309556),v=R(v,h,c,y,x[I+1],4,-1530992060),y=R(y,v,h,c,x[I+4],11,1272893353),c=R(c,y,v,h,x[I+7],16,-155497632),h=R(h,c,y,v,x[I+10],23,-1094730640),v=R(v,h,c,y,x[I+13],4,681279174),y=R(y,v,h,c,x[I+0],11,-358537222),c=R(c,y,v,h,x[I+3],16,-722521979),h=R(h,c,y,v,x[I+6],23,76029189),v=R(v,h,c,y,x[I+9],4,-640364487),y=R(y,v,h,c,x[I+12],11,-421815835),c=R(c,y,v,h,x[I+15],16,530742520),v=S(v,h=R(h,c,y,v,x[I+2],23,-995338651),c,y,x[I+0],6,-198630844),y=S(y,v,h,c,x[I+7],10,1126891415),c=S(c,y,v,h,x[I+14],15,-1416354905),h=S(h,c,y,v,x[I+5],21,-57434055),v=S(v,h,c,y,x[I+12],6,1700485571),y=S(y,v,h,c,x[I+3],10,-1894986606),c=S(c,y,v,h,x[I+10],15,-1051523),h=S(h,c,y,v,x[I+1],21,-2054922799),v=S(v,h,c,y,x[I+8],6,1873313359),y=S(y,v,h,c,x[I+15],10,-30611744),c=S(c,y,v,h,x[I+6],15,-1560198380),h=S(h,c,y,v,x[I+13],21,1309151649),v=S(v,h,c,y,x[I+4],6,-145523070),y=S(y,v,h,c,x[I+11],10,-1120210379),c=S(c,y,v,h,x[I+2],15,718787259),h=S(h,c,y,v,x[I+9],21,-343485551),v=U(v,F),h=U(h,k),c=U(c,G),y=U(y,O)}return Array(v,h,c,y)}function d(x,b,v,h,c,y){return U((b=U(U(b,x),U(h,y)))<<c|b>>>32-c,v)}function u(x,b,v,h,c,y,I){return d(b&v|~b&h,x,b,c,y,I)}function A(x,b,v,h,c,y,I){return d(b&h|v&~h,x,b,c,y,I)}function R(x,b,v,h,c,y,I){return d(b^v^h,x,b,c,y,I)}function S(x,b,v,h,c,y,I){return d(v^(b|~h),x,b,c,y,I)}function U(x,b){var v=(65535&x)+(65535&b);return(x>>16)+(b>>16)+(v>>16)<<16|65535&v}n.exports=function(x){return M.hash(x,T,16)}}).call(this,t("lYpoI2"),typeof self<"u"?self:typeof window<"u"?window:{},t("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/node_modules/gulp-browserify/node_modules/crypto-browserify/md5.js","/node_modules/gulp-browserify/node_modules/crypto-browserify")},{"./helpers":4,buffer:3,lYpoI2:11}],7:[function(t,n,r){(function(s,a,o,l,f,p,_,m,g){n.exports=function(M){for(var T,d=new Array(M),u=0;u<M;u++)(3&u)==0&&(T=4294967296*Math.random()),d[u]=T>>>((3&u)<<3)&255;return d}}).call(this,t("lYpoI2"),typeof self<"u"?self:typeof window<"u"?window:{},t("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/node_modules/gulp-browserify/node_modules/crypto-browserify/rng.js","/node_modules/gulp-browserify/node_modules/crypto-browserify")},{buffer:3,lYpoI2:11}],8:[function(t,n,r){(function(s,a,o,l,f,p,_,m,g){var M=t("./helpers");function T(A,R){A[R>>5]|=128<<24-R%32,A[15+(R+64>>9<<4)]=R;for(var S,U,x,b=Array(80),v=1732584193,h=-271733879,c=-1732584194,y=271733878,I=-1009589776,F=0;F<A.length;F+=16){for(var k=v,G=h,O=c,j=y,X=I,ie=0;ie<80;ie++){b[ie]=ie<16?A[F+ie]:u(b[ie-3]^b[ie-8]^b[ie-14]^b[ie-16],1);var se=d(d(u(v,5),(se=h,U=c,x=y,(S=ie)<20?se&U|~se&x:!(S<40)&&S<60?se&U|se&x|U&x:se^U^x)),d(d(I,b[ie]),(S=ie)<20?1518500249:S<40?1859775393:S<60?-1894007588:-899497514)),I=y,y=c,c=u(h,30),h=v,v=se}v=d(v,k),h=d(h,G),c=d(c,O),y=d(y,j),I=d(I,X)}return Array(v,h,c,y,I)}function d(A,R){var S=(65535&A)+(65535&R);return(A>>16)+(R>>16)+(S>>16)<<16|65535&S}function u(A,R){return A<<R|A>>>32-R}n.exports=function(A){return M.hash(A,T,20,!0)}}).call(this,t("lYpoI2"),typeof self<"u"?self:typeof window<"u"?window:{},t("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/node_modules/gulp-browserify/node_modules/crypto-browserify/sha.js","/node_modules/gulp-browserify/node_modules/crypto-browserify")},{"./helpers":4,buffer:3,lYpoI2:11}],9:[function(t,n,r){(function(s,a,o,l,f,p,_,m,g){function M(R,S){var U=(65535&R)+(65535&S);return(R>>16)+(S>>16)+(U>>16)<<16|65535&U}function T(R,S){var U,x=new Array(1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298),b=new Array(1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225),v=new Array(64);R[S>>5]|=128<<24-S%32,R[15+(S+64>>9<<4)]=S;for(var h,c,y=0;y<R.length;y+=16){for(var I=b[0],F=b[1],k=b[2],G=b[3],O=b[4],j=b[5],X=b[6],ie=b[7],se=0;se<64;se++)v[se]=se<16?R[se+y]:M(M(M((c=v[se-2],u(c,17)^u(c,19)^A(c,10)),v[se-7]),(c=v[se-15],u(c,7)^u(c,18)^A(c,3))),v[se-16]),U=M(M(M(M(ie,u(c=O,6)^u(c,11)^u(c,25)),O&j^~O&X),x[se]),v[se]),h=M(u(h=I,2)^u(h,13)^u(h,22),I&F^I&k^F&k),ie=X,X=j,j=O,O=M(G,U),G=k,k=F,F=I,I=M(U,h);b[0]=M(I,b[0]),b[1]=M(F,b[1]),b[2]=M(k,b[2]),b[3]=M(G,b[3]),b[4]=M(O,b[4]),b[5]=M(j,b[5]),b[6]=M(X,b[6]),b[7]=M(ie,b[7])}return b}var d=t("./helpers"),u=function(R,S){return R>>>S|R<<32-S},A=function(R,S){return R>>>S};n.exports=function(R){return d.hash(R,T,32,!0)}}).call(this,t("lYpoI2"),typeof self<"u"?self:typeof window<"u"?window:{},t("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/node_modules/gulp-browserify/node_modules/crypto-browserify/sha256.js","/node_modules/gulp-browserify/node_modules/crypto-browserify")},{"./helpers":4,buffer:3,lYpoI2:11}],10:[function(t,n,r){(function(s,a,o,l,f,p,_,m,g){r.read=function(M,T,d,u,y){var R,S,U=8*y-u-1,x=(1<<U)-1,b=x>>1,v=-7,h=d?y-1:0,c=d?-1:1,y=M[T+h];for(h+=c,R=y&(1<<-v)-1,y>>=-v,v+=U;0<v;R=256*R+M[T+h],h+=c,v-=8);for(S=R&(1<<-v)-1,R>>=-v,v+=u;0<v;S=256*S+M[T+h],h+=c,v-=8);if(R===0)R=1-b;else{if(R===x)return S?NaN:1/0*(y?-1:1);S+=Math.pow(2,u),R-=b}return(y?-1:1)*S*Math.pow(2,R-u)},r.write=function(M,T,d,u,A,I){var S,U,x=8*I-A-1,b=(1<<x)-1,v=b>>1,h=A===23?Math.pow(2,-24)-Math.pow(2,-77):0,c=u?0:I-1,y=u?1:-1,I=T<0||T===0&&1/T<0?1:0;for(T=Math.abs(T),isNaN(T)||T===1/0?(U=isNaN(T)?1:0,S=b):(S=Math.floor(Math.log(T)/Math.LN2),T*(u=Math.pow(2,-S))<1&&(S--,u*=2),2<=(T+=1<=S+v?h/u:h*Math.pow(2,1-v))*u&&(S++,u/=2),b<=S+v?(U=0,S=b):1<=S+v?(U=(T*u-1)*Math.pow(2,A),S+=v):(U=T*Math.pow(2,v-1)*Math.pow(2,A),S=0));8<=A;M[d+c]=255&U,c+=y,U/=256,A-=8);for(S=S<<A|U,x+=A;0<x;M[d+c]=255&S,c+=y,S/=256,x-=8);M[d+c-y]|=128*I}}).call(this,t("lYpoI2"),typeof self<"u"?self:typeof window<"u"?window:{},t("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/node_modules/gulp-browserify/node_modules/ieee754/index.js","/node_modules/gulp-browserify/node_modules/ieee754")},{buffer:3,lYpoI2:11}],11:[function(t,n,r){(function(s,a,o,l,f,p,_,m,g){var M,T,d;function u(){}(s=n.exports={}).nextTick=(T=typeof window<"u"&&window.setImmediate,d=typeof window<"u"&&window.postMessage&&window.addEventListener,T?function(A){return window.setImmediate(A)}:d?(M=[],window.addEventListener("message",function(A){var R=A.source;R!==window&&R!==null||A.data!=="process-tick"||(A.stopPropagation(),0<M.length&&M.shift()())},!0),function(A){M.push(A),window.postMessage("process-tick","*")}):function(A){setTimeout(A,0)}),s.title="browser",s.browser=!0,s.env={},s.argv=[],s.on=u,s.addListener=u,s.once=u,s.off=u,s.removeListener=u,s.removeAllListeners=u,s.emit=u,s.binding=function(A){throw new Error("process.binding is not supported")},s.cwd=function(){return"/"},s.chdir=function(A){throw new Error("process.chdir is not supported")}}).call(this,t("lYpoI2"),typeof self<"u"?self:typeof window<"u"?window:{},t("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/node_modules/gulp-browserify/node_modules/process/browser.js","/node_modules/gulp-browserify/node_modules/process")},{buffer:3,lYpoI2:11}]},{},[1])(1)})})(es)),es.exports}var xm=vm();const Mm=Mr(xm);var ts,yo;function bl(){return yo||(yo=1,ts=["precision","highp","mediump","lowp","attribute","const","uniform","varying","break","continue","do","for","while","if","else","in","out","inout","float","int","uint","void","bool","true","false","discard","return","mat2","mat3","mat4","vec2","vec3","vec4","ivec2","ivec3","ivec4","bvec2","bvec3","bvec4","sampler1D","sampler2D","sampler3D","samplerCube","sampler1DShadow","sampler2DShadow","struct","asm","class","union","enum","typedef","template","this","packed","goto","switch","default","inline","noinline","volatile","public","static","extern","external","interface","long","short","double","half","fixed","unsigned","input","output","hvec2","hvec3","hvec4","dvec2","dvec3","dvec4","fvec2","fvec3","fvec4","sampler2DRect","sampler3DRect","sampler2DRectShadow","sizeof","cast","namespace","using"]),ts}var ns,Eo;function Sm(){return Eo||(Eo=1,ns=["<<=",">>=","++","--","<<",">>","<=",">=","==","!=","&&","||","+=","-=","*=","/=","%=","&=","^^","^=","|=","(",")","[","]",".","!","~","*","/","%","+","-","<",">","&","^","|","?",":","=",",",";","{","}"]),ns}var is,bo;function Tl(){return bo||(bo=1,is=["abs","acos","all","any","asin","atan","ceil","clamp","cos","cross","dFdx","dFdy","degrees","distance","dot","equal","exp","exp2","faceforward","floor","fract","gl_BackColor","gl_BackLightModelProduct","gl_BackLightProduct","gl_BackMaterial","gl_BackSecondaryColor","gl_ClipPlane","gl_ClipVertex","gl_Color","gl_DepthRange","gl_DepthRangeParameters","gl_EyePlaneQ","gl_EyePlaneR","gl_EyePlaneS","gl_EyePlaneT","gl_Fog","gl_FogCoord","gl_FogFragCoord","gl_FogParameters","gl_FragColor","gl_FragCoord","gl_FragData","gl_FragDepth","gl_FragDepthEXT","gl_FrontColor","gl_FrontFacing","gl_FrontLightModelProduct","gl_FrontLightProduct","gl_FrontMaterial","gl_FrontSecondaryColor","gl_LightModel","gl_LightModelParameters","gl_LightModelProducts","gl_LightProducts","gl_LightSource","gl_LightSourceParameters","gl_MaterialParameters","gl_MaxClipPlanes","gl_MaxCombinedTextureImageUnits","gl_MaxDrawBuffers","gl_MaxFragmentUniformComponents","gl_MaxLights","gl_MaxTextureCoords","gl_MaxTextureImageUnits","gl_MaxTextureUnits","gl_MaxVaryingFloats","gl_MaxVertexAttribs","gl_MaxVertexTextureImageUnits","gl_MaxVertexUniformComponents","gl_ModelViewMatrix","gl_ModelViewMatrixInverse","gl_ModelViewMatrixInverseTranspose","gl_ModelViewMatrixTranspose","gl_ModelViewProjectionMatrix","gl_ModelViewProjectionMatrixInverse","gl_ModelViewProjectionMatrixInverseTranspose","gl_ModelViewProjectionMatrixTranspose","gl_MultiTexCoord0","gl_MultiTexCoord1","gl_MultiTexCoord2","gl_MultiTexCoord3","gl_MultiTexCoord4","gl_MultiTexCoord5","gl_MultiTexCoord6","gl_MultiTexCoord7","gl_Normal","gl_NormalMatrix","gl_NormalScale","gl_ObjectPlaneQ","gl_ObjectPlaneR","gl_ObjectPlaneS","gl_ObjectPlaneT","gl_Point","gl_PointCoord","gl_PointParameters","gl_PointSize","gl_Position","gl_ProjectionMatrix","gl_ProjectionMatrixInverse","gl_ProjectionMatrixInverseTranspose","gl_ProjectionMatrixTranspose","gl_SecondaryColor","gl_TexCoord","gl_TextureEnvColor","gl_TextureMatrix","gl_TextureMatrixInverse","gl_TextureMatrixInverseTranspose","gl_TextureMatrixTranspose","gl_Vertex","greaterThan","greaterThanEqual","inversesqrt","length","lessThan","lessThanEqual","log","log2","matrixCompMult","max","min","mix","mod","normalize","not","notEqual","pow","radians","reflect","refract","sign","sin","smoothstep","sqrt","step","tan","texture2D","texture2DLod","texture2DProj","texture2DProjLod","textureCube","textureCubeLod","texture2DLodEXT","texture2DProjLodEXT","textureCubeLodEXT","texture2DGradEXT","texture2DProjGradEXT","textureCubeGradEXT"]),is}var rs,To;function ym(){if(To)return rs;To=1;var i=bl();return rs=i.slice().concat(["layout","centroid","smooth","case","mat2x2","mat2x3","mat2x4","mat3x2","mat3x3","mat3x4","mat4x2","mat4x3","mat4x4","uvec2","uvec3","uvec4","samplerCubeShadow","sampler2DArray","sampler2DArrayShadow","isampler2D","isampler3D","isamplerCube","isampler2DArray","usampler2D","usampler3D","usamplerCube","usampler2DArray","coherent","restrict","readonly","writeonly","resource","atomic_uint","noperspective","patch","sample","subroutine","common","partition","active","filter","image1D","image2D","image3D","imageCube","iimage1D","iimage2D","iimage3D","iimageCube","uimage1D","uimage2D","uimage3D","uimageCube","image1DArray","image2DArray","iimage1DArray","iimage2DArray","uimage1DArray","uimage2DArray","image1DShadow","image2DShadow","image1DArrayShadow","image2DArrayShadow","imageBuffer","iimageBuffer","uimageBuffer","sampler1DArray","sampler1DArrayShadow","isampler1D","isampler1DArray","usampler1D","usampler1DArray","isampler2DRect","usampler2DRect","samplerBuffer","isamplerBuffer","usamplerBuffer","sampler2DMS","isampler2DMS","usampler2DMS","sampler2DMSArray","isampler2DMSArray","usampler2DMSArray"]),rs}var ss,Ao;function Em(){if(Ao)return ss;Ao=1;var i=Tl();return i=i.slice().filter(function(e){return!/^(gl\_|texture)/.test(e)}),ss=i.concat(["gl_VertexID","gl_InstanceID","gl_Position","gl_PointSize","gl_FragCoord","gl_FrontFacing","gl_FragDepth","gl_PointCoord","gl_MaxVertexAttribs","gl_MaxVertexUniformVectors","gl_MaxVertexOutputVectors","gl_MaxFragmentInputVectors","gl_MaxVertexTextureImageUnits","gl_MaxCombinedTextureImageUnits","gl_MaxTextureImageUnits","gl_MaxFragmentUniformVectors","gl_MaxDrawBuffers","gl_MinProgramTexelOffset","gl_MaxProgramTexelOffset","gl_DepthRangeParameters","gl_DepthRange","trunc","round","roundEven","isnan","isinf","floatBitsToInt","floatBitsToUint","intBitsToFloat","uintBitsToFloat","packSnorm2x16","unpackSnorm2x16","packUnorm2x16","unpackUnorm2x16","packHalf2x16","unpackHalf2x16","outerProduct","transpose","determinant","inverse","texture","textureSize","textureProj","textureLod","textureOffset","texelFetch","texelFetchOffset","textureProjOffset","textureLodOffset","textureProjLod","textureProjLodOffset","textureGrad","textureGradOffset","textureProjGrad","textureProjGradOffset"]),ss}var as,wo;function bm(){if(wo)return as;wo=1,as=S;var i=bl(),e=Sm(),t=Tl(),n=ym(),r=Em(),s=999,a=9999,o=0,l=1,f=2,p=3,_=4,m=5,g=6,M=7,T=8,d=9,u=10,A=11,R=["block-comment","line-comment","preprocessor","operator","integer","float","ident","builtin","keyword","whitespace","eof","integer"];function S(U){var x=0,b=0,v=s,h,c,y=[],I=[],F=1,k=0,G=0,O=!1,j=!1,X="",ie;U=U||{};var se=t,_e=i;U.version==="300 es"&&(se=r,_e=n);for(var Ue={},Ge={},x=0;x<se.length;x++)Ue[se[x]]=!0;for(var x=0;x<_e.length;x++)Ge[_e[x]]=!0;return function(le){return I=[],le!==null?oe(le):xe()};function K(le){le.length&&I.push({type:R[v],data:le,position:G,line:F,column:k})}function oe(le){x=0,le.toString&&(le=le.toString()),X+=le.replace(/\r\n/g,`
`),ie=X.length;for(var De;h=X[x],x<ie;){switch(De=x,v){case o:x=N();break;case l:x=P();break;case f:x=w();break;case p:x=Q();break;case _:x=Pe();break;case A:x=L();break;case m:x=Te();break;case a:x=we();break;case d:x=$();break;case s:x=ue();break}if(De!==x)switch(X[De]){case`
`:k=0,++F;break;default:++k;break}}return b+=x,X=X.slice(x),I}function xe(le){return y.length&&K(y.join("")),v=u,K("(eof)"),I}function ue(){return y=y.length?[]:y,c==="/"&&h==="*"?(G=b+x-1,v=o,c=h,x+1):c==="/"&&h==="/"?(G=b+x-1,v=l,c=h,x+1):h==="#"?(v=f,G=b+x,x):/\s/.test(h)?(v=d,G=b+x,x):(O=/\d/.test(h),j=/[^\w_]/.test(h),G=b+x,v=O?_:j?p:a,x)}function $(){return/[^\s]/g.test(h)?(K(y.join("")),v=s,x):(y.push(h),c=h,x+1)}function w(){return(h==="\r"||h===`
`)&&c!=="\\"?(K(y.join("")),v=s,x):(y.push(h),c=h,x+1)}function P(){return w()}function N(){return h==="/"&&c==="*"?(y.push(h),K(y.join("")),v=s,x+1):(y.push(h),c=h,x+1)}function Q(){if(c==="."&&/\d/.test(h))return v=m,x;if(c==="/"&&h==="*")return v=o,x;if(c==="/"&&h==="/")return v=l,x;if(h==="."&&y.length){for(;Z(y););return v=m,x}if(h===";"||h===")"||h==="("){if(y.length)for(;Z(y););return K(h),v=s,x+1}var le=y.length===2&&h!=="=";if(/[\w_\d\s]/.test(h)||le){for(;Z(y););return v=s,x}return y.push(h),c=h,x+1}function Z(le){var De=0,fe,D;do{if(fe=e.indexOf(le.slice(0,le.length+De).join("")),D=e[fe],fe===-1){if(De--+le.length>0)continue;D=le.slice(0,1).join("")}return K(D),G+=D.length,y=y.slice(D.length),y.length}while(!0)}function L(){return/[^a-fA-F0-9]/.test(h)?(K(y.join("")),v=s,x):(y.push(h),c=h,x+1)}function Pe(){return h==="."||/[eE]/.test(h)?(y.push(h),v=m,c=h,x+1):h==="x"&&y.length===1&&y[0]==="0"?(v=A,y.push(h),c=h,x+1):/[^\d]/.test(h)?(K(y.join("")),v=s,x):(y.push(h),c=h,x+1)}function Te(){return h==="f"&&(y.push(h),c=h,x+=1),/[eE]/.test(h)||(h==="-"||h==="+")&&/[eE]/.test(c)?(y.push(h),c=h,x+1):/[^\d]/.test(h)?(K(y.join("")),v=s,x):(y.push(h),c=h,x+1)}function we(){if(/[^\d\w_]/.test(h)){var le=y.join("");return Ge[le]?v=T:Ue[le]?v=M:v=g,K(y.join("")),v=s,x}return y.push(h),c=h,x+1}}return as}var os,Ro;function Tm(){if(Ro)return os;Ro=1;var i=bm();os=e;function e(t,n){var r=i(n),s=[];return s=s.concat(r(t)),s=s.concat(r(null)),s}return os}var Am=Tm();const wm=Mr(Am);var ls,Co;function Rm(){if(Co)return ls;Co=1,ls=i;function i(e){for(var t=[],n=0;n<e.length;n++)e[n].type!=="eof"&&t.push(e[n].data);return t.join("")}return ls}var Cm=Rm();const Po=Mr(Cm);var cs,Do;function Pm(){if(Do)return cs;Do=1,cs=i;function i(n){var r=null,s=null,a=0,o=0,l=0,f=0,p=0,_=[],m,g,M;for(m=0,g;m<n.length;m++)if(M=n[m],M.data==="{"){if(a&&a++||(g=d(m,e(")"),e()),g<0)||(f=g,g=d(g,e("("),e(")")),g<0)||(p=g,g=d(g,t),g<0)||n[g].type!=="ident"||(s=n[g].data,g=d(g,t),g<0))continue;a=1,o=m,r=n[g].data,l=g;var T=d(g,t);switch(n[T]&&n[T].data){case"lowp":case"highp":case"mediump":l=T}}else if(a&&M.data==="}"){if(--a)continue;_.push({name:s,type:r,body:[o+1,m],args:[p,f+1],outer:[l,m+1]})}for(m=0;m<n.length;m++)if(M=n[m],M.data===";"){if(g=d(m,e(")"),e()),g<0||(f=g,g=d(g,e("("),e(")")),g<0)||(p=g,g=d(g,t),g<0)||n[g].type!=="ident"||(s=n[g].data,g=d(g,t),g<0)||n[g].type==="operator"||n[g].data==="return")continue;r=n[g].data,_.push({name:s,type:r,body:!1,args:[p,f+1],outer:[g,m+1]})}return _.sort(function(u,A){return u.outer[0]-A.outer[0]});function d(u,A,R){for(var S=u-1;S>=0;S--){if(A(n[S]))return S;if(R&&R(n[S]))return-1}return-1}}function e(n){return function(r){return r.type==="operator"&&(!n||r.data===n)}}function t(n){return n.type!=="whitespace"}return cs}var Dm=Pm();const Lm=Mr(Dm);function Im(i,e){if(typeof i!="object"||i===null)return i;var t=i[Symbol.toPrimitive];if(t!==void 0){var n=t.call(i,e);if(typeof n!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(i)}function Al(i){var e=Im(i,"string");return typeof e=="symbol"?e:String(e)}function et(i,e,t){return e=Al(e),e in i?Object.defineProperty(i,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):i[e]=t,i}function Lo(i,e){var t=Object.keys(i);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(i);e&&(n=n.filter(function(r){return Object.getOwnPropertyDescriptor(i,r).enumerable})),t.push.apply(t,n)}return t}function ii(i){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?Lo(Object(t),!0).forEach(function(n){et(i,n,t[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(i,Object.getOwnPropertyDescriptors(t)):Lo(Object(t)).forEach(function(n){Object.defineProperty(i,n,Object.getOwnPropertyDescriptor(t,n))})}return i}function Um(i,e){if(i==null)return{};var t={},n=Object.keys(i),r,s;for(s=0;s<n.length;s++)r=n[s],!(e.indexOf(r)>=0)&&(t[r]=i[r]);return t}function Nm(i,e){if(i==null)return{};var t=Um(i,e),n,r;if(Object.getOwnPropertySymbols){var s=Object.getOwnPropertySymbols(i);for(r=0;r<s.length;r++)n=s[r],!(e.indexOf(n)>=0)&&Object.prototype.propertyIsEnumerable.call(i,n)&&(t[n]=i[n])}return t}function Fm(i,e){if(!(i instanceof e))throw new TypeError("Cannot call a class as a function")}function Om(i,e){for(var t=0;t<e.length;t++){var n=e[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(i,Al(n.key),n)}}function Bm(i,e,t){return e&&Om(i.prototype,e),Object.defineProperty(i,"prototype",{writable:!1}),i}function wl(i){if(i===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return i}function Ks(i,e){return Ks=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(n,r){return n.__proto__=r,n},Ks(i,e)}function zm(i,e){if(typeof e!="function"&&e!==null)throw new TypeError("Super expression must either be null or a function");i.prototype=Object.create(e&&e.prototype,{constructor:{value:i,writable:!0,configurable:!0}}),Object.defineProperty(i,"prototype",{writable:!1}),e&&Ks(i,e)}function _r(i){return _r=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(t){return t.__proto__||Object.getPrototypeOf(t)},_r(i)}function Hm(){if(typeof Reflect>"u"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function km(i,e){if(e&&(typeof e=="object"||typeof e=="function"))return e;if(e!==void 0)throw new TypeError("Derived constructors may only return object or undefined");return wl(i)}function Vm(i){var e=Hm();return function(){var n=_r(i),r;if(e){var s=_r(this).constructor;r=Reflect.construct(n,arguments,s)}else r=n.apply(this,arguments);return km(this,r)}}var Ie={position:"csm_Position",positionRaw:"csm_PositionRaw",pointSize:"csm_PointSize",fragColor:"csm_FragColor",diffuseColor:"csm_DiffuseColor",normal:"csm_Normal",roughness:"csm_Roughness",metalness:"csm_Metalness",emissive:"csm_Emissive",ao:"csm_AO",bump:"csm_Bump",depthAlpha:"csm_DepthAlpha"},Tt,ri,Gm=(Tt={},et(Tt,"".concat(Ie.normal),{"#include <beginnormal_vertex>":`
  ...
  `)}),et(Tt,"".concat(Ie.emissive),{"vec3 totalEmissiveRadiance = emissive;":`
    ...
    `)}),Tt),Wm=(ri={},et(ri,"".concat(Ie.position),{"gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );":`
    gl_Position = projectionMatrix * modelViewMatrix * vec4( `.concat(Ie.position,`, 1.0 );
  `)}),et(ri,"".concat(Ie.positionRaw),{"gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );":`
    gl_Position = `.concat(Ie.position,`;
  `)}),et(ri,"".concat(Ie.diffuseColor),{"gl_FragColor = vec4( 1.0, 0.0, 0.0, 1.0 );":`
    gl_FragColor = `.concat(Ie.diffuseColor,`;
  `)}),et(ri,"".concat(Ie.fragColor),{"gl_FragColor = vec4( 1.0, 0.0, 0.0, 1.0 );":`
    gl_FragColor = `.concat(Ie.fragColor,`;
  `)}),ri),Xm=`
...
}`;(function i(){const e=document.querySelector("canvas.webgl"),t=document.querySelector(".webgl-hero");if(!e){setTimeout(i,50);return}if(t&&t.clientWidth===0){setTimeout(i,50);return}console.log("✅ Canvas and container ready, initializing...");const n=navigator.userAgent.toLowerCase(),r=/iphone|ipod|android.*mobile/i.test(n),s=/ipad|android(?!.*mobile)/i.test(n),a=window.innerWidth,o=a>991,l=a>=768&&a<=991,f=a<768,p="ontouchstart"in window||navigator.maxTouchPoints>0,_=navigator.hardwareConcurrency||4,m=n.includes("mac")&&p&&!n.includes("iphone")||n.includes("ipad"),g=s&&n.includes("android");let M="desktop";r&&!s?M="mobile":m||g?M="tablet":f&&p?M="mobile":l&&p?M="tablet":(o||!p)&&(M="desktop");let T="high";M==="desktop"?T="high":M==="tablet"?_>=6||m&&a>=1024?T="high":_>=4?T="medium":T="low":_>=6?T="medium":T="low";const u={high:{subdivisions:65,cubeMapSize:128,enableCubeCamera:!0,cubeCameraUpdateInterval:1,enableShadows:!0,pixelRatio:2,antialias:!0},medium:{subdivisions:45,cubeMapSize:64,enableCubeCamera:!0,cubeCameraUpdateInterval:3,enableShadows:!0,pixelRatio:2,antialias:!0},low:{subdivisions:35,cubeMapSize:0,enableCubeCamera:!1,cubeCameraUpdateInterval:0,enableShadows:!1,pixelRatio:1,antialias:!1}}[T],A=new ou;A.background=new Xe("#0a1628");const R={uTime:new sn(0),uPositionFrequency:new sn(.233),uTimeFrequency:new sn(.13),uStrength:new sn(.492),uWarpPositionFrequency:new sn(.4),uWarpTimeFrequency:new sn(.3),uWarpStrength:new sn(1.8)},S=new Uo({baseMaterial:hu,vertexShader:No,fragmentShader:s_,uniforms:R,silent:!0,metalness:1,roughness:.4,color:"#68707A",transmission:0,ior:10,thickness:0,transparent:!0,wireframe:!1,clearcoat:0,clearcoatRoughness:0}),U=new Uo({baseMaterial:ml,vertexShader:No,uniforms:R,silent:!0,depthPacking:$o});let x=new la(2.5,u.subdivisions);x=gm(x),x.computeTangents();const b=new Yt(x,S);b.customDepthMaterial=U,b.receiveShadow=u.enableShadows,b.castShadow=u.enableShadows,A.add(b);const v=new qr("#ffffff",25);v.castShadow=u.enableShadows,v.shadow.mapSize.set(512,512),v.shadow.camera.far=15,v.shadow.normalBias=.05,v.position.set(3,4,-3),A.add(v);const h=new qr("#4a7c9e",10);h.position.set(-4,2,3),A.add(h);const c=new qr("#8bb8d8",3);c.position.set(0,-1,-4),A.add(c);const y=new mu("#AAAAEE",2.5);A.add(y);const I=t||e.parentElement||document.body,F={width:I.clientWidth>0?I.clientWidth:window.innerWidth,height:I.clientHeight>0?I.clientHeight:window.innerHeight,pixelRatio:Math.min(window.devicePixelRatio,u.pixelRatio)};console.log("📐 Container:",I.className||I.tagName),console.log("📐 Size:",F.width,"x",F.height);const k=new Ft(35,F.width/F.height,.1,100);k.position.set(13,-3,-5),A.add(k);const G=new rm(k,e);G.enableDamping=!0,G.enabled=!1;const O=new nm({canvas:e,antialias:u.antialias,alpha:!0,powerPreference:"high-performance",stencil:!1,depth:!0});O.shadowMap.enabled=u.enableShadows,O.shadowMap.type=u.enableShadows?Oo:Fl,O.toneMapping=zo,O.toneMappingExposure=2.5,O.outputColorSpace=wt,O.setSize(F.width,F.height),O.setPixelRatio(F.pixelRatio);let j=null,X=null;u.enableCubeCamera?(X=new dl(u.cubeMapSize,{format:Ot,generateMipmaps:!0,minFilter:xn,magFilter:Wt,colorSpace:wt}),j=new hl(.1,100,X),A.add(j),S.envMap=X.texture,S.envMapIntensity=1,S.needsUpdate=!0):(S.envMap=null,S.envMapIntensity=0);let ie=!0,se=!0;const _e=()=>{ie=!document.hidden},Ue=t||e,Ge=new IntersectionObserver(P=>{P.forEach(N=>{se=N.isIntersecting})},{threshold:.1});Ge.observe(Ue);const K=()=>{const P=t||e.parentElement||document.body;F.width=P.clientWidth>0?P.clientWidth:window.innerWidth,F.height=P.clientHeight>0?P.clientHeight:window.innerHeight,F.pixelRatio=Math.min(window.devicePixelRatio,u.pixelRatio),k.aspect=F.width/F.height,k.updateProjectionMatrix(),O.setSize(F.width,F.height),O.setPixelRatio(F.pixelRatio)};window.addEventListener("resize",K),document.addEventListener("visibilitychange",_e);const oe=new gu;let xe=0,ue=null;const $=()=>{if(!ie||!se){ue=window.requestAnimationFrame($);return}const P=oe.getElapsedTime();R.uTime.value=P,G.update(),j&&(u.cubeCameraUpdateInterval===1||xe%u.cubeCameraUpdateInterval===0)&&(b.visible=!1,j.update(O,A),b.visible=!0),xe++,O.render(A,k),ue=window.requestAnimationFrame($)};$();const w=()=>{ue!==null&&(window.cancelAnimationFrame(ue),ue=null),window.removeEventListener("resize",K),document.removeEventListener("visibilitychange",_e),Ge&&Ge.disconnect(),x.dispose(),S.dispose(),U.dispose(),j&&(A.remove(j),j=null),X&&(X.dispose(),X=null),G.dispose(),A.traverse(P=>{P.geometry&&P.geometry.dispose(),P.material&&(Array.isArray(P.material)?P.material.forEach(N=>N.dispose()):P.material.dispose())}),A.clear(),O.dispose(),O.forceContextLoss()};window.addEventListener("beforeunload",w)})();
