...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function Eo(){return new wn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ca(),fragmentShader:`
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function bo(){return new wn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ca(),fragmentShader:`
	...
	`}function Wd(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,f=l===Fs||l===Os,p=l===Ei||l===bi;if(f||p){let _=e.get(o);const m=_!==void 0?_.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==m)return t===null&&(t=new So(i)),_=f?t.fromEquirectangular(o,_):t.fromCubemap(o,_),_.texture.pmremVersion=o.pmremVersion,e.set(o,_),_.texture;if(_!==void 0)return _.texture;{const g=o.image;return f&&g&&g.height>0||p&&g&&r(g)?(t===null&&(t=new So(i)),_=f?t.fromEquirectangular(o):t.fromCubemap(o),_.texture.pmremVersion=o.pmremVersion,e.set(o,_),o.addEventListener("dispose",s),_.texture):null}}}return o}function r(o){let l=0;const f=6;for(let p=0;p<f;p++)o[p]!==void 0&&l++;return l===f}function s(o){const l=o.target;l.removeEventListener("dispose",s);const f=e.get(l);f!==void 0&&(e.delete(l),f.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function Xd(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&On("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function qd(i,e,t,n){const r={},s=new WeakMap;function a(_){const m=_.target;m.index!==null&&e.remove(m.index);for(const M in m.attributes)e.remove(m.attributes[M]);m.removeEventListener("dispose",a),delete r[m.id];const g=s.get(m);g&&(e.remove(g),s.delete(m)),n.releaseStatesOfGeometry(m),m.isInstancedBufferGeometry===!0&&delete m._maxInstanceCount,t.memory.geometries--}function o(_,m){return r[m.id]===!0||(m.addEventListener("dispose",a),r[m.id]=!0,t.memory.geometries++),m}function l(_){const m=_.attributes;for(const g in m)e.update(m[g],i.ARRAY_BUFFER)}function f(_){const m=[],g=_.index,M=_.attributes.position;let A=0;if(g!==null){const R=g.array;A=g.version;for(let w=0,S=R.length;w<S;w+=3){const U=R[w+0],x=R[w+1],b=R[w+2];m.push(U,x,x,b,b,U)}}else if(M!==void 0){const R=M.array;A=M.version;for(let w=0,S=R.length/3-1;w<S;w+=3){const U=w+0,x=w+1,b=w+2;m.push(U,x,x,b,b,U)}}else return;const d=new(El(m)?Pl:Cl)(m,1);d.version=A;const u=s.get(_);u&&e.remove(u),s.set(_,d)}function p(_){const m=s.get(_);if(m){const g=_.index;g!==null&&m.version<g.version&&f(_)}else f(_);return s.get(_)}return{get:o,update:l,getWireframeAttribute:p}}function Yd(i,e,t){let n;function r(m){n=m}let s,a;function o(m){s=m.type,a=m.bytesPerElement}function l(m,g){i.drawElements(n,g,s,m*a),t.update(g,n,1)}function f(m,g,M){M!==0&&(i.drawElementsInstanced(n,g,s,m*a,M),t.update(g,n,M))}function p(m,g,M){if(M===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,g,0,s,m,0,M);let d=0;for(let u=0;u<M;u++)d+=g[u];t.update(d,n,1)}function _(m,g,M,A){if(M===0)return;const d=e.get("WEBGL_multi_draw");if(d===null)for(let u=0;u<m.length;u++)f(m[u]/a,g[u],A[u]);else{d.multiDrawElementsInstancedWEBGL(n,g,0,s,m,0,A,0,M);let u=0;for(let R=0;R<M;R++)u+=g[R]*A[R];t.update(u,n,1)}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=f,this.renderMultiDraw=p,this.renderMultiDrawInstances=_}function jd(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Zd(i,e,t){const n=new WeakMap,r=new ot;function s(a,o,l){const f=a.morphTargetInfluences,p=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,_=p!==void 0?p.length:0;let m=n.get(o);if(m===void 0||m.count!==_){let c=function(){v.dispose(),n.delete(o),o.removeEventListener("dispose",c)};var g=c;m!==void 0&&m.texture.dispose();const M=o.morphAttributes.position!==void 0,A=o.morphAttributes.normal!==void 0,d=o.morphAttributes.color!==void 0,u=o.morphAttributes.position||[],R=o.morphAttributes.normal||[],w=o.morphAttributes.color||[];let S=0;M===!0&&(S=1),A===!0&&(S=2),d===!0&&(S=3);let U=o.attributes.position.count*S,x=1;U>e.maxTextureSize&&(x=Math.ceil(U/e.maxTextureSize),U=e.maxTextureSize);const b=new Float32Array(U*x*4*_),v=new bl(b,U,x,_);v.type=hn,v.needsUpdate=!0;const h=S*4;for(let y=0;y<_;y++){const I=u[y],O=R[y],G=w[y],W=U*x*4*y;for(let B=0;B<I.count;B++){const Z=B*h;M===!0&&(r.fromBufferAttribute(I,B),b[W+Z+0]=r.x,b[W+Z+1]=r.y,b[W+Z+2]=r.z,b[W+Z+3]=0),A===!0&&(r.fromBufferAttribute(O,B),b[W+Z+4]=r.x,b[W+Z+5]=r.y,b[W+Z+6]=r.z,b[W+Z+7]=0),d===!0&&(r.fromBufferAttribute(G,B),b[W+Z+8]=r.x,b[W+Z+9]=r.y,b[W+Z+10]=r.z,b[W+Z+11]=G.itemSize===4?r.w:1)}}m={count:_,texture:v,size:new Fe(U,x)},n.set(o,m),o.addEventListener("dispose",c)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let M=0;for(let d=0;d<f.length;d++)M+=f[d];const A=o.morphTargetsRelative?1:1-M;l.getUniforms().setValue(i,"morphTargetBaseInfluence",A),l.getUniforms().setValue(i,"morphTargetInfluences",f)}l.getUniforms().setValue(i,"morphTargetsTexture",m.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",m.size)}return{update:s}}function Kd(i,e,t,n){let r=new WeakMap;function s(l){const f=n.render.frame,p=l.geometry,_=e.get(l,p);if(r.get(_)!==f&&(e.update(_),r.set(_,f)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==f&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,f))),l.isSkinnedMesh){const m=l.skeleton;r.get(m)!==f&&(m.update(),r.set(m,f))}return _}function a(){r=new WeakMap}function o(l){const f=l.target;f.removeEventListener("dispose",o),t.remove(f.instanceMatrix),f.instanceColor!==null&&t.remove(f.instanceColor)}return{update:s,dispose:a}}const kl=new Ct,To=new Fl(1,1),Vl=new bl,Gl=new Eu,Wl=new Ul,Ao=[],wo=[],Ro=new Float32Array(16),Co=new Float32Array(9),Po=new Float32Array(4);function Ii(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Ao[r];if(s===void 0&&(s=new Float32Array(r),Ao[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function ft(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function dt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Fr(i,e){let t=wo[e];t===void 0&&(t=new Int32Array(e),wo[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function $d(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Jd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ft(t,e))return;i.uniform2fv(this.addr,e),dt(t,e)}}function Qd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(ft(t,e))return;i.uniform3fv(this.addr,e),dt(t,e)}}function ep(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ft(t,e))return;i.uniform4fv(this.addr,e),dt(t,e)}}function tp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ft(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),dt(t,e)}else{if(ft(t,n))return;Po.set(n),i.uniformMatrix2fv(this.addr,!1,Po),dt(t,n)}}function np(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ft(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),dt(t,e)}else{if(ft(t,n))return;Co.set(n),i.uniformMatrix3fv(this.addr,!1,Co),dt(t,n)}}function ip(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ft(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),dt(t,e)}else{if(ft(t,n))return;Ro.set(n),i.uniformMatrix4fv(this.addr,!1,Ro),dt(t,n)}}function rp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function sp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ft(t,e))return;i.uniform2iv(this.addr,e),dt(t,e)}}function ap(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ft(t,e))return;i.uniform3iv(this.addr,e),dt(t,e)}}function op(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ft(t,e))return;i.uniform4iv(this.addr,e),dt(t,e)}}function lp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function cp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ft(t,e))return;i.uniform2uiv(this.addr,e),dt(t,e)}}function up(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ft(t,e))return;i.uniform3uiv(this.addr,e),dt(t,e)}}function hp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ft(t,e))return;i.uniform4uiv(this.addr,e),dt(t,e)}}function fp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(To.compareFunction=Sl,s=To):s=kl,t.setTexture2D(e||s,r)}function dp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Gl,r)}function pp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Wl,r)}function mp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Vl,r)}function _p(i){switch(i){case 5126:return $d;case 35664:return Jd;case 35665:return Qd;case 35666:return ep;case 35674:return tp;case 35675:return np;case 35676:return ip;case 5124:case 35670:return rp;case 35667:case 35671:return sp;case 35668:case 35672:return ap;case 35669:case 35673:return op;case 5125:return lp;case 36294:return cp;case 36295:return up;case 36296:return hp;case 35678:case 36198:case 36298:case 36306:case 35682:return fp;case 35679:case 36299:case 36307:return dp;case 35680:case 36300:case 36308:case 36293:return pp;case 36289:case 36303:case 36311:case 36292:return mp}}function gp(i,e){i.uniform1fv(this.addr,e)}function vp(i,e){const t=Ii(e,this.size,2);i.uniform2fv(this.addr,t)}function xp(i,e){const t=Ii(e,this.size,3);i.uniform3fv(this.addr,t)}function Mp(i,e){const t=Ii(e,this.size,4);i.uniform4fv(this.addr,t)}function Sp(i,e){const t=Ii(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function yp(i,e){const t=Ii(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Ep(i,e){const t=Ii(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function bp(i,e){i.uniform1iv(this.addr,e)}function Tp(i,e){i.uniform2iv(this.addr,e)}function Ap(i,e){i.uniform3iv(this.addr,e)}function wp(i,e){i.uniform4iv(this.addr,e)}function Rp(i,e){i.uniform1uiv(this.addr,e)}function Cp(i,e){i.uniform2uiv(this.addr,e)}function Pp(i,e){i.uniform3uiv(this.addr,e)}function Dp(i,e){i.uniform4uiv(this.addr,e)}function Lp(i,e,t){const n=this.cache,r=e.length,s=Fr(t,r);ft(n,s)||(i.uniform1iv(this.addr,s),dt(n,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||kl,s[a])}function Ip(i,e,t){const n=this.cache,r=e.length,s=Fr(t,r);ft(n,s)||(i.uniform1iv(this.addr,s),dt(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Gl,s[a])}function Up(i,e,t){const n=this.cache,r=e.length,s=Fr(t,r);ft(n,s)||(i.uniform1iv(this.addr,s),dt(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||Wl,s[a])}function Np(i,e,t){const n=this.cache,r=e.length,s=Fr(t,r);ft(n,s)||(i.uniform1iv(this.addr,s),dt(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||Vl,s[a])}function Fp(i){switch(i){case 5126:return gp;case 35664:return vp;case 35665:return xp;case 35666:return Mp;case 35674:return Sp;case 35675:return yp;case 35676:return Ep;case 5124:case 35670:return bp;case 35667:case 35671:return Tp;case 35668:case 35672:return Ap;case 35669:case 35673:return wp;case 5125:return Rp;case 36294:return Cp;case 36295:return Pp;case 36296:return Dp;case 35678:case 36198:case 36298:case 36306:case 35682:return Lp;case 35679:case 36299:case 36307:return Ip;case 35680:case 36300:case 36308:case 36293:return Up;case 36289:case 36303:case 36311:case 36292:return Np}}class Op{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=_p(t.type)}}class Bp{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Fp(t.type)}}class zp{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const ps=/(\w+)(\])?(\[|\.)?/g;function Do(i,e){i.seq.push(e),i.map[e.id]=e}function Hp(i,e,t){const n=i.name,r=n.length;for(ps.lastIndex=0;;){const s=ps.exec(n),a=ps.lastIndex;let o=s[1];const l=s[2]==="]",f=s[3];if(l&&(o=o|0),f===void 0||f==="["&&a+2===r){Do(t,f===void 0?new Op(o,i,e):new Bp(o,i,e));break}else{let _=t.map[o];_===void 0&&(_=new zp(o),Do(t,_)),t=_}}}class Rr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);Hp(s,a,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function Lo(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const kp=37297;let Vp=0;function Gp(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Io=new He;function Wp(i){Ke._getMatrix(Io,Ke.workingColorSpace,i);const e=`mat3( ${Io.elements.map(t=>t.toFixed(4))} )`;switch(Ke.getTransfer(i)){case Pr:return[e,"LinearTransferOETF"];case tt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Uo(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`
...
`)}function qp(i,e){let t;switch(e){case Fc:t="Linear";break;case Oc:t="Reinhard";break;case Bc:t="Cineon";break;case ol:t="ACESFilmic";break;case Hc:t="AgX";break;case kc:t="Neutral";break;case zc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Mr=new k;function Yp(){Ke.getLuminanceCoefficients(Mr);const i=Mr.x.toFixed(4),e=Mr.y.toFixed(4),t=Mr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function nm(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===rl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===sl?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===ln&&(e="SHADOWMAP_TYPE_VSM"),e}function im(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Ei:case bi:e="ENVMAP_TYPE_CUBE";break;case Ur:e="ENVMAP_TYPE_CUBE_UV";break}return e}function rm(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case bi:e="ENVMAP_MODE_REFRACTION";break}return e}function sm(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case al:e="ENVMAP_BLENDING_MULTIPLY";break;case Uc:e="ENVMAP_BLENDING_MIX";break;case Nc:e="ENVMAP_BLENDING_ADD";break}return e}function am(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function om(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=nm(t),f=im(t),p=rm(t),_=sm(t),m=am(t),g=jp(t),M=Zp(s),A=r.createProgram();let d,u,R=t.glslVersion?"#version "+t.glslVersion+`
...
`)&&c!=="\\"?(K(y.join("")),v=s,x):(y.push(h),c=h,x+1)}function D(){return T()}function N(){return h==="/"&&c==="*"?(y.push(h),K(y.join("")),v=s,x+1):(y.push(h),c=h,x+1)}function Q(){if(c==="."&&/\d/.test(h))return v=m,x;if(c==="/"&&h==="*")return v=o,x;if(c==="/"&&h==="/")return v=l,x;if(h==="."&&y.length){for(;j(y););return v=m,x}if(h===";"||h===")"||h==="("){if(y.length)for(;j(y););return K(h),v=s,x+1}var oe=y.length===2&&h!=="=";if(/[\w_\d\s]/.test(h)||oe){for(;j(y););return v=s,x}return y.push(h),c=h,x+1}function j(oe){var De=0,fe,P;do{if(fe=e.indexOf(oe.slice(0,oe.length+De).join("")),P=e[fe],fe===-1){if(De--+oe.length>0)continue;P=oe.slice(0,1).join("")}return K(P),W+=P.length,y=y.slice(P.length),y.length}while(!0)}function L(){return/[^a-fA-F0-9]/.test(h)?(K(y.join("")),v=s,x):(y.push(h),c=h,x+1)}function Pe(){return h==="."||/[eE]/.test(h)?(y.push(h),v=m,c=h,x+1):h==="x"&&y.length===1&&y[0]==="0"?(v=R,y.push(h),c=h,x+1):/[^\d]/.test(h)?(K(y.join("")),v=s,x):(y.push(h),c=h,x+1)}function Te(){return h==="f"&&(y.push(h),c=h,x+=1),/[eE]/.test(h)||(h==="-"||h==="+")&&/[eE]/.test(c)?(y.push(h),c=h,x+1):/[^\d]/.test(h)?(K(y.join("")),v=s,x):(y.push(h),c=h,x+1)}function we(){if(/[^\d\w_]/.test(h)){var oe=y.join("");return We[oe]?v=A:Be[oe]?v=M:v=g,K(y.join("")),v=s,x}return y.push(h),c=h,x+1}}return ys}var Es,$o;function r_(){if($o)return Es;$o=1;var i=i_();Es=e;function e(t,n){var r=i(n),s=[];return s=s.concat(r(t)),s=s.concat(r(null)),s}return Es}var s_=r_();const a_=Or(s_);var bs,Jo;function o_(){if(Jo)return bs;Jo=1,bs=i;function i(e){for(var t=[],n=0;n<e.length;n++)e[n].type!=="eof"&&t.push(e[n].data);return t.join("")}return bs}var l_=o_();const Qo=Or(l_);var Ts,el;function c_(){if(el)return Ts;el=1,Ts=i;function i(n){var r=null,s=null,a=0,o=0,l=0,f=0,p=0,_=[],m,g,M;for(m=0,g;m<n.length;m++)if(M=n[m],M.data==="{"){if(a&&a++||(g=d(m,e(")"),e()),g<0)||(f=g,g=d(g,e("("),e(")")),g<0)||(p=g,g=d(g,t),g<0)||n[g].type!=="ident"||(s=n[g].data,g=d(g,t),g<0))continue;a=1,o=m,r=n[g].data,l=g;var A=d(g,t);switch(n[A]&&n[A].data){case"lowp":case"highp":case"mediump":l=A}}else if(a&&M.data==="}"){if(--a)continue;_.push({name:s,type:r,body:[o+1,m],args:[p,f+1],outer:[l,m+1]})}for(m=0;m<n.length;m++)if(M=n[m],M.data===";"){if(g=d(m,e(")"),e()),g<0||(f=g,g=d(g,e("("),e(")")),g<0)||(p=g,g=d(g,t),g<0)||n[g].type!=="ident"||(s=n[g].data,g=d(g,t),g<0)||n[g].type==="operator"||n[g].data==="return")continue;r=n[g].data,_.push({name:s,type:r,body:!1,args:[p,f+1],outer:[g,m+1]})}return _.sort(function(u,R){return u.outer[0]-R.outer[0]});function d(u,R,w){for(var S=u-1;S>=0;S--){if(R(n[S]))return S;if(w&&w(n[S]))return-1}return-1}}function e(n){return function(r){return r.type==="operator"&&(!n||r.data===n)}}function t(n){return n.type!=="whitespace"}return Ts}var u_=c_();const h_=Or(u_);function f_(i,e){if(typeof i!="object"||i===null)return i;var t=i[Symbol.toPrimitive];if(t!==void 0){var n=t.call(i,e);if(typeof n!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(i)}function jl(i){var e=f_(i,"string");return typeof e=="symbol"?e:String(e)}function et(i,e,t){return e=jl(e),e in i?Object.defineProperty(i,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):i[e]=t,i}function tl(i,e){var t=Object.keys(i);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(i);e&&(n=n.filter(function(r){return Object.getOwnPropertyDescriptor(i,r).enumerable})),t.push.apply(t,n)}return t}function hi(i){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?tl(Object(t),!0).forEach(function(n){et(i,n,t[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(i,Object.getOwnPropertyDescriptors(t)):tl(Object(t)).forEach(function(n){Object.defineProperty(i,n,Object.getOwnPropertyDescriptor(t,n))})}return i}function d_(i,e){if(i==null)return{};var t={},n=Object.keys(i),r,s;for(s=0;s<n.length;s++)r=n[s],!(e.indexOf(r)>=0)&&(t[r]=i[r]);return t}function p_(i,e){if(i==null)return{};var t=d_(i,e),n,r;if(Object.getOwnPropertySymbols){var s=Object.getOwnPropertySymbols(i);for(r=0;r<s.length;r++)n=s[r],!(e.indexOf(n)>=0)&&Object.prototype.propertyIsEnumerable.call(i,n)&&(t[n]=i[n])}return t}function m_(i,e){if(!(i instanceof e))throw new TypeError("Cannot call a class as a function")}function __(i,e){for(var t=0;t<e.length;t++){var n=e[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(i,jl(n.key),n)}}function g_(i,e,t){return e&&__(i.prototype,e),Object.defineProperty(i,"prototype",{writable:!1}),i}function Zl(i){if(i===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return i}function da(i,e){return da=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(n,r){return n.__proto__=r,n},da(i,e)}function v_(i,e){if(typeof e!="function"&&e!==null)throw new TypeError("Super expression must either be null or a function");i.prototype=Object.create(e&&e.prototype,{constructor:{value:i,writable:!0,configurable:!0}}),Object.defineProperty(i,"prototype",{writable:!1}),e&&da(i,e)}function Ir(i){return Ir=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(t){return t.__proto__||Object.getPrototypeOf(t)},Ir(i)}function x_(){if(typeof Reflect>"u"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function M_(i,e){if(e&&(typeof e=="object"||typeof e=="function"))return e;if(e!==void 0)throw new TypeError("Derived constructors may only return object or undefined");return Zl(i)}function S_(i){var e=x_();return function(){var n=Ir(i),r;if(e){var s=Ir(this).constructor;r=Reflect.construct(n,arguments,s)}else r=n.apply(this,arguments);return M_(this,r)}}var Ie={position:"csm_Position",positionRaw:"csm_PositionRaw",pointSize:"csm_PointSize",fragColor:"csm_FragColor",diffuseColor:"csm_DiffuseColor",normal:"csm_Normal",roughness:"csm_Roughness",metalness:"csm_Metalness",emissive:"csm_Emissive",ao:"csm_AO",bump:"csm_Bump",depthAlpha:"csm_DepthAlpha"},Tt,fi,y_=(Tt={},et(Tt,"".concat(Ie.normal),{"#include <beginnormal_vertex>":`
  ...
  `)}),et(Tt,"".concat(Ie.emissive),{"vec3 totalEmissiveRadiance = emissive;":`
    ...
    `)}),Tt),E_=(fi={},et(fi,"".concat(Ie.position),{"gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );":`
...
`,At,C_=(At={},et(At,"".concat(Ie.position),"*"),et(At,"".concat(Ie.positionRaw),"*"),et(At,"".concat(Ie.normal),"*"),et(At,"".concat(Ie.pointSize),["PointsMaterial"]),et(At,"".concat(Ie.diffuseColor),"*"),et(At,"".concat(Ie.fragColor),"*"),et(At,"".concat(Ie.emissive),["MeshStandardMaterial","MeshPhysicalMaterial"]),et(At,"".concat(Ie.roughness),["MeshStandardMaterial","MeshPhysicalMaterial"]),et(At,"".concat(Ie.metalness),["MeshStandardMaterial","MeshPhysicalMaterial"]),et(At,"".concat(Ie.ao),["MeshStandardMaterial","MeshPhysicalMaterial","MeshBasicMaterial","MeshLambertMaterial","MeshPhongMaterial","MeshToonMaterial"]),et(At,"".concat(Ie.bump),["MeshLambertMaterial","MeshMatcapMaterial","MeshNormalMaterial","MeshPhongMaterial","MeshPhysicalMaterial","MeshStandardMaterial","MeshToonMaterial","ShadowMaterial"]),et(At,"".concat(Ie.depthAlpha),"*"),At),P_=["baseMaterial","fragmentShader","vertexShader","uniforms","patchMap","cacheKey","silent"],D_=function(e,t,n){return e.split(t).join(n)},L_=function(e){return e.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")},I_=function(e,t){return new RegExp("\\b".concat(L_(t),"\\b")).test(e)};function U_(i){try{new i}catch(e){if(e.message.indexOf("is not a constructor")>=0)return!1}return!0}function N_(i,e){var t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:!1;Object.assign(i,e);var n=Object.getPrototypeOf(e);Object.entries(Object.getOwnPropertyDescriptors(n)).filter(function(r){var s=typeof r[1].get=="function",a=typeof r[1].set=="function",o=typeof r[1].value=="function",l=r[0]==="constructor";return(s||a||o)&&!l}).forEach(function(r){if(typeof i[r[0]]=="function"){t||console.warn("Function ".concat(r[0]," already exists on CSM, renaming to base_").concat(r[0]));var s="base_".concat(r[0]);i[s]=r[1].value.bind(i);return}Object.defineProperty(i,r[0],r[1])})}function F_(i){var e=i.toString().trim(),t=e.substring(e.indexOf("{")+1,e.lastIndexOf("}"));return t.trim().length===0}function nl(i){return i.replace(/\s/g,"")}function O_(i,e,t){var n=i.lastIndexOf(e);return n===-1?i:i.substring(0,n)+t+i.substring(n+e.length)}var Kl=(function(i){v_(t,i);var e=S_(t);function t(n){var r,s=n.baseMaterial,a=n.fragmentShader,o=n.vertexShader,l=n.uniforms,f=n.patchMap,p=n.cacheKey,_=n.silent,m=p_(n,P_);m_(this,t);var g;if(U_(s)?g=new s(m):(g=s,Object.assign(g,m)),g.type==="RawShaderMaterial")throw new Error("CustomShaderMaterial does not support RawShaderMaterial");r=e.call(this),N_(Zl(r),g,_),r.__csm={patchMap:f||{},fragmentShader:a||"",vertexShader:o||"",cacheKey:p,baseMaterial:s,instanceID:yl.generateUUID(),type:g.type,isAlreadyExtended:!F_(g.onBeforeCompile),cacheHash:"",silent:_},r.uniforms=hi(hi({},r.uniforms||{}),l||{});{var M=r.__csm,A=M.fragmentShader,d=M.vertexShader,u=r.uniforms;r.__csm.cacheHash=r.getCacheHash(),r.generateMaterial(A,d,u)}return r}return g_(t,[{key:"update",value:function(){var r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};this.uniforms=r.uniforms||this.uniforms,Object.assign(this.__csm,r);var s=this.__csm,a=s.fragmentShader,o=s.vertexShader,l=this.uniforms,f=this.getCacheHash();this.__csm.cacheHash=f,this.generateMaterial(a,o,l)}},{key:"clone",value:function(){var r={baseMaterial:this.__csm.baseMaterial,fragmentShader:this.__csm.fragmentShader,vertexShader:this.__csm.vertexShader,uniforms:this.uniforms,silent:this.__csm.silent,patchMap:this.__csm.patchMap,cacheKey:this.__csm.cacheKey},s=new this.constructor(r);return Object.assign(this,s),s}},{key:"getCacheHash",value:function(){var r=this.__csm,s=r.fragmentShader,a=r.vertexShader,o=this.uniforms,l=Object.values(o).reduce(function(p,_){var m=_.value;return p+JSON.stringify(m)},""),f=nl(s)+nl(a)+l;return f.trim().length>0?Qm(f):this.customProgramCacheKey()}},{key:"generateMaterial",value:function(r,s,a){var o=this,l=this.parseShader(r),f=this.parseShader(s);this.uniforms=a||{},this.customProgramCacheKey=function(){return o.__csm.cacheHash};var p=function(g){try{if(l){var M=o.patchShader(l,g.fragmentShader,!0);g.fragmentShader=o.getMaterialDefine()+M}if(f){var A=o.patchShader(f,g.vertexShader);g.vertexShader=`#define IS_VERTEX;
`+A,g.vertexShader=o.getMaterialDefine()+g.vertexShader}g.uniforms=hi(hi({},g.uniforms),o.uniforms),o.uniforms=g.uniforms}catch(d){console.error(d)}};if(this.__csm.isAlreadyExtended){var _=this.onBeforeCompile;this.onBeforeCompile=function(m,g){_(m,g),p(m)}}else this.onBeforeCompile=p;this.needsUpdate=!0}},{key:"patchShader",value:function(r,s,a){var o=this,l=s,f=hi(hi({},this.getPatchMapForMaterial()),this.__csm.patchMap);Object.keys(f).forEach(function(m){Object.keys(f[m]).forEach(function(g){var M=C_[m],A=o.__csm.type;if(m==="*"||I_(r.main,m))if(!M||Array.isArray(M)&&M.includes(A)||M==="*")l=D_(l,g,f[m][g]);else throw new Error("CSM: ".concat(m," is not available in ").concat(A,". Shader cannot compile."))})}),l=l.replace("void main() {",`
      ...
      `));var p=this.__csm.isAlreadyExtended,_=l.includes("// CSM_END");return p&&_?l=O_(l,"// CSM_END",`
        ...
        `.concat(r.main,`
        // CSM_END
          `)),l=r.defines+l,l}},{key:"parseShader",value:function(r){if(r){var s=r.replace(/\/\*\*(.*?)\*\/|\/\/(.*?)\n/gm,""),a=a_(s),o=h_(a),l=o.map(function(_){return _.name}).indexOf("main"),f=Qo(a.slice(0,l>=0?o[l].outer[0]:void 0)),p=l>=0?this.getShaderFromIndex(a,o[l].body):"";return{defines:"",header:f,main:p}}}},{key:"getMaterialDefine",value:function(){var r=this.__csm.type;return r?"#define IS_".concat(r.toUpperCase(),`;
`):`#define IS_UNKNOWN;
`}},{key:"getPatchMapForMaterial",value:function(){switch(this.__csm.type){case"ShaderMaterial":return E_;default:return y_}}},{key:"getShaderFromIndex",value:function(r,s){return Qo(r.slice(s[0],s[1]))}}]),t})(Li),$l=`uniform float uTime;\r
...
}`;const Mi=navigator.userAgent.toLowerCase(),z_=/iphone|ipod|android.*mobile/i.test(Mi),Jl=/ipad|android(?!.*mobile)/i.test(Mi),qi=window.innerWidth,H_=qi>991,k_=qi>=768&&qi<=991,V_=qi<768,Cr="ontouchstart"in window||navigator.maxTouchPoints>0,As=navigator.hardwareConcurrency||4,Ql=Mi.includes("mac")&&Cr&&!Mi.includes("iphone")||Mi.includes("ipad"),G_=Jl&&Mi.includes("android");let Vn="desktop";z_&&!Jl?Vn="mobile":Ql||G_?Vn="tablet":V_&&Cr?Vn="mobile":k_&&Cr?Vn="tablet":(H_||!Cr)&&(Vn="desktop");let zn="high";Vn==="desktop"?zn="high":Vn==="tablet"?As>=6||Ql&&qi>=1024?zn="high":As>=4?zn="medium":zn="low":As>=6?zn="medium":zn="low";const W_={high:{subdivisions:65,cubeMapSize:128,enableCubeCamera:!0,cubeCameraUpdateInterval:1,enableShadows:!0,pixelRatio:2,antialias:!0},medium:{subdivisions:45,cubeMapSize:64,enableCubeCamera:!0,cubeCameraUpdateInterval:3,enableShadows:!0,pixelRatio:2,antialias:!0},low:{subdivisions:35,cubeMapSize:0,enableCubeCamera:!1,cubeCameraUpdateInterval:0,enableShadows:!1,pixelRatio:1,antialias:!1}},Nt=W_[zn],Da=document.querySelector("canvas.webgl"),Ut=new Hu;Ut.background=new Xe("#0a1628");const La={uTime:new cn(0),uPositionFrequency:new cn(.233),uTimeFrequency:new cn(.13),uStrength:new cn(.492),uWarpPositionFrequency:new cn(.4),uWarpTimeFrequency:new cn(.3),uWarpStrength:new cn(1.8)},Gn=new Kl({baseMaterial:Wu,vertexShader:$l,fragmentShader:B_,uniforms:La,silent:!0,metalness:1,roughness:.4,color:"#68707A",transmission:0,ior:10,thickness:0,transparent:!0,wireframe:!1,clearcoat:0,clearcoatRoughness:0}),ec=new Kl({baseMaterial:Ol,vertexShader:$l,uniforms:La,silent:!0,depthPacking:xl});let Yi=new wa(2.5,Nt.subdivisions);Yi=Km(Yi);Yi.computeTangents();const Ci=new $t(Yi,Gn);Ci.customDepthMaterial=ec;Ci.receiveShadow=Nt.enableShadows;Ci.castShadow=Nt.enableShadows;Ut.add(Ci);const Ui=new Ra("#ffffff",25);Ui.castShadow=Nt.enableShadows;Ui.shadow.mapSize.set(512,512);Ui.shadow.camera.far=15;Ui.shadow.normalBias=.05;Ui.position.set(3,4,-3);Ut.add(Ui);const tc=new Ra("#4a7c9e",10);tc.position.set(-4,2,3);Ut.add(tc);const nc=new Ra("#8bb8d8",3);nc.position.set(0,-1,-4);Ut.add(nc);const X_=new ju("#AAAAEE",2.5);Ut.add(X_);const It={width:window.innerWidth,height:window.innerHeight,pixelRatio:Math.min(window.devicePixelRatio,Nt.pixelRatio)},Pi=new Ht(35,It.width/It.height,.1,100);Pi.position.set(13,-3,-5);Ut.add(Pi);const Ia=new Om(Pi,Da);Ia.enableDamping=!0;const Ft=new Nm({canvas:Da,antialias:Nt.antialias,alpha:!0,powerPreference:"high-performance",stencil:!1,depth:!0});Ft.shadowMap.enabled=Nt.enableShadows;Ft.shadowMap.type=Nt.enableShadows?sl:mc;Ft.toneMapping=ol;Ft.toneMappingExposure=2.5;Ft.outputColorSpace=wt;Ft.setSize(It.width,It.height);Ft.setPixelRatio(It.pixelRatio);let Xn=null,Si=null;Nt.enableCubeCamera?(Si=new Nl(Nt.cubeMapSize,{format:kt,generateMipmaps:!0,minFilter:En,magFilter:jt,colorSpace:wt}),Xn=new Il(.1,100,Si),Ut.add(Xn),Gn.envMap=Si.texture,Gn.envMapIntensity=1,Gn.needsUpdate=!0):(Gn.envMap=null,Gn.envMapIntensity=0);let ic=!0,rc=!0;const sc=()=>{ic=!document.hidden},q_=document.querySelector(".webgl-hero"),Y_=q_||Da,pa=new IntersectionObserver(i=>{i.forEach(e=>{rc=e.isIntersecting})},{threshold:.1});pa.observe(Y_);const ac=()=>{It.width=window.innerWidth,It.height=window.innerHeight,It.pixelRatio=Math.min(window.devicePixelRatio,Nt.pixelRatio),Pi.aspect=It.width/It.height,Pi.updateProjectionMatrix(),Ft.setSize(It.width,It.height),Ft.setPixelRatio(It.pixelRatio)};window.addEventListener("resize",ac);document.addEventListener("visibilitychange",sc);const j_=new Ku;let il=0,Gi=null;const ma=()=>{if(!ic||!rc){Gi=window.requestAnimationFrame(ma);return}const i=j_.getElapsedTime();La.uTime.value=i,Ia.update(),Xn&&(Nt.cubeCameraUpdateInterval===1||il%Nt.cubeCameraUpdateInterval===0)&&(Ci.visible=!1,Xn.update(Ft,Ut),Ci.visible=!0),il++,Ft.render(Ut,Pi),Gi=window.requestAnimationFrame(ma)};ma();const Z_=()=>{Gi!==null&&(window.cancelAnimationFrame(Gi),Gi=null),window.removeEventListener("resize",ac),document.removeEventListener("visibilitychange",sc),pa&&pa.disconnect(),Yi.dispose(),Gn.dispose(),ec.dispose(),Xn&&(Ut.remove(Xn),Xn=null),Si&&(Si.dispose(),Si=null),Ia.dispose(),Ut.traverse(i=>{i.geometry&&i.geometry.dispose(),i.material&&(Array.isArray(i.material)?i.material.forEach(e=>e.dispose()):i.material.dispose())}),Ut.clear(),Ft.dispose(),Ft.forceContextLoss()};window.addEventListener("beforeunload",Z_);
